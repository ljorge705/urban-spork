        ...
        this.elementDescriptors = LazyKt.lazy(new Function0<SerialDescriptor[]>() { // from class: kotlinx.serialization.internal.EnumDescriptor$elementDescriptors$2
            ...
            public final SerialDescriptor[] invoke() {
                ...
                for (int i3 = 0; i3 < i2; i3++) {
                    serialDescriptorArr[i3] = SerialDescriptorsKt.buildSerialDescriptor$default(name + ClassUtils.PACKAGE_SEPARATOR_CHAR + this.getElementName(i3), StructureKind.OBJECT.INSTANCE, new SerialDescriptor[0], null, 8, null);
                }
