...
public final class PrimitivesKt {
    ...
    private static final void checkName(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (StringsKt.equals(str, Intrinsics.stringPlus("kotlin.", strCapitalize), true) || StringsKt.equals(str, strCapitalize, true)) {
    ...
    private static final String capitalize(String str) {
        ...
        StringBuilder sbAppend = sb.append((Character.isLowerCase(cCharAt) ? CharsKt.titlecase(cCharAt) : String.valueOf(cCharAt)).toString());
        if (str == null) {
