    ...
    public R deserialize(Decoder decoder) {
        ...
        while (true) {
            ...
            if (iDecodeElementIndex == 0) {
                ...
                throw new SerializationException(Intrinsics.stringPlus("Invalid index: ", Integer.valueOf(iDecodeElementIndex)));
            }
        }
    }
}
