...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m6264boximpl(m7681deserializeI7RO_PI(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m7682serialize2TYgG_w(encoder, ((ULong) obj).getData());
    }

    /* renamed from: serialize-2TYgG_w, reason: not valid java name */
    public void m7682serialize2TYgG_w(Encoder encoder, long value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeLong(value);
    }

    /* renamed from: deserialize-I7RO_PI, reason: not valid java name */
    public long m7681deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m6270constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
