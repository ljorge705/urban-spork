...
public final class JsonDecoderForUnsignedTypes extends AbstractDecoder {
    ...
    public int decodeInt() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type 'UInt' for input '" + strConsumeStringLenient + '\'', 0, 2, null);
    ...
    public long decodeLong() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type 'ULong' for input '" + strConsumeStringLenient + '\'', 0, 2, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public byte decodeByte() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type 'UByte' for input '" + strConsumeStringLenient + '\'', 0, 2, null);
            throw new KotlinNothingValueException();
        }
    }
    ...
    public short decodeShort() {
        ...
        try {
            ...
            AbstractJsonLexer.fail$default(abstractJsonLexer, "Failed to parse type 'UShort' for input '" + strConsumeStringLenient + '\'', 0, 2, null);
            throw new KotlinNothingValueException();
        }
    }
}
