...
public final class JsonToWriterStringBuilder extends JsonStringBuilder {
    ...
    public JsonToWriterStringBuilder(OutputStream os, Charset charset) {
        ...
        this(outputStreamWriter instanceof BufferedWriter ? (BufferedWriter) outputStreamWriter : new BufferedWriter(outputStreamWriter, 262144));
    }
    ...
    protected int ensureTotalCapacity(int oldSize, int additional) throws IOException {
        int i = oldSize + additional;
        ...
        if (additional > length) {
            this.array = new char[RangesKt.coerceAtLeast(i, length * 2)];
        }
        return 0;
    }

    static /* synthetic */ void flush$default(JsonToWriterStringBuilder jsonToWriterStringBuilder, int i, int i2, Object obj) throws IOException {
        if ((i2 & 1) != 0) {
    ...
    private final void flush(int sz) throws IOException {
