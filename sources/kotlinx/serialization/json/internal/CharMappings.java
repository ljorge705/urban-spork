...
public final class CharMappings {
    ...
    static {
        ...
        ESCAPE_2_CHAR = new char[LDSFile.EF_DG2_TAG];
    ...
    private final void initEscape() {
        ...
        while (true) {
            ...
            if (i2 > 31) {
                initC2ESC(8, Constants.INAPP_POSITION_BOTTOM);
                initC2ESC(9, Constants.INAPP_POSITION_TOP);
                initC2ESC(10, 'n');
                initC2ESC(12, 'f');
                initC2ESC(13, Constants.INAPP_POSITION_RIGHT);
                initC2ESC('/', '/');
                initC2ESC('\"', '\"');
