...
public final class JsonPrimitiveSerializer implements KSerializer<JsonPrimitive> {
    ...
    public JsonPrimitive deserialize(Decoder decoder) {
        ...
        if (!(jsonElementDecodeJsonElement instanceof JsonPrimitive)) {
            throw JsonExceptionsKt.JsonDecodingException(-1, Intrinsics.stringPlus("Unexpected JSON element, expected JsonPrimitive, had ", Reflection.getOrCreateKotlinClass(jsonElementDecodeJsonElement.getClass())), jsonElementDecodeJsonElement.toString());
        }
