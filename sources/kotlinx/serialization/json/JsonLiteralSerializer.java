...
final class JsonLiteralSerializer implements KSerializer<JsonLiteral> {
    ...
    public JsonLiteral deserialize(Decoder decoder) {
        ...
        if (!(jsonElementDecodeJsonElement instanceof JsonLiteral)) {
            throw JsonExceptionsKt.JsonDecodingException(-1, Intrinsics.stringPlus("Unexpected JSON element, expected JsonLiteral, had ", Reflection.getOrCreateKotlinClass(jsonElementDecodeJsonElement.getClass())), jsonElementDecodeJsonElement.toString());
        }
