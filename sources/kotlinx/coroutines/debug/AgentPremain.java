...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM6095constructorimpl = Result.m6095constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6095constructorimpl = Result.m6095constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m6101isFailureimpl(objM6095constructorimpl) ? null : objM6095constructorimpl);
        if (bool != null) {
