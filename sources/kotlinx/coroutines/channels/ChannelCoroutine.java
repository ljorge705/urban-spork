...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public void mo7666invokeOnClose(Function1<? super Throwable, Unit> handler) {
        this._channel.mo7666invokeOnClose(handler);
    }
    ...
    public Object mo7603receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo7603receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo7604tryReceivePtdJZtk() {
        return this._channel.mo7604tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo7599trySendJP2dKIU(E element) {
        return this._channel.mo7599trySendJP2dKIU(element);
    }
