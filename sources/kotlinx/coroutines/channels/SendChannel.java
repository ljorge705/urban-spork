...
public interface SendChannel<E> {
    ...
    void mo7666invokeOnClose(Function1<? super Throwable, Unit> handler);
    ...
    Object mo7599trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object objMo7599trySendJP2dKIU = sendChannel.mo7599trySendJP2dKIU(e);
            if (ChannelResult.m7619isSuccessimpl(objMo7599trySendJP2dKIU)) {
                return true;
            }
            Throwable thM7613exceptionOrNullimpl = ChannelResult.m7613exceptionOrNullimpl(objMo7599trySendJP2dKIU);
