...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM7627trySendImplMj0NB7M = conflatedBufferedChannel.m7627trySendImplMj0NB7M(e, true);
        if (objM7627trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m7613exceptionOrNullimpl(objM7627trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM7627trySendImplMj0NB7M = conflatedBufferedChannel.m7627trySendImplMj0NB7M(e, true);
        if (!(objM7627trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo7599trySendJP2dKIU(E element) {
        return m7627trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m7627trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m7625trySendDropLatestMj0NB7M(element, isSendOp) : m7626trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m7625trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo7599trySendJP2dKIU = super.mo7599trySendJP2dKIU(element);
        if (ChannelResult.m7619isSuccessimpl(objMo7599trySendJP2dKIU) || ChannelResult.m7617isClosedimpl(objMo7599trySendJP2dKIU)) {
            return objMo7599trySendJP2dKIU;
        }
    ...
    private final Object m7626trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m7622closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo7599trySendJP2dKIU = mo7599trySendJP2dKIU(element);
        if (!(objMo7599trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo7599trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m7613exceptionOrNullimpl(objMo7599trySendJP2dKIU);
