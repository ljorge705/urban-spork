        ...
        for (int i6 = 1; i6 < iCurrentLength; i6++) {
            ...
            if (worker != null) {
                ...
                if (i7 == 1) {
                    ...
                    i2++;
                    arrayList.add(new StringBuilder().append(size$kotlinx_coroutines_core).append(Constants.INAPP_POSITION_BOTTOM).toString());
                } else if (i7 == 3) {
                    i++;
