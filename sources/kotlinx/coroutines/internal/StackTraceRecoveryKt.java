...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM6095constructorimpl = Result.m6095constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM6095constructorimpl = Result.m6095constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m6098exceptionOrNullimpl(objM6095constructorimpl) == null) {
            obj2 = objM6095constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM6095constructorimpl2 = Result.m6095constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM6095constructorimpl2 = Result.m6095constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m6098exceptionOrNullimpl(objM6095constructorimpl2) == null) {
            obj = objM6095constructorimpl2;
        }
