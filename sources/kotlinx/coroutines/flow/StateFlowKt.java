...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        cctxrwizduxmjefyvyrx cctxrwizduxmjefyvyrxVar;
        T tInvoke;
        do {
            cctxrwizduxmjefyvyrxVar = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(cctxrwizduxmjefyvyrxVar);
        } while (!mutableStateFlow.compareAndSet(cctxrwizduxmjefyvyrxVar, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            cctxrwizduxmjefyvyrxVar = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(cctxrwizduxmjefyvyrxVar, function1.invoke(cctxrwizduxmjefyvyrxVar)));
    }
