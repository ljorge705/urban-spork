...
public final class FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1", f = "Emitters.kt", i = {0, 0, 1, 2}, l = {ISO781611.DISCRETIONARY_DATA_FOR_PAYLOAD_CONSTRUCTED_TAG, 122, 129}, m = "collect", n = {"this", "$this$onCompletion_u24lambda_u242", "e", Constants.INAPP_NOTIF_SHOW_CLOSE}, s = {"L$0", "L$1", "L$0", "L$0"})
