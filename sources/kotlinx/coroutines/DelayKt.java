...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo7655scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m7586delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m7587toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m7587toDelayMillisLRDsOJo(long j) {
        if (Duration.m7421compareToLRDsOJo(j, Duration.INSTANCE.m7525getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m7440getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
