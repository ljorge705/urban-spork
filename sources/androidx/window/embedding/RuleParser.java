...
public final class RuleParser {
    ...
    private final ComponentName buildClassName(String pkg, CharSequence clsSeq) {
        ...
        if (!Intrinsics.areEqual(string, ProxyConfig.MATCH_ALL_SCHEMES) && StringsKt.indexOf$default((CharSequence) string, ClassUtils.PACKAGE_SEPARATOR_CHAR, 0, false, 6, (Object) null) < 0) {
