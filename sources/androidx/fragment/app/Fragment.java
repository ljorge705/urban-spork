...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    void performConfigurationChanged(Configuration configuration) {
        ...
        this.mChildFragmentManager.m4672lambda$new$0$androidxfragmentappFragmentManager(configuration);
    }
    ...
    void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle bundleSaveAllStateInternal = this.mChildFragmentManager.m4671lambda$attachController$4$androidxfragmentappFragmentManager();
