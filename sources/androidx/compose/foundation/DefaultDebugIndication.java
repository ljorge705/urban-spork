    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                DrawScope.m2412drawRectnJ9OG0$default(contentDrawScope, Color.m1876copywmQWz5c$default(Color.INSTANCE.m1903getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2417getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                DrawScope.m2412drawRectnJ9OG0$default(contentDrawScope, Color.m1876copywmQWz5c$default(Color.INSTANCE.m1903getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2417getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
