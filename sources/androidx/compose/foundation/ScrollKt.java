...
public final class ScrollKt {
    public static final ScrollState rememberScrollState(final int i, Composer composer, int i2, int i3) {
        ...
        ScrollState scrollState = (ScrollState) RememberSaveableKt.m1531rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics) {
                        ...
                        if (z6) {
                            ...
                            SemanticsPropertiesKt.scrollBy$default(semantics, null, new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1.1
                                ...
                                @DebugMetadata(c = "androidx.compose.foundation.ScrollKt$scroll$2$semantics$1$1$1", f = "Scroll.kt", i = {}, l = {285, OlympusImageProcessingMakernoteDirectory.TagWbGLevel}, m = "invokeSuspend", n = {}, s = {})
