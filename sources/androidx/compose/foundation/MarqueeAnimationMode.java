...
public final class MarqueeAnimationMode {
    ...
    private static final int Immediately = m478constructorimpl(0);
    private static final int WhileFocused = m478constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ MarqueeAnimationMode m477boximpl(int i) {
        return new MarqueeAnimationMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m478constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m479equalsimpl(int i, Object obj) {
        return (obj instanceof MarqueeAnimationMode) && i == ((MarqueeAnimationMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m480equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static String m482toStringimpl(int i) {
        if (m480equalsimpl0(i, Immediately)) {
            return "Immediately";
        }
        if (m480equalsimpl0(i, WhileFocused)) {
            return "WhileFocused";
        }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m484getImmediatelyZbEOnfQ$annotations() {
        }

        /* renamed from: getWhileFocused-ZbEOnfQ$annotations, reason: not valid java name */
        public static /* synthetic */ void m485getWhileFocusedZbEOnfQ$annotations() {
        }
