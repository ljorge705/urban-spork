...
final class AlignmentLineOffsetDp extends InspectorValueInfo implements LayoutModifier {
    ...
    private AlignmentLineOffsetDp(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> function1) {
        ...
        this.before = f;
        this.after = f2;
        if ((f < 0.0f && !Dp.m4395equalsimpl0(f, Dp.INSTANCE.m4410getUnspecifiedD9Ej5fM())) || (f2 < 0.0f && !Dp.m4395equalsimpl0(f2, Dp.INSTANCE.m4410getUnspecifiedD9Ej5fM()))) {
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return AlignmentLineKt.m611alignmentLineOffsetMeasuretjqqzMA(measure, this.alignmentLine, this.before, this.after, measurable, j);
    }

    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m4396hashCodeimpl(this.before)) * 31) + Dp.m4396hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDp.alignmentLine) && Dp.m4395equalsimpl0(this.before, alignmentLineOffsetDp.before) && Dp.m4395equalsimpl0(this.after, alignmentLineOffsetDp.after);
    }

    public String toString() {
        return "AlignmentLineOffset(alignmentLine=" + this.alignmentLine + ", before=" + ((Object) Dp.m4401toStringimpl(this.before)) + ", after=" + ((Object) Dp.m4401toStringimpl(this.after)) + ')';
    }
}
