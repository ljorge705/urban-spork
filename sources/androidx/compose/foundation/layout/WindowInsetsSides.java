...
public final class WindowInsetsSides {
    ...
    public static final /* synthetic */ WindowInsetsSides m755boximpl(int i) {
        return new WindowInsetsSides(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m756constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m757equalsimpl(int i, Object obj) {
    ...
    public static final boolean m759hasAnybkgdKaI$foundation_layout_release(int i, int i2) {
        return (i & i2) != 0;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m760hashCodeimpl(int i) {
    ...
    public static final int m761plusgK_yJZ4(int i, int i2) {
        return m756constructorimpl(i | i2);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m762toStringimpl(int i) {
        return "WindowInsetsSides(" + m763valueToStringimpl(i) + ')';
    }

    public String toString() {
        return m762toStringimpl(this.value);
    }

    /* renamed from: valueToString-impl, reason: not valid java name */
    private static final String m763valueToStringimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m765getAllowLeftInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInLtr;
        }

        /* renamed from: getAllowRightInLtr-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m767getAllowRightInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInLtr;
        }

        /* renamed from: getAllowLeftInRtl-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m766getAllowLeftInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInRtl;
        }

        /* renamed from: getAllowRightInRtl-JoeWqyM$foundation_layout_release, reason: not valid java name */
        public final int m768getAllowRightInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInRtl;
        }

        /* renamed from: getStart-JoeWqyM, reason: not valid java name */
        public final int m774getStartJoeWqyM() {
            return WindowInsetsSides.Start;
        }

        /* renamed from: getEnd-JoeWqyM, reason: not valid java name */
        public final int m770getEndJoeWqyM() {
            return WindowInsetsSides.End;
        }

        /* renamed from: getTop-JoeWqyM, reason: not valid java name */
        public final int m775getTopJoeWqyM() {
            return WindowInsetsSides.Top;
        }

        /* renamed from: getBottom-JoeWqyM, reason: not valid java name */
        public final int m769getBottomJoeWqyM() {
            return WindowInsetsSides.Bottom;
        }

        /* renamed from: getLeft-JoeWqyM, reason: not valid java name */
        public final int m772getLeftJoeWqyM() {
            return WindowInsetsSides.Left;
        }

        /* renamed from: getRight-JoeWqyM, reason: not valid java name */
        public final int m773getRightJoeWqyM() {
            return WindowInsetsSides.Right;
        }

        /* renamed from: getHorizontal-JoeWqyM, reason: not valid java name */
        public final int m771getHorizontalJoeWqyM() {
            return WindowInsetsSides.Horizontal;
        }

        /* renamed from: getVertical-JoeWqyM, reason: not valid java name */
        public final int m776getVerticalJoeWqyM() {
            return WindowInsetsSides.Vertical;
        }
    }

    static {
        int iM756constructorimpl = m756constructorimpl(8);
        AllowLeftInLtr = iM756constructorimpl;
        int iM756constructorimpl2 = m756constructorimpl(4);
        AllowRightInLtr = iM756constructorimpl2;
        int iM756constructorimpl3 = m756constructorimpl(2);
        AllowLeftInRtl = iM756constructorimpl3;
        int iM756constructorimpl4 = m756constructorimpl(1);
        AllowRightInRtl = iM756constructorimpl4;
        Start = m761plusgK_yJZ4(iM756constructorimpl, iM756constructorimpl4);
        End = m761plusgK_yJZ4(iM756constructorimpl2, iM756constructorimpl3);
        int iM756constructorimpl5 = m756constructorimpl(16);
        Top = iM756constructorimpl5;
        int iM756constructorimpl6 = m756constructorimpl(32);
        Bottom = iM756constructorimpl6;
        int iM761plusgK_yJZ4 = m761plusgK_yJZ4(iM756constructorimpl, iM756constructorimpl3);
        Left = iM761plusgK_yJZ4;
        int iM761plusgK_yJZ42 = m761plusgK_yJZ4(iM756constructorimpl2, iM756constructorimpl4);
        Right = iM761plusgK_yJZ42;
        Horizontal = m761plusgK_yJZ4(iM761plusgK_yJZ4, iM761plusgK_yJZ42);
        Vertical = m761plusgK_yJZ4(iM756constructorimpl5, iM756constructorimpl6);
    }
}
