...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo287measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long j) {
            ...
            return MeasureScope.layout$default(MeasurePolicy, Constraints.m4348getMinWidthimpl(j), Constraints.m4347getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1$measure$1
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt.boxMeasurePolicy.1
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo287measure3p2s80s(final MeasureScope MeasurePolicy, final List<? extends Measurable> measurables, long j) {
                ...
                if (measurables.isEmpty()) {
                    return MeasureScope.layout$default(MeasurePolicy, Constraints.m4348getMinWidthimpl(j), Constraints.m4347getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                        }
                ...
                long jM4337copyZbe2FdA$default = z ? j : Constraints.m4337copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                if (measurables.size() == 1) {
                    final Measurable measurable = measurables.get(0);
                    if (!BoxKt.getMatchesParentSize(measurable)) {
                        Placeable placeableMo3396measureBRTryo02 = measurable.mo3396measureBRTryo0(jM4337copyZbe2FdA$default);
                        int iMax2 = Math.max(Constraints.m4348getMinWidthimpl(j), placeableMo3396measureBRTryo02.getWidth());
                        iMax = Math.max(Constraints.m4347getMinHeightimpl(j), placeableMo3396measureBRTryo02.getHeight());
                        placeableMo3396measureBRTryo0 = placeableMo3396measureBRTryo02;
                        iM4348getMinWidthimpl = iMax2;
                    } else {
                        iM4348getMinWidthimpl = Constraints.m4348getMinWidthimpl(j);
                        int iM4347getMinHeightimpl = Constraints.m4347getMinHeightimpl(j);
                        placeableMo3396measureBRTryo0 = measurable.mo3396measureBRTryo0(Constraints.INSTANCE.m4354fixedJhjzzOo(Constraints.m4348getMinWidthimpl(j), Constraints.m4347getMinHeightimpl(j)));
                        iMax = iM4347getMinHeightimpl;
                    }
                    final Alignment alignment2 = alignment;
                    final int i = iM4348getMinWidthimpl;
                    final int i2 = iMax;
                    return MeasureScope.layout$default(MeasurePolicy, iM4348getMinWidthimpl, iMax, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1$measure$2
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            Intrinsics.checkNotNullParameter(layout, "$this$layout");
                            BoxKt.placeInBox(layout, placeableMo3396measureBRTryo0, measurable, MeasurePolicy.getLayoutDirection(), i, i2, alignment2);
                        }
                    }, 4, null);
                }
                final Placeable[] placeableArr = new Placeable[measurables.size()];
                final Ref.IntRef intRef = new Ref.IntRef();
                intRef.element = Constraints.m4348getMinWidthimpl(j);
                final Ref.IntRef intRef2 = new Ref.IntRef();
                intRef2.element = Constraints.m4347getMinHeightimpl(j);
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (BoxKt.getMatchesParentSize(measurable2)) {
                        ...
                        Placeable placeableMo3396measureBRTryo03 = measurable2.mo3396measureBRTryo0(jM4337copyZbe2FdA$default);
                        placeableArr[i3] = placeableMo3396measureBRTryo03;
                        intRef.element = Math.max(intRef.element, placeableMo3396measureBRTryo03.getWidth());
                        intRef2.element = Math.max(intRef2.element, placeableMo3396measureBRTryo03.getHeight());
                    }
                }
                if (z2) {
                    ...
                    for (int i4 = 0; i4 < size2; i4++) {
                        ...
                        if (BoxKt.getMatchesParentSize(measurable3)) {
                            placeableArr[i4] = measurable3.mo3396measureBRTryo0(jConstraints);
                        }
                    }
                }
    ...
    public static final void placeInBox(Placeable.PlacementScope placementScope, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int i, int i2, Alignment alignment) {
        ...
        Placeable.PlacementScope.m3444place70tqf50$default(placementScope, placeable, ((boxChildData == null || (alignment2 = boxChildData.getAlignment()) == null) ? alignment : alignment2).mo1535alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i, i2), layoutDirection), 0.0f, 2, null);
    }
    ...
    public static final void Box(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, -1253624675, "C:Box.kt#2w3rfo");
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
