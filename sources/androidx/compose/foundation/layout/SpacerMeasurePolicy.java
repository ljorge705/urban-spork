...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo287measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        return MeasureScope.layout$default(measure, Constraints.m4344getHasFixedWidthimpl(j) ? Constraints.m4346getMaxWidthimpl(j) : 0, Constraints.m4343getHasFixedHeightimpl(j) ? Constraints.m4345getMaxHeightimpl(j) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
