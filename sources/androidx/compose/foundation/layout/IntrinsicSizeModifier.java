...
interface IntrinsicSizeModifier extends LayoutModifier {
    ...
    long mo674calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);
    ...
    default MeasureResult mo300measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        long jMo674calculateContentConstraintsl58MMJ0 = mo674calculateContentConstraintsl58MMJ0(measure, measurable, j);
        if (getEnforceIncoming()) {
            jMo674calculateContentConstraintsl58MMJ0 = ConstraintsKt.m4358constrainN9IONVI(j, jMo674calculateContentConstraintsl58MMJ0);
        }
        final Placeable placeableMo3396measureBRTryo0 = measurable.mo3396measureBRTryo0(jMo674calculateContentConstraintsl58MMJ0);
        return MeasureScope.layout$default(measure, placeableMo3396measureBRTryo0.getWidth(), placeableMo3396measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.IntrinsicSizeModifier$measure$1
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3445placeRelative70tqf50$default(layout, placeableMo3396measureBRTryo0, IntOffset.INSTANCE.m4518getZeronOccac(), 0.0f, 2, null);
            }
        }, 4, null);
    }
