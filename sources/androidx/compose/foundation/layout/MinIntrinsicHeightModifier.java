...
final class MinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo674calculateContentConstraintsl58MMJ0(MeasureScope calculateContentConstraints, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(calculateContentConstraints, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.INSTANCE.m4355fixedHeightOenEA2s(measurable.minIntrinsicHeight(Constraints.m4346getMaxWidthimpl(j)));
    }
