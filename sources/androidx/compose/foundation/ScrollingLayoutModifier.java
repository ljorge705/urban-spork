...
final /* data */ class ScrollingLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        CheckScrollableContainerConstraintsKt.m447checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable placeableMo3396measureBRTryo0 = measurable.mo3396measureBRTryo0(Constraints.m4337copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m4346getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m4345getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo3396measureBRTryo0.getWidth(), Constraints.m4346getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo3396measureBRTryo0.getHeight(), Constraints.m4345getMaxHeightimpl(j));
        final int height = placeableMo3396measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo3396measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.layout$default(measure, iCoerceAtMost, iCoerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeableMo3396measureBRTryo0, this.this$0.isVertical() ? 0 : i, this.this$0.isVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
