...
final class ConsumeAllFlingOnDirection implements NestedScrollConnection {
    ...
    public final long m926consumeOnOrientationQWom1Mo(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Velocity.m4611copyOhffZ5M$default(j, 0.0f, 0.0f, 2, null);
        }
        return Velocity.m4611copyOhffZ5M$default(j, 0.0f, 0.0f, 1, null);
    }

    /* renamed from: consumeOnOrientation-8S9VItk, reason: not valid java name */
    public final long m925consumeOnOrientation8S9VItk(long j, Orientation orientation) {
        Intrinsics.checkNotNullParameter(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return Offset.m1633copydBAh8RU$default(j, 0.0f, 0.0f, 2, null);
        }
        return Offset.m1633copydBAh8RU$default(j, 0.0f, 0.0f, 1, null);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo584onPostScrollDzOQY0M(long consumed, long available, int source) {
        return NestedScrollSource.m3172equalsimpl0(source, NestedScrollSource.INSTANCE.m3178getFlingWNlRxjI()) ? m925consumeOnOrientation8S9VItk(available, this.orientation) : Offset.INSTANCE.m1655getZeroF1C5BW0();
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo583onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return Velocity.m4606boximpl(m926consumeOnOrientationQWom1Mo(j2, this.orientation));
    }
}
