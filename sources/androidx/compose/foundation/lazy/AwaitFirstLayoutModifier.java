...
public final class AwaitFirstLayoutModifier implements OnGloballyPositionedModifier {
    ...
    @DebugMetadata(c = "androidx.compose.foundation.lazy.AwaitFirstLayoutModifier", f = "LazyListState.kt", i = {0, 0}, l = {OnfidoActivity.RESULT_EXIT_INVALID_CERTIFICATE}, m = "waitForFirstLayout", n = {"this", "oldContinuation"}, s = {"L$0", "L$1"})
    /* renamed from: androidx.compose.foundation.lazy.AwaitFirstLayoutModifier$waitForFirstLayout$1, reason: invalid class name */
    ...
    */
    public final java.lang.Object waitForFirstLayout(kotlin.coroutines.Continuation<? super kotlin.Unit> r5) throws java.lang.Throwable {
        ...
        L6a:
            ...
            java.lang.Object r5 = kotlin.Result.m6095constructorimpl(r5)
            r1.resumeWith(r5)
        L77:
            kotlin.Unit r5 = kotlin.Unit.INSTANCE
            return r5
