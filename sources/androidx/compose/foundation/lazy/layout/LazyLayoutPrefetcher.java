...
public final class LazyLayoutPrefetcher implements RememberObserver, LazyLayoutPrefetchState.Prefetcher, Runnable, Choreographer.FrameCallback {
                        ...
                        try {
                            ...
                            if (enoughTimeLeft(jNanoTime, nanos, this.averagePremeasureTimeNs)) {
                                ...
                                for (int i = 0; i < placeablesCount; i++) {
                                    precomposeHandle.mo3409premeasure0kLqBqw(i, prefetchRequest.getConstraints());
                                }
    ...
    public LazyLayoutPrefetchState.PrefetchHandle mo895schedulePrefetch0kLqBqw(int index, long constraints) {
