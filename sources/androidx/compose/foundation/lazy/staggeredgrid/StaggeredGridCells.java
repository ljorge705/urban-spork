...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(Density density, int i, int i2) {
            Intrinsics.checkNotNullParameter(density, "<this>");
            return LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.mo571roundToPx0680j_4(this.minSize) + i2), 1), i2);
        }

        public int hashCode() {
            return Dp.m4396hashCodeimpl(this.minSize);
        }

        public boolean equals(Object other) {
            return (other instanceof Adaptive) && Dp.m4395equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }
    }
}
