...
public final class ClipScrollableContainerKt {
    private static final float MaxSupportedElevation = Dp.m4390constructorimpl(30);
    private static final Modifier HorizontalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
        ...
        public Outline mo469createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            ...
            float fMo571roundToPx0680j_4 = density.mo571roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(0.0f, -fMo571roundToPx0680j_4, Size.m1708getWidthimpl(size), Size.m1705getHeightimpl(size) + fMo571roundToPx0680j_4));
        }
    });
    private static final Modifier VerticalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
        ...
        public Outline mo469createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            ...
            Intrinsics.checkNotNullParameter(density, "density");
            float fMo571roundToPx0680j_4 = density.mo571roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(-fMo571roundToPx0680j_4, 0.0f, Size.m1708getWidthimpl(size) + fMo571roundToPx0680j_4, Size.m1705getHeightimpl(size)));
        }
    });
