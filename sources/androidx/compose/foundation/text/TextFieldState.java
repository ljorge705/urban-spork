...
public final class TextFieldState {
    ...
    public TextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope) {
        ...
        this.minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m4388boximpl(Dp.m4390constructorimpl(0)), null, 2, null);
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.TextFieldState$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m1059invokeKlQnJC8(imeAction.getValue());
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m1059invokeKlQnJC8(int i) {
                this.this$0.keyboardActionRunner.m990runActionKlQnJC8(i);
            }
        };
    ...
    public final float m1056getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m4404unboximpl();
    }

    /* renamed from: setMinHeightForSingleLineField-0680j_4, reason: not valid java name */
    public final void m1057setMinHeightForSingleLineField0680j_4(float f) {
        this.minHeightForSingleLineField.setValue(Dp.m4388boximpl(f));
    }
    ...
    public final void m1058updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean softWrap, Density density, FontFamily.Resolver fontFamilyResolver, Function1<? super TextFieldValue, Unit> onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long selectionBackgroundColor) {
        ...
        this.selectionPaint.mo1759setColor8_81llA(selectionBackgroundColor);
        ...
        TextDelegate textDelegateM982updateTextDelegaterm0N8CA = CoreTextKt.m982updateTextDelegaterm0N8CA(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, (CaptureActivity.RESULT_EXIT_USER_FLOW & 32) != 0 ? true : softWrap, (CaptureActivity.RESULT_EXIT_USER_FLOW & 64) != 0 ? TextOverflow.INSTANCE.m4309getClipgIe3tQ8() : 0, (CaptureActivity.RESULT_EXIT_USER_FLOW & 128) != 0 ? Integer.MAX_VALUE : 0, (CaptureActivity.RESULT_EXIT_USER_FLOW & 256) != 0 ? 1 : 0, CollectionsKt.emptyList());
        if (this.textDelegate != textDelegateM982updateTextDelegaterm0N8CA) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM982updateTextDelegaterm0N8CA;
    }
