...
public final class TextFieldScrollerPosition {
    ...
    public final void m1052setPreviousSelection5zctL8(long j) {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m3910getZerod9O1mEE();
    ...
    public final int m1050getOffsetToFollow5zctL8(long selection) {
        return TextRange.m3905getStartimpl(selection) != TextRange.m3905getStartimpl(this.previousSelection) ? TextRange.m3905getStartimpl(selection) : TextRange.m3900getEndimpl(selection) != TextRange.m3900getEndimpl(this.previousSelection) ? TextRange.m3900getEndimpl(selection) : TextRange.m3903getMinimpl(selection);
    }
