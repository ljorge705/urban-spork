...
public final class DeadKeyCombiner {
    ...
    public final Integer m986consumeZmokQxo(KeyEvent event) {
        ...
        int iM3147getUtf16CodePointZmokQxo = KeyEvent_androidKt.m3147getUtf16CodePointZmokQxo(event);
        if ((Integer.MIN_VALUE & iM3147getUtf16CodePointZmokQxo) != 0) {
            this.deadKeyCode = Integer.valueOf(iM3147getUtf16CodePointZmokQxo & Integer.MAX_VALUE);
            return null;
        }
        Integer num = this.deadKeyCode;
        if (num != null) {
            this.deadKeyCode = null;
            Integer numValueOf = Integer.valueOf(KeyCharacterMap.getDeadChar(num.intValue(), iM3147getUtf16CodePointZmokQxo));
            Integer num2 = numValueOf.intValue() != 0 ? numValueOf : null;
            return num2 == null ? Integer.valueOf(iM3147getUtf16CodePointZmokQxo) : num2;
        }
        return Integer.valueOf(iM3147getUtf16CodePointZmokQxo);
    }
}
