...
public final class AndroidCursorHandle_androidKt {
    ...
    public static final void m963CursorHandleULxng0E(final long j, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        final int i2;
        ...
        if ((i2 & 731) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            AndroidSelectionHandles_androidKt.m1072HandlePopupULxng0E(j, HandleReferencePoint.TopMiddle, ComposableLambdaKt.composableLambda(composerStartRestartGroup, -1458480226, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$1
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$2
            ...
            public final void invoke(Composer composer2, int i3) {
                AndroidCursorHandle_androidKt.m963CursorHandleULxng0E(j, modifier, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void DefaultCursorHandle(final Modifier modifier, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawCursorHandle(SizeKt.m735sizeVpY3zN4(modifier, CursorHandleWidth, CursorHandleHeight)), composerStartRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final Modifier drawCursorHandle(Modifier modifier) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt.drawCursorHandle.1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Color colorM1867boximpl = Color.m1867boximpl(handleColor);
                composer.startReplaceableGroup(1157296644);
                ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
                boolean zChanged = composer.changed(colorM1867boximpl);
                ...
                if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final float fM1708getWidthimpl = Size.m1708getWidthimpl(drawWithCache.m1551getSizeNHjbRc()) / 2.0f;
                            final ImageBitmap imageBitmapCreateHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, fM1708getWidthimpl);
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    transform.mo2348rotateUv8p0NA(45.0f, Offset.INSTANCE.m1655getZeroF1C5BW0());
    ...
    static {
        float fM4390constructorimpl = Dp.m4390constructorimpl(25);
        CursorHandleHeight = fM4390constructorimpl;
        CursorHandleWidth = Dp.m4390constructorimpl(Dp.m4390constructorimpl(fM4390constructorimpl * 2.0f) / 2.4142137f);
    }
}
