...
public final class KeyboardOptions {
    ...
    public /* synthetic */ KeyboardOptions(int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? KeyboardCapitalization.INSTANCE.m4081getNoneIUNYP9k() : i, (i4 & 2) != 0 ? true : z, (i4 & 4) != 0 ? KeyboardType.INSTANCE.m4107getTextPjHm6EE() : i2, (i4 & 8) != 0 ? ImeAction.INSTANCE.m4053getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ KeyboardOptions m991copy3m2b7yw$default(KeyboardOptions keyboardOptions, int i, boolean z, int i2, int i3, int i4, Object obj) {
        ...
        return keyboardOptions.m992copy3m2b7yw(i, z, i2, i3);
    }

    /* renamed from: copy-3m2b7yw, reason: not valid java name */
    public final KeyboardOptions m992copy3m2b7yw(int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return KeyboardCapitalization.m4072equalsimpl0(this.capitalization, keyboardOptions.capitalization) && this.autoCorrect == keyboardOptions.autoCorrect && KeyboardType.m4087equalsimpl0(this.keyboardType, keyboardOptions.keyboardType) && ImeAction.m4041equalsimpl0(this.imeAction, keyboardOptions.imeAction);
    }

    public int hashCode() {
        return (((((KeyboardCapitalization.m4073hashCodeimpl(this.capitalization) * 31) + Boolean.hashCode(this.autoCorrect)) * 31) + KeyboardType.m4088hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4042hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "KeyboardOptions(capitalization=" + ((Object) KeyboardCapitalization.m4074toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4089toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4043toStringimpl(this.imeAction)) + ')';
    }
}
