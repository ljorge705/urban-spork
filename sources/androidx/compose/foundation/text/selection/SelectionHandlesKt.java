...
public final class SelectionHandlesKt {
    ...
    public static final long m1097getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m1639getXimpl(j), Offset.m1640getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m4390constructorimpl(f);
        HandleHeight = Dp.m4390constructorimpl(f);
    }
}
