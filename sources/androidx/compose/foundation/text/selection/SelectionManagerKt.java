...
public final class SelectionManagerKt {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null) {
            ...
            Offset offsetM1118getCurrentDragPosition_m7T9E = selectionManager.m1118getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(offsetM1118getCurrentDragPosition_m7T9E);
            float fM1639getXimpl = Offset.m1639getXimpl(layoutCoordinates.mo3402localPositionOfR5De75A(containerLayoutCoordinates, offsetM1118getCurrentDragPosition_m7T9E.getPackedValue()));
            long jMo1079getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo1079getRangeOfLineContainingjx7JFs(offset);
            Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m3903getMinimpl(jMo1079getRangeOfLineContainingjx7JFs));
            Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(RangesKt.coerceAtLeast(TextRange.m3902getMaximpl(jMo1079getRangeOfLineContainingjx7JFs) - 1, TextRange.m3903getMinimpl(jMo1079getRangeOfLineContainingjx7JFs)));
            float fCoerceIn = RangesKt.coerceIn(fM1639getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
            if (Math.abs(fM1639getXimpl - fCoerceIn) > IntSize.m4550getWidthimpl(j) / 2) {
                return Offset.INSTANCE.m1654getUnspecifiedF1C5BW0();
            }
            return containerLayoutCoordinates.mo3402localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(fCoerceIn, Offset.m1640getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m1669getCenterF1C5BW0())));
        }
        return Offset.INSTANCE.m1654getUnspecifiedF1C5BW0();
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m1129calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager manager, long j) {
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m1677Rect0a9Yr6o(layoutCoordinates.mo3406windowToLocalMKHz9U(rectBoundsInWindow.m1674getTopLeftF1C5BW0()), layoutCoordinates.mo3406windowToLocalMKHz9U(rectBoundsInWindow.m1668getBottomRightF1C5BW0()));
    }

    /* renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m1130containsInclusiveUv8p0NA(Rect containsInclusive, long j) {
