...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m1140getTextFieldSelectionbb3KNj8(TextLayoutResult textLayoutResult, int i, int i2, TextRange textRange, boolean z, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        if (textLayoutResult != null) {
            long jTextRange = TextRangeKt.TextRange(i, i2);
            return (textRange == null && Intrinsics.areEqual(adjustment, SelectionAdjustment.INSTANCE.getCharacter())) ? jTextRange : adjustment.mo1088adjustZXO7KMw(textLayoutResult, jTextRange, -1, z, textRange);
        }
