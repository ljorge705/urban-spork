...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m987cancelsTextSelectionZmokQxo(KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m3138equalsimpl0(KeyEvent_androidKt.m3146getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m3143getKeyUpCS__XNY());
    }
}
