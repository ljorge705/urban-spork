...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo943createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1708getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m1708getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m1708getWidthimpl(size), Size.m1705getHeightimpl(size) - f2);
        Path.lineTo(Size.m1708getWidthimpl(size) - f2, Size.m1705getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m1705getHeightimpl(size));
        Path.lineTo(0.0f, Size.m1705getHeightimpl(size) - bottomEnd);
        Path.close();
