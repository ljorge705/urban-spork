...
final /* data */ class PercentCornerSize implements CornerSize, InspectableValue {
    ...
    public float mo951toPxTmRCtEA(long shapeSize, Density density) {
        ...
        return Size.m1707getMinDimensionimpl(shapeSize) * (this.percent / 100.0f);
    }
