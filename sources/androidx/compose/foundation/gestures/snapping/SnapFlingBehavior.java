...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    /* renamed from: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$longSnap$1, reason: invalid class name and case insensitive filesystem */
    ...
    /* compiled from: SnapFlingBehavior.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "androidx.compose.foundation.gestures.snapping.SnapFlingBehavior", f = "SnapFlingBehavior.kt", i = {}, l = {LDSFile.EF_DG4_TAG}, m = "performFling", n = {}, s = {})
    /* renamed from: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$performFling$3, reason: invalid class name and case insensitive filesystem */
    static final class C02963 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C02963(Continuation<? super C02963> continuation) {
            super(continuation);
        }
    ...
    private SnapFlingBehavior(SnapLayoutInfoProvider snapLayoutInfoProvider, AnimationSpec<Float> animationSpec, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec2, Density density, float f) {
        ...
        this.velocityThreshold = density.mo577toPx0680j_4(f);
    ...
    */
    public final java.lang.Object performFling(androidx.compose.foundation.gestures.ScrollScope r5, float r6, kotlin.jvm.functions.Function1<? super java.lang.Float, kotlin.Unit> r7, kotlin.coroutines.Continuation<? super java.lang.Float> r8) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r8 instanceof androidx.compose.foundation.gestures.snapping.SnapFlingBehavior.C02963
            if (r0 == 0) goto L14
            r0 = r8
            androidx.compose.foundation.gestures.snapping.SnapFlingBehavior$performFling$3 r0 = (androidx.compose.foundation.gestures.snapping.SnapFlingBehavior.C02963) r0
            int r1 = r0.label
    ...
    */
    ...
    public final Object shortSnap(ScrollScope scrollScope, float f, final Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        ...
        return SnapFlingBehaviorKt.animateSnap(scrollScope, fFindClosestOffset, fFindClosestOffset, AnimationStateKt.AnimationState$default(0.0f, f, 0L, 0L, false, 28, null), this.snapAnimationSpec, new Function1<Float, Unit>() { // from class: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior.shortSnap.3
