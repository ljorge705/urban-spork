...
public interface PointerDirectionConfig {
    ...
    float mo526crossAxisDeltak4lQ0M(long offset);

    /* renamed from: mainAxisDelta-k-4lQ0M */
    float mo527mainAxisDeltak4lQ0M(long offset);

    /* renamed from: offsetFromChanges-dBAh8RU */
    long mo528offsetFromChangesdBAh8RU(float mainChange, float crossChange);
}
