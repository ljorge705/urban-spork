...
final class DefaultCheckboxColors implements CheckboxColors {
    ...
    public State<Color> checkmarkColor(ToggleableState state, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C(checkmarkColor)405@15946L61:Checkbox.kt#jmzs0o");
        State<Color> stateM343animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m343animateColorAsStateKTwxG1Y(state == ToggleableState.Off ? this.uncheckedCheckmarkColor : this.checkedCheckmarkColor, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
        composer.endReplaceableGroup();
        return stateM343animateColorAsStateKTwxG1Y;
    }
    ...
    public State<Color> boxColor(boolean z, ToggleableState state, Composer composer, int i) {
        ...
        if (z) {
            ...
            ComposerKt.sourceInformation(composer, "427@16874L61");
            stateRememberUpdatedState = SingleValueAnimationKt.m343animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-2010643841);
            ComposerKt.sourceInformation(composer, "429@16965L28");
    ...
    public State<Color> borderColor(boolean z, ToggleableState state, Composer composer, int i) {
        ...
        if (z) {
            ...
            ComposerKt.sourceInformation(composer, "451@17834L61");
            stateRememberUpdatedState = SingleValueAnimationKt.m343animateColorAsStateKTwxG1Y(j2, AnimationSpecKt.tween$default(state == ToggleableState.Off ? 100 : 50, 0, null, 6, null), null, composer, 0, 4);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-796405600);
            ComposerKt.sourceInformation(composer, "453@17925L28");
            stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1867boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        }
        composer.endReplaceableGroup();
