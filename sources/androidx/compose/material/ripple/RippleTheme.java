...
public interface RippleTheme {
    ...
    long mo1326defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1488defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m1929luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m1914getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m1487defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            if (!lightTheme) {
                return RippleThemeKt.DarkThemeRippleAlpha;
            }
            if (ColorKt.m1929luminance8_81llA(contentColor) > 0.5d) {
