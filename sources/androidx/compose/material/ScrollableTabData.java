...
final class ScrollableTabData {
    ...
    public final void onLaidOut(Density density, int edgeOffset, List<TabPosition> tabPositions, int selectedTab) {
        ...
        BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, null, null, new ScrollableTabData$onLaidOut$1$1(this, calculateTabOffset(tabPosition, density, edgeOffset, tabPositions), null), 3, null);
    }

    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int iMo571roundToPx0680j_4 = density.mo571roundToPx0680j_4(((TabPosition) CollectionsKt.last((List) list)).m1441getRightD9Ej5fM()) + i;
        int maxValue = iMo571roundToPx0680j_4 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.mo571roundToPx0680j_4(tabPosition.getLeft()) - ((maxValue / 2) - (density.mo571roundToPx0680j_4(tabPosition.getWidth()) / 2)), 0, RangesKt.coerceAtLeast(iMo571roundToPx0680j_4 - maxValue, 0));
    }
}
