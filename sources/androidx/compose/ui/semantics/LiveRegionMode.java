...
public final class LiveRegionMode {
    ...
    private static final int Polite = m3737constructorimpl(0);
    private static final int Assertive = m3737constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ LiveRegionMode m3736boximpl(int i) {
    ...
    public static String m3741toStringimpl(int i) {
        return m3739equalsimpl0(i, Polite) ? "Polite" : m3739equalsimpl0(i, Assertive) ? "Assertive" : "Unknown";
    }
}
