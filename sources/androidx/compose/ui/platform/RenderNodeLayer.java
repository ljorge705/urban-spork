...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    public RenderNodeLayer(AndroidComposeView ownerView, Function1<? super Canvas, Unit> drawBlock, Function0<Unit> invalidateParentLayer) {
        ...
        this.transformOrigin = TransformOrigin.INSTANCE.m2258getCenterSzJe1aQ();
    ...
    public void mo3645updateLayerPropertiesdDxrwY(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, Shape shape, boolean clip, RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy, LayoutDirection layoutDirection, Density density) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m1931toArgb8_81llA(ambientShadowColor));
        this.renderNode.setSpotShadowColor(ColorKt.m1931toArgb8_81llA(spotShadowColor));
        ...
        this.renderNode.setPivotX(TransformOrigin.m2253getPivotFractionXimpl(transformOrigin) * this.renderNode.getWidth());
        this.renderNode.setPivotY(TransformOrigin.m2254getPivotFractionYimpl(transformOrigin) * this.renderNode.getHeight());
        ...
        this.renderNode.mo3689setCompositingStrategyaDBOjCE(compositingStrategy);
    ...
    public boolean mo3640isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM1639getXimpl && fM1639getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM1640getYimpl && fM1640getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mo3643resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m2253getPivotFractionXimpl(this.transformOrigin) * f);
        float f2 = iM4549getHeightimpl;
        this.renderNode.setPivotY(TransformOrigin.m2254getPivotFractionYimpl(this.transformOrigin) * f2);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM4550getWidthimpl, this.renderNode.getTop() + iM4549getHeightimpl)) {
    ...
    public void mo3642movegyyYBs(long position) {
        ...
        if (left == iM4508getXimpl && top == iM4509getYimpl) {
            return;
        }
        this.renderNode.offsetLeftAndRight(iM4508getXimpl - left);
        this.renderNode.offsetTopAndBottom(iM4509getYimpl - top);
        triggerRepaint();
        this.matrixCache.invalidate();
    }
    ...
    public void drawLayer(Canvas canvas) {
        ...
        canvas.mo1735concat58bKbWc(this.matrixCache.m3704calculateMatrixGrdbGEg(this.renderNode));
    ...
    public long mo3641mapOffset8S9VItk(long point, boolean inverse) {
        if (inverse) {
            float[] fArrM3703calculateInverseMatrixbWbORWo = this.matrixCache.m3703calculateInverseMatrixbWbORWo(this.renderNode);
        ...
        return androidx.compose.ui.graphics.Matrix.m2107mapMKHz9U(this.matrixCache.m3704calculateMatrixGrdbGEg(this.renderNode), point);
    }
    ...
    public void mapBounds(MutableRect rect, boolean inverse) {
        ...
        androidx.compose.ui.graphics.Matrix.m2109mapimpl(this.matrixCache.m3704calculateMatrixGrdbGEg(this.renderNode), rect);
    }
    ...
    public void mo3644transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m2118timesAssign58bKbWc(matrix, this.matrixCache.m3704calculateMatrixGrdbGEg(this.renderNode));
    }
