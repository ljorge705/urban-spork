...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m1961getAutoNrFUSI();
    ...
    public void mo3689setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m1957equalsimpl0(i, CompositingStrategy.INSTANCE.m1963getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m1957equalsimpl0(i, CompositingStrategy.INSTANCE.m1962getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m1957equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m1963getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m1848clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
