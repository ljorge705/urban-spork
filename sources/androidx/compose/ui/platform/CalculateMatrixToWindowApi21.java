...
final class CalculateMatrixToWindowApi21 implements CalculateMatrixToWindow {
    ...
    private final float[] tmpMatrix = Matrix.m2101constructorimpl$default(null, 1, null);

    @Override // androidx.compose.ui.platform.CalculateMatrixToWindow
    /* renamed from: calculateMatrixToWindow-EL8BTi8 */
    public void mo3677calculateMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        Matrix.m2110resetimpl(matrix);
        m3680transformMatrixToWindowEL8BTi8(view, matrix);
    }

    /* renamed from: transformMatrixToWindow-EL8BTi8, reason: not valid java name */
    private final void m3680transformMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Object parent = view.getParent();
        if (parent instanceof View) {
            m3680transformMatrixToWindowEL8BTi8((View) parent, matrix);
            m3679preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m3679preTranslate3XD1CNM(matrix, view.getLeft(), view.getTop());
        } else {
            view.getLocationInWindow(this.tmpLocation);
            m3679preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m3679preTranslate3XD1CNM(matrix, r0[0], r0[1]);
        }
        ...
        m3678preConcattUYjHk(matrix, viewMatrix);
    }

    /* renamed from: preConcat-tU-YjHk, reason: not valid java name */
    private final void m3678preConcattUYjHk(float[] fArr, android.graphics.Matrix matrix) {
        AndroidMatrixConversions_androidKt.m1751setFromtUYjHk(this.tmpMatrix, matrix);
        AndroidComposeView_androidKt.m3676preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* renamed from: preTranslate-3XD1CNM, reason: not valid java name */
    private final void m3679preTranslate3XD1CNM(float[] fArr, float f, float f2) {
        Matrix.m2110resetimpl(this.tmpMatrix);
        Matrix.m2121translateimpl$default(this.tmpMatrix, f, f2, 0.0f, 4, null);
        AndroidComposeView_androidKt.m3676preTransformJiSxe2E(fArr, this.tmpMatrix);
    }
}
