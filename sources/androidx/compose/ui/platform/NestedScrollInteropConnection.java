...
public final class NestedScrollInteropConnection implements NestedScrollConnection {
    ...
    public long mo585onPreScrollOzD1aCk(long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m3722getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m3724toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedPreScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1639getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1640getYimpl(available)), this.consumedScrollCache, null, NestedScrollInteropConnectionKt.m3724toViewTypeGyEprt8(source));
            return NestedScrollInteropConnectionKt.m3723toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
    ...
    public long mo584onPostScrollDzOQY0M(long consumed, long available, int source) {
        if (this.nestedScrollChildHelper.startNestedScroll(NestedScrollInteropConnectionKt.m3722getScrollAxesk4lQ0M(available), NestedScrollInteropConnectionKt.m3724toViewTypeGyEprt8(source))) {
            ArraysKt.fill$default(this.consumedScrollCache, 0, 0, 0, 6, (Object) null);
            this.nestedScrollChildHelper.dispatchNestedScroll(NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1639getXimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1640getYimpl(consumed)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1639getXimpl(available)), NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m1640getYimpl(available)), null, NestedScrollInteropConnectionKt.m3724toViewTypeGyEprt8(source), this.consumedScrollCache);
            return NestedScrollInteropConnectionKt.m3723toOffsetUv8p0NA(this.consumedScrollCache, available);
        }
        return Offset.INSTANCE.m1655getZeroF1C5BW0();
    }
    ...
    public Object mo754onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedPreFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m4615getXimpl(j)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m4616getYimpl(j)))) {
            j = Velocity.INSTANCE.m4626getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m4606boximpl(j);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo583onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        if (!this.nestedScrollChildHelper.dispatchNestedFling(NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m4615getXimpl(j2)), NestedScrollInteropConnectionKt.toViewVelocity(Velocity.m4616getYimpl(j2)), true)) {
            j2 = Velocity.INSTANCE.m4626getZero9UxMQ8M();
        }
        interruptOngoingScrolls();
        return Velocity.m4606boximpl(j2);
    }
