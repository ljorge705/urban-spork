    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayListEmptyList.add(Offset.m1628boximpl(OffsetKt.Offset(Math.abs(Offset.m1639getXimpl(semanticsNode4.getBoundsInRoot().m1669getCenterF1C5BW0()) - Offset.m1639getXimpl(semanticsNode3.getBoundsInRoot().m1669getCenterF1C5BW0())), Math.abs(Offset.m1640getYimpl(semanticsNode4.getBoundsInRoot().m1669getCenterF1C5BW0()) - Offset.m1640getYimpl(semanticsNode3.getBoundsInRoot().m1669getCenterF1C5BW0())))));
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m1628boximpl(Offset.m1644plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m1630component2impl(packedValue) < Offset.m1629component1impl(packedValue);
    }
