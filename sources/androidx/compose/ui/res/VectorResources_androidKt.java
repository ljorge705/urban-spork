...
public final class VectorResources_androidKt {
    ...
    public static final ImageVector vectorResource(ImageVector.Companion companion, Resources.Theme theme, Resources res, int i) throws XmlPullParserException, Resources.NotFoundException, IOException {
        Intrinsics.checkNotNullParameter(companion, "<this>");
    ...
    public static final ImageVectorCache.ImageVectorEntry loadVectorResourceInner(Resources.Theme theme, Resources res, XmlResourceParser parser, int i) throws XmlPullParserException, IllegalArgumentException {
        Intrinsics.checkNotNullParameter(res, "res");
