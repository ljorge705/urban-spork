...
public final class StringResources_androidKt {
    ...
    public static final String stringResource(int i, Object[] formatArgs, Composer composer, int i2) throws Resources.NotFoundException {
    ...
    public static final String pluralStringResource(int i, int i2, Object[] formatArgs, Composer composer, int i3) throws Resources.NotFoundException {
        Intrinsics.checkNotNullParameter(formatArgs, "formatArgs");
