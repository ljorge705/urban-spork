...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m2514rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        long jM1913getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m1913getUnspecified0d7_KjU() : j;
        int iM1819getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m1819getSrcIn0nO6VwU() : i;
        ...
        VectorPainter vectorPainterM2515rememberVectorPaintervIP8VLU = m2515rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM1913getUnspecified0d7_KjU, iM1819getSrcIn0nO6VwU, false, content, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return vectorPainterM2515rememberVectorPaintervIP8VLU;
    }

    /* renamed from: rememberVectorPainter-vIP8VLU, reason: not valid java name */
    public static final VectorPainter m2515rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        float fMo577toPx0680j_4 = density.mo577toPx0680j_4(f);
        float fMo577toPx0680j_42 = density.mo577toPx0680j_4(f2);
        if (Float.isNaN(f5)) {
            f5 = fMo577toPx0680j_4;
        }
        if (Float.isNaN(f6)) {
            f6 = fMo577toPx0680j_42;
        }
        Color colorM1867boximpl = Color.m1867boximpl(jM1913getUnspecified0d7_KjU);
        BlendMode blendModeM1787boximpl = BlendMode.m1787boximpl(iM1819getSrcIn0nO6VwU);
        int i4 = i2 >> 15;
        composer.startReplaceableGroup(511388516);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1,2):Composables.kt#9igjgp");
        boolean zChanged = composer.changed(colorM1867boximpl) | composer.changed(blendModeM1787boximpl);
        Object objRememberedValue = composer.rememberedValue();
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = !Color.m1878equalsimpl0(jM1913getUnspecified0d7_KjU, Color.INSTANCE.m1913getUnspecified0d7_KjU()) ? ColorFilter.INSTANCE.m1921tintxETnrds(jM1913getUnspecified0d7_KjU, iM1819getSrcIn0nO6VwU) : null;
        ...
        vectorPainter.m2513setSizeuvyYCjk$ui_release(SizeKt.Size(fMo577toPx0680j_4, fMo577toPx0680j_42));
    ...
    private static final void mirror(DrawScope drawScope, Function1<? super DrawScope, Unit> function1) {
        long jMo2416getCenterF1C5BW0 = drawScope.mo2416getCenterF1C5BW0();
