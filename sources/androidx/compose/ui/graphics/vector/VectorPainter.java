...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m1696boximpl(Size.INSTANCE.m1717getZeroNHjbRc()), null, 2, null);
    ...
    public final long m2512getSizeNHjbRc$ui_release() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m2513setSizeuvyYCjk$ui_release(long j) {
        this.size.setValue(Size.m1696boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m2512getSizeNHjbRc$ui_release();
    }
