...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m1716getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m1704equalsimpl0(this.previousDrawSize, drawScope.mo2417getSizeNHjbRc())) {
            this.root.setScaleX(Size.m1708getWidthimpl(drawScope.mo2417getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m1705getHeightimpl(drawScope.mo2417getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m2493drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m1708getWidthimpl(drawScope.mo2417getSizeNHjbRc())), (int) Math.ceil(Size.m1705getHeightimpl(drawScope.mo2417getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo2417getSizeNHjbRc();
        }
