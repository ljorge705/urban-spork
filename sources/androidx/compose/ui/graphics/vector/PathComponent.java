...
public final class PathComponent extends VNode {
    ...
    public final void m2505setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo1773setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m2506setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m2507setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (this.trimPathStart == 0.0f && this.trimPathEnd == 1.0f) {
            Path.m2139addPathUv8p0NA$default(this.renderPath, this.path, 0L, 2, null);
            return;
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m2407drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m2407drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
