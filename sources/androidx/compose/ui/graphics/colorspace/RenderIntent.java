...
public final class RenderIntent {
    ...
    private static final int Perceptual = m2293constructorimpl(0);
    private static final int Relative = m2293constructorimpl(1);
    private static final int Saturation = m2293constructorimpl(2);
    private static final int Absolute = m2293constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ RenderIntent m2292boximpl(int i) {
        return new RenderIntent(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2293constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2294equalsimpl(int i, Object obj) {
        return (obj instanceof RenderIntent) && i == ((RenderIntent) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2295equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2296hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2294equalsimpl(this.value, obj);
    }
    ...
    public String toString() {
        return m2297toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2297toStringimpl(int i) {
        return m2295equalsimpl0(i, Perceptual) ? "Perceptual" : m2295equalsimpl0(i, Relative) ? "Relative" : m2295equalsimpl0(i, Saturation) ? ExifInterface.TAG_SATURATION : m2295equalsimpl0(i, Absolute) ? "Absolute" : "Unknown";
    }
}
