...
public final class ImageBitmapConfig {
    ...
    private static final int Argb8888 = m2086constructorimpl(0);
    private static final int Alpha8 = m2086constructorimpl(1);
    private static final int Rgb565 = m2086constructorimpl(2);
    private static final int F16 = m2086constructorimpl(3);
    private static final int Gpu = m2086constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ImageBitmapConfig m2085boximpl(int i) {
    ...
    public static boolean m2087equalsimpl(int i, Object obj) {
        return (obj instanceof ImageBitmapConfig) && i == ((ImageBitmapConfig) obj).m2091unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2093getArgb8888_sVssgQ() {
            return ImageBitmapConfig.Argb8888;
        }

        /* renamed from: getAlpha8-_sVssgQ, reason: not valid java name */
        public final int m2092getAlpha8_sVssgQ() {
            return ImageBitmapConfig.Alpha8;
        }

        /* renamed from: getRgb565-_sVssgQ, reason: not valid java name */
        public final int m2096getRgb565_sVssgQ() {
            return ImageBitmapConfig.Rgb565;
        }

        /* renamed from: getF16-_sVssgQ, reason: not valid java name */
        public final int m2094getF16_sVssgQ() {
            return ImageBitmapConfig.F16;
        }

        /* renamed from: getGpu-_sVssgQ, reason: not valid java name */
        public final int m2095getGpu_sVssgQ() {
    ...
    public static String m2090toStringimpl(int i) {
        return m2088equalsimpl0(i, Argb8888) ? "Argb8888" : m2088equalsimpl0(i, Alpha8) ? "Alpha8" : m2088equalsimpl0(i, Rgb565) ? "Rgb565" : m2088equalsimpl0(i, F16) ? "F16" : m2088equalsimpl0(i, Gpu) ? "Gpu" : "Unknown";
    }
}
