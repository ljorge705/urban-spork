...
public final class PathOperation {
    ...
    private static final int Difference = m2153constructorimpl(0);
    private static final int Intersect = m2153constructorimpl(1);
    private static final int Union = m2153constructorimpl(2);
    private static final int Xor = m2153constructorimpl(3);
    private static final int ReverseDifference = m2153constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m2152boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2159getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c, reason: not valid java name */
        public final int m2160getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c, reason: not valid java name */
        public final int m2162getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c, reason: not valid java name */
        public final int m2163getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c, reason: not valid java name */
        public final int m2161getReverseDifferenceb3I0S0c() {
    ...
    public static String m2157toStringimpl(int i) {
        return m2155equalsimpl0(i, Difference) ? "Difference" : m2155equalsimpl0(i, Intersect) ? "Intersect" : m2155equalsimpl0(i, Union) ? "Union" : m2155equalsimpl0(i, Xor) ? "Xor" : m2155equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
}
