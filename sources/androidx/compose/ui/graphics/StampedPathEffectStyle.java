...
public final class StampedPathEffectStyle {
    ...
    private static final int Translate = m2204constructorimpl(0);
    private static final int Rotate = m2204constructorimpl(1);
    private static final int Morph = m2204constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StampedPathEffectStyle m2203boximpl(int i) {
        return new StampedPathEffectStyle(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2204constructorimpl(int i) {
        return i;
    }
    ...
    public static String m2208toStringimpl(int i) {
        return m2206equalsimpl0(i, Translate) ? "Translate" : m2206equalsimpl0(i, Rotate) ? "Rotate" : m2206equalsimpl0(i, Morph) ? "Morph" : "Unknown";
    }
}
