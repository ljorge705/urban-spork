...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m2258getCenterSzJe1aQ();
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m1961getAutoNrFUSI();
    private long size = Size.INSTANCE.m1716getUnspecifiedNHjbRc();
    ...
    public void mo2062setAmbientShadowColor8_81llA(long j) {
    ...
    public void mo2063setCompositingStrategyaDBOjCE(int i) {
    ...
    public void m2179setSizeuvyYCjk(long j) {
        this.size = j;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setSpotShadowColor-8_81llA */
    public void mo2064setSpotShadowColor8_81llA(long j) {
        this.spotShadowColor = j;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setTransformOrigin-__ExYCQ */
    public void mo2065setTransformOrigin__ExYCQ(long j) {
    ...
    public final void reset() {
        ...
        mo2062setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo2064setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo2065setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m2258getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo2063setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m1961getAutoNrFUSI());
        m2179setSizeuvyYCjk(Size.INSTANCE.m1716getUnspecifiedNHjbRc());
    }
}
