...
public final class AndroidPath implements Path {
    ...
    public int mo1771getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m2150getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m2151getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo1773setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m2146equalsimpl0(i, PathFillType.INSTANCE.m2150getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m1614getXimpl(roundRect.m1689getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m1615getYimpl(roundRect.m1689getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m1614getXimpl(roundRect.m1690getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m1615getYimpl(roundRect.m1690getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m1614getXimpl(roundRect.m1688getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m1615getYimpl(roundRect.m1688getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m1614getXimpl(roundRect.m1687getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m1615getYimpl(roundRect.m1687getBottomLeftCornerRadiuskKHJgLs());
    ...
    public void mo1774translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m1639getXimpl(offset), Offset.m1640getYimpl(offset));
    ...
    public boolean mo1772opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m2155equalsimpl0(operation, PathOperation.INSTANCE.m2159getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m2155equalsimpl0(operation, PathOperation.INSTANCE.m2160getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m2155equalsimpl0(operation, PathOperation.INSTANCE.m2161getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m2155equalsimpl0(operation, PathOperation.INSTANCE.m2162getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
    ...
    public void mo1770addPathUv8p0NA(Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m1639getXimpl(offset), Offset.m1640getYimpl(offset));
            return;
        }
        throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
    }
