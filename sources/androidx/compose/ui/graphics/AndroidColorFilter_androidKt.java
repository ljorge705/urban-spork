...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m1746actualTintColorFilterxETnrds(long j, int i) {
        PorterDuffColorFilter porterDuffColorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            porterDuffColorFilter = BlendModeColorFilterHelper.INSTANCE.m1823BlendModeColorFilterxETnrds(j, i);
        } else {
            porterDuffColorFilter = new PorterDuffColorFilter(ColorKt.m1931toArgb8_81llA(j), AndroidBlendMode_androidKt.m1732toPorterDuffModes9anfk8(i));
        }
        return new ColorFilter(porterDuffColorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final ColorFilter m1744actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final ColorFilter m1745actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m1931toArgb8_81llA(j), ColorKt.m1931toArgb8_81llA(j2)));
    }
}
