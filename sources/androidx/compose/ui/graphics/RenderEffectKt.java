...
public final class RenderEffectKt {
    ...
    public static /* synthetic */ BlurEffect m2176BlurEffect3YTHUZs$default(float f, float f2, int i, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = TileMode.INSTANCE.m2240getClamp3opZhB0();
        }
        return m2175BlurEffect3YTHUZs(f, f2, i);
    }

    /* renamed from: BlurEffect-3YTHUZs, reason: not valid java name */
    public static final BlurEffect m2175BlurEffect3YTHUZs(float f, float f2, int i) {
