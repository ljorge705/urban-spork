...
public final class ClipOp {
    ...
    private static final int Difference = m1859constructorimpl(0);
    private static final int Intersect = m1859constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ClipOp m1858boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static String m1863toStringimpl(int i) {
        return m1861equalsimpl0(i, Difference) ? "Difference" : m1861equalsimpl0(i, Intersect) ? "Intersect" : "Unknown";
    }
}
