...
public final class StrokeJoin {
    ...
    private static final int Miter = m2224constructorimpl(0);
    private static final int Round = m2224constructorimpl(1);
    private static final int Bevel = m2224constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeJoin m2223boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m2231getMiterLxFBmk8() {
            return StrokeJoin.Miter;
        }

        /* renamed from: getRound-LxFBmk8, reason: not valid java name */
        public final int m2232getRoundLxFBmk8() {
            return StrokeJoin.Round;
        }

        /* renamed from: getBevel-LxFBmk8, reason: not valid java name */
        public final int m2230getBevelLxFBmk8() {
    ...
    public static String m2228toStringimpl(int i) {
        return m2226equalsimpl0(i, Miter) ? "Miter" : m2226equalsimpl0(i, Round) ? "Round" : m2226equalsimpl0(i, Bevel) ? "Bevel" : "Unknown";
    }
}
