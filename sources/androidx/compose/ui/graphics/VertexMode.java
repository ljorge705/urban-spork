...
public final class VertexMode {
    ...
    private static final int Triangles = m2260constructorimpl(0);
    private static final int TriangleStrip = m2260constructorimpl(1);
    private static final int TriangleFan = m2260constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m2259boximpl(int i) {
        return new VertexMode(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2260constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2261equalsimpl(int i, Object obj) {
        return (obj instanceof VertexMode) && i == ((VertexMode) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2262equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m2263hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2261equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2263hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2268getTrianglesc2xauaI() {
            return VertexMode.Triangles;
        }

        /* renamed from: getTriangleStrip-c2xauaI, reason: not valid java name */
        public final int m2267getTriangleStripc2xauaI() {
            return VertexMode.TriangleStrip;
        }

        /* renamed from: getTriangleFan-c2xauaI, reason: not valid java name */
        public final int m2266getTriangleFanc2xauaI() {
            return VertexMode.TriangleFan;
        }
    }

    public String toString() {
        return m2264toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2264toStringimpl(int i) {
        return m2262equalsimpl0(i, Triangles) ? "Triangles" : m2262equalsimpl0(i, TriangleStrip) ? "TriangleStrip" : m2262equalsimpl0(i, TriangleFan) ? "TriangleFan" : "Unknown";
    }
}
