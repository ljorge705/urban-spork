...
public final class PathFillType {
    ...
    private static final int NonZero = m2144constructorimpl(0);
    private static final int EvenOdd = m2144constructorimpl(1);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathFillType m2143boximpl(int i) {
        return new PathFillType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2144constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m2151getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os, reason: not valid java name */
        public final int m2150getEvenOddRgk1Os() {
    ...
    public static String m2148toStringimpl(int i) {
        return m2146equalsimpl0(i, NonZero) ? "NonZero" : m2146equalsimpl0(i, EvenOdd) ? "EvenOdd" : "Unknown";
    }
}
