...
public final class StrokeCap {
    ...
    private static final int Butt = m2214constructorimpl(0);
    private static final int Round = m2214constructorimpl(1);
    private static final int Square = m2214constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StrokeCap m2213boximpl(int i) {
        return new StrokeCap(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m2214constructorimpl(int i) {
        return i;
    }
    ...
    public boolean equals(Object obj) {
        return m2215equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2217hashCodeimpl(this.value);
    }
    ...
    public static final class Companion {
        ...
        public final int m2220getButtKaPHkGw() {
            return StrokeCap.Butt;
        }

        /* renamed from: getRound-KaPHkGw, reason: not valid java name */
        public final int m2221getRoundKaPHkGw() {
            return StrokeCap.Round;
        }

        /* renamed from: getSquare-KaPHkGw, reason: not valid java name */
        public final int m2222getSquareKaPHkGw() {
    ...
    public String toString() {
        return m2218toStringimpl(this.value);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2218toStringimpl(int i) {
        return m2216equalsimpl0(i, Butt) ? "Butt" : m2216equalsimpl0(i, Round) ? "Round" : m2216equalsimpl0(i, Square) ? "Square" : "Unknown";
    }
}
