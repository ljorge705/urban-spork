...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m1918tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m1819getSrcIn0nO6VwU();
            }
            return companion.m1921tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m1921tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m1746actualTintColorFilterxETnrds(color, blendMode);
        }

        /* renamed from: colorMatrix-jHG-Opc, reason: not valid java name */
        public final ColorFilter m1919colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m1744actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI, reason: not valid java name */
        public final ColorFilter m1920lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m1745actualLightingColorFilterOWjLjI(multiply, add);
        }
    }
}
