...
public final class SolidColor extends Brush {
    ...
    public void mo1824applyToPq9zytI(long size, Paint p, float alpha) {
        long jM1876copywmQWz5c$default;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (alpha == 1.0f) {
            jM1876copywmQWz5c$default = this.value;
        } else {
            long j = this.value;
            jM1876copywmQWz5c$default = Color.m1876copywmQWz5c$default(j, Color.m1879getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        }
        p.mo1759setColor8_81llA(jM1876copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m1878equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m1885toStringimpl(this.value)) + ')';
    }
}
