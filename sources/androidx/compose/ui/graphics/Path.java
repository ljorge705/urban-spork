...
public interface Path {
    ...
    void mo1770addPathUv8p0NA(Path path, long offset);
    ...
    boolean mo1772opN5in7k0(Path path1, Path path2, int operation);
    ...
    void mo1773setFillTypeoQ8Xj4U(int i);

    /* renamed from: translate-k-4lQ0M */
    void mo1774translatek4lQ0M(long offset);
    ...
    static /* synthetic */ void m2139addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj != null) {
        ...
        path.mo1770addPathUv8p0NA(path2, j);
    }
    ...
    public static final class Companion {
        ...
        public final Path m2140combinexh6zSI8(int operation, Path path1, Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo1772opN5in7k0(path1, path2, operation)) {
                return Path;
            }
