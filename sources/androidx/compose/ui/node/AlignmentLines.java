...
public abstract class AlignmentLines {
    ...
    protected abstract long mo3481calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo3481calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            iRoundToInt = MathKt.roundToInt(Offset.m1640getYimpl(jOffset));
        } else {
            iRoundToInt = MathKt.roundToInt(Offset.m1639getXimpl(jOffset));
        }
