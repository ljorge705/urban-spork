...
public final class MeasureAndLayoutDelegate {
    ...
    public MeasureAndLayoutDelegate(LayoutNode root) {
        ...
        this.consistencyChecker = Owner.INSTANCE.getEnableExtraAssertions() ? new LayoutTreeConsistencyChecker(root, depthSortedSet, mutableVector.asMutableList()) : null;
    }
    ...
    public final void m3555updateRootConstraintsBRTryo0(long constraints) {
        Constraints constraints2 = this.rootConstraints;
        if (constraints2 != null && Constraints.m4339equalsimpl0(constraints2.getValue(), constraints)) {
            return;
        }
        if (!(!this.duringMeasureLayout)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        this.rootConstraints = Constraints.m4334boximpl(constraints);
    ...
    private final boolean m3552doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM3523lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getMLookaheadScope() == null) {
            return false;
        }
        if (constraints != null) {
            zM3523lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m3527lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM3523lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m3523lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM3523lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM3523lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m3553doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM3524remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            zM3524remeasure_Sx5XlM$ui_release$default = layoutNode.m3528remeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM3524remeasure_Sx5XlM$ui_release$default = LayoutNode.m3524remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM3524remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM3524remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m3554measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (!this.duringMeasureLayout) {
            if (this.rootConstraints != null) {
                ...
                try {
                    ...
                    boolean zM3552doLookaheadRemeasuresdFAvZA = m3552doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4334boximpl(constraints));
                    m3553doRemeasuresdFAvZA(layoutNode, Constraints.m4334boximpl(constraints));
                    if ((zM3552doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode) {
        ...
        boolean zM3552doLookaheadRemeasuresdFAvZA;
        boolean zM3553doRemeasuresdFAvZA;
        int i = 0;
        if (!layoutNode.getIsPlaced() && !getCanAffectParent(layoutNode) && !Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) && !getCanAffectParentInLookahead(layoutNode) && !layoutNode.getAlignmentLinesRequired$ui_release()) {
            return false;
        }
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            zM3552doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m3552doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            zM3553doRemeasuresdFAvZA = m3553doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            zM3553doRemeasuresdFAvZA = false;
            zM3552doLookaheadRemeasuresdFAvZA = false;
        }
        if ((zM3552doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
            layoutNode.lookaheadReplace$ui_release();
        }
        ...
        return zM3553doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m3552doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m3553doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
