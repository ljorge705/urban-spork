...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m4166copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m4168copy8_81llA(j);
    }
    ...
    public final ColorStyle m4168copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m1878equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public final long m4169getValue0d7_KjU() {
        return this.value;
    }

    public int hashCode() {
        return Color.m1884hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m1885toStringimpl(this.value)) + ')';
    }
    ...
    public float getAlpha() {
        return Color.m1879getAlphaimpl(mo4165getColor0d7_KjU());
    }
}
