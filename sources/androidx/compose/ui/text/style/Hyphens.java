...
public final class Hyphens {
    ...
    private static final int None = m4171constructorimpl(1);
    private static final int Auto = m4171constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ Hyphens m4170boximpl(int i) {
        return new Hyphens(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m4171constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m4178getNonevmbZdU8() {
            return Hyphens.None;
        }

        /* renamed from: getAuto-vmbZdU8, reason: not valid java name */
        public final int m4177getAutovmbZdU8() {
            return Hyphens.Auto;
        }
    }
    ...
    public static String m4175toStringimpl(int i) {
        return m4173equalsimpl0(i, None) ? "Hyphens.None" : m4173equalsimpl0(i, Auto) ? "Hyphens.Auto" : "Invalid";
    }
}
