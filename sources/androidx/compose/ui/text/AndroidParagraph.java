...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i, boolean z, long j) {
        ...
        this.ellipsis = z;
        this.constraints = j;
        if (Constraints.m4347getMinHeightimpl(j) != 0 || Constraints.m4348getMinWidthimpl(j) != 0) {
        ...
        int iM3780toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m3780toLayoutAlignAMY3VfE(style.m3933getTextAlignbuA522U());
        TextAlign textAlignM3933getTextAlignbuA522U = style.m3933getTextAlignbuA522U();
        int i2 = textAlignM3933getTextAlignbuA522U == null ? 0 : TextAlign.m4258equalsimpl0(textAlignM3933getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m4264getJustifye0LSkKk()) ? 1 : 0;
        int iM3782toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m3782toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak lineBreakM3931getLineBreakLgCVezo = style.m3931getLineBreakLgCVezo();
        int iM3781toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m3781toLayoutBreakStrategyu6PBz3U(lineBreakM3931getLineBreakLgCVezo != null ? LineBreak.Strategy.m4195boximpl(LineBreak.m4186getStrategyfcGXIks(lineBreakM3931getLineBreakLgCVezo.getMask())) : null);
        LineBreak lineBreakM3931getLineBreakLgCVezo2 = style.m3931getLineBreakLgCVezo();
        int iM3783toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m3783toLayoutLineBreakStyle4a2g8L8(lineBreakM3931getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m4205boximpl(LineBreak.m4187getStrictnessusljTpc(lineBreakM3931getLineBreakLgCVezo2.getMask())) : null);
        LineBreak lineBreakM3931getLineBreakLgCVezo3 = style.m3931getLineBreakLgCVezo();
        int iM3784toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m3784toLayoutLineBreakWordStylegvcdTPQ(lineBreakM3931getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m4216boximpl(LineBreak.m4188getWordBreakjp8hJ3c(lineBreakM3931getLineBreakLgCVezo3.getMask())) : null);
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout textLayoutConstructTextLayout = constructTextLayout(iM3780toLayoutAlignAMY3VfE, i2, truncateAt, i, iM3782toLayoutHyphenationFrequency0_XeFpE, iM3781toLayoutBreakStrategyu6PBz3U, iM3783toLayoutLineBreakStyle4a2g8L8, iM3784toLayoutLineBreakWordStylegvcdTPQ);
        if (!z || textLayoutConstructTextLayout.getHeight() <= Constraints.m4345getMaxHeightimpl(j) || i <= 1) {
            this.layout = textLayoutConstructTextLayout;
        } else {
            int iNumberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(textLayoutConstructTextLayout, Constraints.m4345getMaxHeightimpl(j));
            if (iNumberOfLinesThatFitMaxHeight >= 0 && iNumberOfLinesThatFitMaxHeight != i) {
                textLayoutConstructTextLayout = constructTextLayout(iM3780toLayoutAlignAMY3VfE, i2, truncateAt, RangesKt.coerceAtLeast(iNumberOfLinesThatFitMaxHeight, 1), iM3782toLayoutHyphenationFrequency0_XeFpE, iM3781toLayoutBreakStrategyu6PBz3U, iM3783toLayoutLineBreakStyle4a2g8L8, iM3784toLayoutLineBreakWordStylegvcdTPQ);
            }
            this.layout = textLayoutConstructTextLayout;
        }
        getTextPaint$ui_text_release().m4131setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m4150setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m4346getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo3770getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m1640getYimpl(position)), Offset.m1639getXimpl(position));
    }
    ...
    public final void m3768fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m3903getMinimpl(range), TextRange.m3902getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo3771getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo3773paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4132setColor8_81llA(color);
    ...
    public void mo3772paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int iM4129getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4129getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4132setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4130setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4130setBlendModes9anfk8(iM4129getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo3774painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int iM4129getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4129getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4131setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4130setBlendModes9anfk8(blendMode);
