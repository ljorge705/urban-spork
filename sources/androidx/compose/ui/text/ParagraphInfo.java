...
public final /* data */ class ParagraphInfo {
    ...
    public final long m3807toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m1639getXimpl(j), Offset.m1640getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m1676translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo1774translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m3806toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m3905getStartimpl(j)), toGlobalIndex(TextRange.m3900getEndimpl(j)));
    }
}
