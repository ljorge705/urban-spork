...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo4015createDefaultFO1MlWM;
        ...
        if (fontFamily == null || (fontFamily instanceof DefaultFontFamily)) {
            typefaceMo4015createDefaultFO1MlWM = this.platformTypefaceResolver.mo4015createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m4033getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo4015createDefaultFO1MlWM = this.platformTypefaceResolver.mo4016createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m4033getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo4015createDefaultFO1MlWM = ((AndroidTypeface) typeface).mo4117getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m4033getFontStyle_LCdwA(), typefaceRequest.m4034getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo4015createDefaultFO1MlWM, false, 2, null);
    }
}
