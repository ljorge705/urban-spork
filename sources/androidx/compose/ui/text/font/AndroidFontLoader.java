...
public final class AndroidFontLoader implements PlatformFontLoader {
    ...
    public android.graphics.Typeface loadBlocking(Font font) throws Resources.NotFoundException {
        ...
        } else if (FontLoadingStrategy.m3977equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m3983getOptionalLocalPKNRLFQ())) {
            try {
                Result.Companion companion = Result.INSTANCE;
                AndroidFontLoader androidFontLoader = this;
                Context context3 = this.context;
                Intrinsics.checkNotNullExpressionValue(context3, "context");
                objM6095constructorimpl = Result.m6095constructorimpl(AndroidFontLoader_androidKt.load((ResourceFont) font, context3));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM6095constructorimpl = Result.m6095constructorimpl(ResultKt.createFailure(th));
            }
            typefaceLoad = (android.graphics.Typeface) (Result.m6101isFailureimpl(objM6095constructorimpl) ? null : objM6095constructorimpl);
        } else {
            if (FontLoadingStrategy.m3977equalsimpl0(loadingStrategy, FontLoadingStrategy.INSTANCE.m3981getAsyncPKNRLFQ())) {
                throw new UnsupportedOperationException("Unsupported Async font load path");
            }
            throw new IllegalArgumentException("Unknown loading type " + ((Object) FontLoadingStrategy.m3979toStringimpl(font.getLoadingStrategy())));
        }
