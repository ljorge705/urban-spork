...
public final class FontSynthesis {
    ...
    private static final int None = m3997constructorimpl(0);
    private static final int All = m3997constructorimpl(1);
    private static final int Weight = m3997constructorimpl(2);
    private static final int Style = m3997constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ FontSynthesis m3996boximpl(int i) {
    ...
    public boolean equals(Object obj) {
        return m3998equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m4000hashCodeimpl(this.value);
    }
    ...
    public static String m4003toStringimpl(int i) {
        return m3999equalsimpl0(i, None) ? KeychainModule.AccessControl.NONE : m3999equalsimpl0(i, All) ? "All" : m3999equalsimpl0(i, Weight) ? "Weight" : m3999equalsimpl0(i, Style) ? "Style" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public final int m4006getNoneGVVA2EU() {
            return FontSynthesis.None;
        }

        /* renamed from: getAll-GVVA2EU, reason: not valid java name */
        public final int m4005getAllGVVA2EU() {
            return FontSynthesis.All;
        }

        /* renamed from: getWeight-GVVA2EU, reason: not valid java name */
        public final int m4008getWeightGVVA2EU() {
            return FontSynthesis.Weight;
        }

        /* renamed from: getStyle-GVVA2EU, reason: not valid java name */
        public final int m4007getStyleGVVA2EU() {
            return FontSynthesis.Style;
        }
    }

    /* renamed from: isWeightOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m4002isWeightOnimpl$ui_text_release(int i) {
        return m3999equalsimpl0(i, All) || m3999equalsimpl0(i, Weight);
    }

    /* renamed from: isStyleOn-impl$ui_text_release, reason: not valid java name */
    public static final boolean m4001isStyleOnimpl$ui_text_release(int i) {
        return m3999equalsimpl0(i, All) || m3999equalsimpl0(i, Style);
    }
}
