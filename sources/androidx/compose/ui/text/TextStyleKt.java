...
public final class TextStyleKt {
    ...
    public static final int m3935resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int iM4275getContents_7Xco = TextDirection.INSTANCE.m4275getContents_7Xco();
        if (textDirection != null && TextDirection.m4271equalsimpl0(textDirection.getValue(), iM4275getContents_7Xco)) {
            int i = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i == 1) {
                return TextDirection.INSTANCE.m4276getContentOrLtrs_7Xco();
            }
            if (i == 2) {
                return TextDirection.INSTANCE.m4277getContentOrRtls_7Xco();
            }
        ...
        if (textDirection == null) {
            ...
            if (i2 == 1) {
                return TextDirection.INSTANCE.m4278getLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m4279getRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
