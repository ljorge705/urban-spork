...
public final class PlaceholderExtensions_androidKt {
    ...
    private static /* synthetic */ void m4135getSpanUnitR2X_6o$annotations(long j) {
    }

    /* renamed from: getSpanVerticalAlign-do9X-Gg$annotations, reason: not valid java name */
    private static /* synthetic */ void m4137getSpanVerticalAligndo9XGg$annotations(int i) {
    }
    ...
    private static final void setPlaceholder(Spannable spannable, Placeholder placeholder, int i, int i2, Density density) {
        ...
        SpannableExtensions_androidKt.setSpan(spannable, new PlaceholderSpan(TextUnit.m4571getValueimpl(placeholder.getWidth()), m4134getSpanUnitR2X_6o(placeholder.getWidth()), TextUnit.m4571getValueimpl(placeholder.getHeight()), m4134getSpanUnitR2X_6o(placeholder.getHeight()), density.getFontScale() * density.getDensity(), m4136getSpanVerticalAligndo9XGg(placeholder.getPlaceholderVerticalAlign())), i, i2);
    }

    /* renamed from: getSpanUnit--R2X_6o, reason: not valid java name */
    private static final int m4134getSpanUnitR2X_6o(long j) {
        ...
        return TextUnitType.m4599equalsimpl0(jM4570getTypeUIouoOA, TextUnitType.INSTANCE.m4603getEmUIouoOA()) ? 1 : 2;
    }

    /* renamed from: getSpanVerticalAlign-do9X-Gg, reason: not valid java name */
    private static final int m4136getSpanVerticalAligndo9XGg(int i) {
        if (PlaceholderVerticalAlign.m3833equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m3837getAboveBaselineJ6kI3mc())) {
            return 0;
        }
        if (PlaceholderVerticalAlign.m3833equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m3843getTopJ6kI3mc())) {
            return 1;
        }
        if (PlaceholderVerticalAlign.m3833equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m3838getBottomJ6kI3mc())) {
            return 2;
        }
        if (PlaceholderVerticalAlign.m3833equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m3839getCenterJ6kI3mc())) {
            return 3;
        }
        if (PlaceholderVerticalAlign.m3833equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m3842getTextTopJ6kI3mc())) {
            return 4;
        }
        if (PlaceholderVerticalAlign.m3833equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m3840getTextBottomJ6kI3mc())) {
            return 5;
        }
        if (PlaceholderVerticalAlign.m3833equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m3841getTextCenterJ6kI3mc())) {
            return 6;
        }
