...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public void updateDrawState(TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m4148toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m4147toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
    ...
    private final Paint.Join m4148toAndroidJoinWw9F2mQ(int i) {
        return StrokeJoin.m2226equalsimpl0(i, StrokeJoin.INSTANCE.m2231getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m2226equalsimpl0(i, StrokeJoin.INSTANCE.m2232getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m2226equalsimpl0(i, StrokeJoin.INSTANCE.m2230getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }

    /* renamed from: toAndroidCap-BeK7IIE, reason: not valid java name */
    private final Paint.Cap m4147toAndroidCapBeK7IIE(int i) {
        return StrokeCap.m2216equalsimpl0(i, StrokeCap.INSTANCE.m2220getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m2216equalsimpl0(i, StrokeCap.INSTANCE.m2221getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m2216equalsimpl0(i, StrokeCap.INSTANCE.m2222getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }
}
