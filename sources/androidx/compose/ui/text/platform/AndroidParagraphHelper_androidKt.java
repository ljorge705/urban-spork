...
public final class AndroidParagraphHelper_androidKt {
    ...
    public static final CharSequence createCharSequence(String text, float f, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, List<AnnotatedString.Range<Placeholder>> placeholders, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface, boolean z) {
        ...
        if (spanStyles.isEmpty() && placeholders.isEmpty() && Intrinsics.areEqual(contextTextStyle.getTextIndent(), TextIndent.INSTANCE.getNone()) && TextUnitKt.m4589isUnspecifiedR2X_6o(contextTextStyle.m3932getLineHeightXSAIIZE())) {
            return strProcess;
        }
        ...
        if (isIncludeFontPaddingEnabled(contextTextStyle) && contextTextStyle.getLineHeightStyle() == null) {
            SpannableExtensions_androidKt.m4145setLineHeightr9BaKPg(spannableString, contextTextStyle.m3932getLineHeightXSAIIZE(), f, density);
        } else {
            ...
            SpannableExtensions_androidKt.m4144setLineHeightKmRG4DE(spannable, contextTextStyle.m3932getLineHeightXSAIIZE(), f, density, lineHeightStyle);
        }
