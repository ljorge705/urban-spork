...
public final class SaversKt {
    ...
    private static final Saver<ParagraphStyle, Object> ParagraphStyleSaver = SaverKt.Saver(new Function2<SaverScope, ParagraphStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$ParagraphStyleSaver$1
        ...
        public final Object invoke(SaverScope Saver, ParagraphStyle it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(it.getTextAlign()), SaversKt.save(it.getTextDirection()), SaversKt.save(TextUnit.m4561boximpl(it.getLineHeight()), SaversKt.getSaver(TextUnit.INSTANCE), Saver), SaversKt.save(it.getTextIndent(), SaversKt.getSaver(TextIndent.INSTANCE), Saver));
        }
        ...
        public final ParagraphStyle invoke(Object it) {
            ...
            return new ParagraphStyle(textAlign, textDirection, packedValue, (Intrinsics.areEqual(obj4, (Object) false) || obj4 == null) ? null : SaversKt.getSaver(TextIndent.INSTANCE).restore(obj4), (PlatformParagraphStyle) null, (LineHeightStyle) null, (LineBreak) null, (Hyphens) null, FaceDetectorAvcMLKit.FACE_DETECTION_FRAME_WIDTH, (DefaultConstructorMarker) null);
        }
    });
    private static final Saver<SpanStyle, Object> SpanStyleSaver = SaverKt.Saver(new Function2<SaverScope, SpanStyle, Object>() { // from class: androidx.compose.ui.text.SaversKt$SpanStyleSaver$1
        ...
        public final SpanStyle invoke(Object it) {
            ...
            long jM1887unboximpl = colorRestore.m1887unboximpl();
            Object obj2 = list.get(1);
            ...
            long jM1887unboximpl2 = colorRestore2.m1887unboximpl();
            ...
            return new SpanStyle(jM1887unboximpl, packedValue, fontWeightRestore, fontStyle, fontSynthesis, (FontFamily) null, str, packedValue2, baselineShiftRestore, textGeometricTransformRestore, localeListRestore, jM1887unboximpl2, textDecorationRestore, (Intrinsics.areEqual(obj13, (Object) false) || obj13 == null) ? null : SaversKt.getSaver(Shadow.INSTANCE).restore(obj13), 32, (DefaultConstructorMarker) null);
        }
    });
    ...
    private static final Saver<TextIndent, Object> TextIndentSaver = SaverKt.Saver(new Function2<SaverScope, TextIndent, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextIndentSaver$1
        ...
        public final Object invoke(SaverScope Saver, TextIndent it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(TextUnit.m4561boximpl(it.getFirstLine()), SaversKt.getSaver(TextUnit.INSTANCE), Saver), SaversKt.save(TextUnit.m4561boximpl(it.getRestLine()), SaversKt.getSaver(TextUnit.INSTANCE), Saver));
        }
    ...
    private static final Saver<BaselineShift, Object> BaselineShiftSaver = SaverKt.Saver(new Function2<SaverScope, BaselineShift, Object>() { // from class: androidx.compose.ui.text.SaversKt$BaselineShiftSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, BaselineShift baselineShift) {
            return m3845invoke8a2Sb4w(saverScope, baselineShift.m4157unboximpl());
        }

        /* renamed from: invoke-8a2Sb4w, reason: not valid java name */
        public final Object m3845invoke8a2Sb4w(SaverScope Saver, float f) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
        ...
        public final BaselineShift invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return BaselineShift.m4151boximpl(BaselineShift.m4152constructorimpl(((Float) it).floatValue()));
        }
    });
    private static final Saver<TextRange, Object> TextRangeSaver = SaverKt.Saver(new Function2<SaverScope, TextRange, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextRangeSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextRange textRange) {
            return m3851invokeFDrldGo(saverScope, textRange.getPackedValue());
        }

        /* renamed from: invoke-FDrldGo, reason: not valid java name */
        public final Object m3851invokeFDrldGo(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf((Integer) SaversKt.save(Integer.valueOf(TextRange.m3905getStartimpl(j))), (Integer) SaversKt.save(Integer.valueOf(TextRange.m3900getEndimpl(j))));
        }
        ...
        public final TextRange invoke(Object it) {
            ...
            Intrinsics.checkNotNull(num2);
            return TextRange.m3893boximpl(TextRangeKt.TextRange(iIntValue, num2.intValue()));
        }
    });
    private static final Saver<Shadow, Object> ShadowSaver = SaverKt.Saver(new Function2<SaverScope, Shadow, Object>() { // from class: androidx.compose.ui.text.SaversKt$ShadowSaver$1
        ...
        public final Object invoke(SaverScope Saver, Shadow it) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            Intrinsics.checkNotNullParameter(it, "it");
            return CollectionsKt.arrayListOf(SaversKt.save(Color.m1867boximpl(it.getColor()), SaversKt.getSaver(Color.INSTANCE), Saver), SaversKt.save(Offset.m1628boximpl(it.getOffset()), SaversKt.getSaver(Offset.INSTANCE), Saver), SaversKt.save(Float.valueOf(it.getBlurRadius())));
        }
        ...
        public final Shadow invoke(Object it) {
            ...
            return new Shadow(jM1887unboximpl, packedValue, f.floatValue(), null);
        }
    });
    private static final Saver<Color, Object> ColorSaver = SaverKt.Saver(new Function2<SaverScope, Color, Object>() { // from class: androidx.compose.ui.text.SaversKt$ColorSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Color color) {
            return m3847invoke4WTKRHQ(saverScope, color.m1887unboximpl());
        }

        /* renamed from: invoke-4WTKRHQ, reason: not valid java name */
        public final Object m3847invoke4WTKRHQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return ULong.m6264boximpl(j);
        }
        ...
        public final Color invoke(Object it) {
            Intrinsics.checkNotNullParameter(it, "it");
            return Color.m1867boximpl(Color.m1873constructorimpl(((ULong) it).getData()));
        }
    });
    private static final Saver<TextUnit, Object> TextUnitSaver = SaverKt.Saver(new Function2<SaverScope, TextUnit, Object>() { // from class: androidx.compose.ui.text.SaversKt$TextUnitSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, TextUnit textUnit) {
            return m3853invokempE4wyQ(saverScope, textUnit.getPackedValue());
        }

        /* renamed from: invoke-mpE4wyQ, reason: not valid java name */
        public final Object m3853invokempE4wyQ(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(TextUnit.m4571getValueimpl(j))), SaversKt.save(TextUnitType.m4596boximpl(TextUnit.m4570getTypeUIouoOA(j))));
        }
        ...
        public final TextUnit invoke(Object it) {
            ...
            return TextUnit.m4561boximpl(TextUnitKt.m4583TextUnitanM5pPY(fFloatValue, textUnitType.getType()));
        }
    });
    private static final Saver<Offset, Object> OffsetSaver = SaverKt.Saver(new Function2<SaverScope, Offset, Object>() { // from class: androidx.compose.ui.text.SaversKt$OffsetSaver$1
        ...
        public /* bridge */ /* synthetic */ Object invoke(SaverScope saverScope, Offset offset) {
            return m3849invokeUv8p0NA(saverScope, offset.getPackedValue());
        }

        /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
        public final Object m3849invokeUv8p0NA(SaverScope Saver, long j) {
            Intrinsics.checkNotNullParameter(Saver, "$this$Saver");
            return Offset.m1636equalsimpl0(j, Offset.INSTANCE.m1654getUnspecifiedF1C5BW0()) ? (Serializable) false : CollectionsKt.arrayListOf((Float) SaversKt.save(Float.valueOf(Offset.m1639getXimpl(j))), (Float) SaversKt.save(Float.valueOf(Offset.m1640getYimpl(j))));
        }
        ...
        public final Offset invoke(Object it) {
            ...
            if (Intrinsics.areEqual(it, (Object) false)) {
                return Offset.m1628boximpl(Offset.INSTANCE.m1654getUnspecifiedF1C5BW0());
            }
            List list = (List) it;
            Object obj = list.get(0);
            Float f = obj != null ? (Float) obj : null;
            ...
            return Offset.m1628boximpl(OffsetKt.Offset(fFloatValue, f2.floatValue()));
        }
    });
