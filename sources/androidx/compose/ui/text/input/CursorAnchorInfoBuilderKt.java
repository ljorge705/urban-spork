...
public final class CursorAnchorInfoBuilderKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, TextLayoutResult textLayoutResult, Matrix matrix) {
        ...
        int iM3903getMinimpl = TextRange.m3903getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(iM3903getMinimpl, TextRange.m3902getMaximpl(textFieldValue.getSelection()));
        setInsertionMarker(builder, iM3903getMinimpl, textLayoutResult);
        ...
        int iM3902getMaximpl = composition2 != null ? TextRange.m3902getMaximpl(composition2.getPackedValue()) : -1;
        if (iM3903getMinimpl2 >= 0 && iM3903getMinimpl2 < iM3902getMaximpl) {
            builder.setComposingText(iM3903getMinimpl2, textFieldValue.getText().subSequence(iM3903getMinimpl2, iM3902getMaximpl));
        }
