...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int iM3903getMinimpl = composition != null ? TextRange.m3903getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m3903getMinimpl(state.getSelection()), TextRange.m3902getMaximpl(state.getSelection()), iM3903getMinimpl, composition2 != null ? TextRange.m3902getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m3899getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public boolean performEditorAction(int editorAction) {
        int iM4053getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM4053getDefaulteUduSuo = ImeAction.INSTANCE.m4053getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM4053getDefaulteUduSuo = ImeAction.INSTANCE.m4055getGoeUduSuo();
                    break;
                case 3:
                    iM4053getDefaulteUduSuo = ImeAction.INSTANCE.m4059getSearcheUduSuo();
                    break;
                case 4:
                    iM4053getDefaulteUduSuo = ImeAction.INSTANCE.m4060getSendeUduSuo();
                    break;
                case 5:
                    iM4053getDefaulteUduSuo = ImeAction.INSTANCE.m4056getNexteUduSuo();
                    break;
                case 6:
                    iM4053getDefaulteUduSuo = ImeAction.INSTANCE.m4054getDoneeUduSuo();
                    break;
                case 7:
                    iM4053getDefaulteUduSuo = ImeAction.INSTANCE.m4058getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo4068onImeActionKlQnJC8(iM4053getDefaulteUduSuo);
        return true;
    }

    @Override // android.view.inputmethod.InputConnection
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m3903getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
}
