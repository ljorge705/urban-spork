...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m3903getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m3902getMaximpl(textFieldValue.getSelection());
