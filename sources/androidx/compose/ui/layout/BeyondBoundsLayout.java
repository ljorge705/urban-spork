...
public interface BeyondBoundsLayout {
    ...
    <T> T mo891layouto7g1Pn8(int direction, Function1<? super BeyondBoundsScope, ? extends T> block);
    ...
    public static final class LayoutDirection {
        ...
        private static final int Before = m3374constructorimpl(1);
        private static final int After = m3374constructorimpl(2);
        private static final int Left = m3374constructorimpl(3);
        private static final int Right = m3374constructorimpl(4);
        private static final int Above = m3374constructorimpl(5);
        private static final int Below = m3374constructorimpl(6);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ LayoutDirection m3373boximpl(int i) {
        ...
        public static final class Companion {
            ...
            public final int m3382getBeforehoxUOeE() {
                return LayoutDirection.Before;
            }

            /* renamed from: getAfter-hoxUOeE, reason: not valid java name */
            public final int m3381getAfterhoxUOeE() {
                return LayoutDirection.After;
            }

            /* renamed from: getLeft-hoxUOeE, reason: not valid java name */
            public final int m3384getLefthoxUOeE() {
                return LayoutDirection.Left;
            }

            /* renamed from: getRight-hoxUOeE, reason: not valid java name */
            public final int m3385getRighthoxUOeE() {
                return LayoutDirection.Right;
            }

            /* renamed from: getAbove-hoxUOeE, reason: not valid java name */
            public final int m3380getAbovehoxUOeE() {
                return LayoutDirection.Above;
            }

            /* renamed from: getBelow-hoxUOeE, reason: not valid java name */
            public final int m3383getBelowhoxUOeE() {
        ...
        public static String m3378toStringimpl(int i) {
            return m3376equalsimpl0(i, Before) ? "Before" : m3376equalsimpl0(i, After) ? "After" : m3376equalsimpl0(i, Left) ? "Left" : m3376equalsimpl0(i, Right) ? "Right" : m3376equalsimpl0(i, Above) ? "Above" : m3376equalsimpl0(i, Below) ? "Below" : "invalid LayoutDirection";
        }
    }
}
