...
public interface ContentScale {
    ...
    long mo3387computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3387computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3393computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3393computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3393computeFillMaxDimensioniLBOSCw, fM3393computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3387computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3394computeFillMinDimensioniLBOSCw = ContentScaleKt.m3394computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3394computeFillMinDimensioniLBOSCw, fM3394computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3387computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3392computeFillHeightiLBOSCw = ContentScaleKt.m3392computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3392computeFillHeightiLBOSCw, fM3392computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3387computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3395computeFillWidthiLBOSCw = ContentScaleKt.m3395computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3395computeFillWidthiLBOSCw, fM3395computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3387computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m1708getWidthimpl(srcSize) > Size.m1708getWidthimpl(dstSize) || Size.m1705getHeightimpl(srcSize) > Size.m1705getHeightimpl(dstSize)) {
                    float fM3394computeFillMinDimensioniLBOSCw = ContentScaleKt.m3394computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(fM3394computeFillMinDimensioniLBOSCw, fM3394computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3387computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m3395computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m3392computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
