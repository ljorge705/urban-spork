...
public interface MeasureScope extends IntrinsicMeasureScope {
    ...
    public static final class DefaultImpls {
        ...
        public static int m3424roundToPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo570roundToPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: roundToPx-0680j_4, reason: not valid java name */
        public static int m3425roundToPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo571roundToPx0680j_4(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA, reason: not valid java name */
        public static float m3426toDpGaN1DYA(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo572toDpGaN1DYA(j);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3427toDpu2uoSUM(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo573toDpu2uoSUM(f);
        }

        @Deprecated
        /* renamed from: toDp-u2uoSUM, reason: not valid java name */
        public static float m3428toDpu2uoSUM(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo574toDpu2uoSUM(i);
        }

        @Deprecated
        /* renamed from: toDpSize-k-rfVVM, reason: not valid java name */
        public static long m3429toDpSizekrfVVM(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo575toDpSizekrfVVM(j);
        }

        @Deprecated
        /* renamed from: toPx--R2X_6o, reason: not valid java name */
        public static float m3430toPxR2X_6o(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo576toPxR2X_6o(j);
        }

        @Deprecated
        /* renamed from: toPx-0680j_4, reason: not valid java name */
        public static float m3431toPx0680j_4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo577toPx0680j_4(f);
        }
        ...
        public static long m3432toSizeXkaWNTQ(MeasureScope measureScope, long j) {
            return MeasureScope.super.mo578toSizeXkaWNTQ(j);
        }

        @Deprecated
        /* renamed from: toSp-0xMU5do, reason: not valid java name */
        public static long m3433toSp0xMU5do(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo579toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3434toSpkPz2Gy4(MeasureScope measureScope, float f) {
            return MeasureScope.super.mo580toSpkPz2Gy4(f);
        }

        @Deprecated
        /* renamed from: toSp-kPz2Gy4, reason: not valid java name */
        public static long m3435toSpkPz2Gy4(MeasureScope measureScope, int i) {
            return MeasureScope.super.mo581toSpkPz2Gy4(i);
        }
