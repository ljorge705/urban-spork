...
public final class AnimatedVisibilityClock implements ComposeAnimationClock<AnimatedVisibilityComposeAnimation, AnimatedVisibilityState> {
    ...
    public AnimatedVisibilityClock(AnimatedVisibilityComposeAnimation animation) {
        String strM4332getEnterjXw82LU;
        Intrinsics.checkNotNullParameter(animation, "animation");
        this.animation = animation;
        if (getAnimation().m4318getAnimationObject().getCurrentState().booleanValue()) {
            strM4332getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m4333getExitjXw82LU();
        } else {
            strM4332getEnterjXw82LU = AnimatedVisibilityState.INSTANCE.m4332getEnterjXw82LU();
        }
        this.state = strM4332getEnterjXw82LU;
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ ComposeAnimationState getState() {
        return AnimatedVisibilityState.m4325boximpl(getState());
    }

    @Override // androidx.compose.ui.tooling.animation.clock.ComposeAnimationClock
    public /* bridge */ /* synthetic */ void setState(ComposeAnimationState composeAnimationState) {
        m4324setState7IW2chM(((AnimatedVisibilityState) composeAnimationState).m4331unboximpl());
    }

    /* renamed from: setState-7IW2chM, reason: not valid java name */
    public void m4324setState7IW2chM(String value) {
    ...
    public void setStateParameters(Object par1, Object par2) {
        ...
        m4324setState7IW2chM(((AnimatedVisibilityState) par1).m4331unboximpl());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        Transition<Boolean> transitionM4318getAnimationObject = getAnimation().m4318getAnimationObject();
        Pair<Boolean, Boolean> pairM4322toCurrentTargetPair7IW2chM = m4322toCurrentTargetPair7IW2chM(getState());
        transitionM4318getAnimationObject.seek(Boolean.valueOf(pairM4322toCurrentTargetPair7IW2chM.component1().booleanValue()), Boolean.valueOf(pairM4322toCurrentTargetPair7IW2chM.component2().booleanValue()), animationTimeNanos);
    }
    ...
    public List<TransitionInfo> getTransitions(long stepMillis) {
        Transition<Object> childTransition = getAnimation().getChildTransition();
        if (childTransition != null) {
            List<Transition<?>.TransitionAnimationState<?, ?>> listAllAnimations = UtilsKt.allAnimations(childTransition);
            ...
            while (it.hasNext()) {
                arrayList.add(UtilsKt.createTransitionInfo((Transition.TransitionAnimationState) it.next(), stepMillis));
            }
            List listSortedWith = CollectionsKt.sortedWith(arrayList, new Comparator() { // from class: androidx.compose.ui.tooling.animation.clock.AnimatedVisibilityClock$getTransitions$lambda$4$$inlined$sortedBy$1
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        ...
        if (childTransition != null) {
            ...
            List listSortedWith = CollectionsKt.sortedWith(arrayList, new Comparator() { // from class: androidx.compose.ui.tooling.animation.clock.AnimatedVisibilityClock$getAnimatedProperties$lambda$8$$inlined$sortedBy$1
                @Override // java.util.Comparator
                public final int compare(T t, T t2) {
    ...
    private final Pair<Boolean, Boolean> m4322toCurrentTargetPair7IW2chM(String str) {
        return AnimatedVisibilityState.m4328equalsimpl0(str, AnimatedVisibilityState.INSTANCE.m4332getEnterjXw82LU()) ? TuplesKt.to(false, true) : TuplesKt.to(true, false);
    }
}
