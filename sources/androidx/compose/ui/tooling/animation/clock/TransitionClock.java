...
public final class TransitionClock<T> implements ComposeAnimationClock<TransitionBasedAnimation<T>, TargetState<T>> {
    ...
    public TransitionClock(TransitionBasedAnimation<T> animation) {
        ...
        this.state = new TargetState<>(getAnimation().m4317getAnimationObject().getCurrentState(), getAnimation().m4317getAnimationObject().getTargetState());
    }
    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        List<Transition<?>.TransitionAnimationState<?, ?>> listAllAnimations = UtilsKt.allAnimations(getAnimation().m4317getAnimationObject());
    ...
    public long getMaxDurationPerIteration() {
        return UtilsKt.nanosToMillis(getAnimation().m4317getAnimationObject().getTotalDurationNanos());
    }
    ...
    public void setClockTime(long animationTimeNanos) {
        getAnimation().m4317getAnimationObject().seek(getState().getInitial(), getState().getTarget(), animationTimeNanos);
    }
}
