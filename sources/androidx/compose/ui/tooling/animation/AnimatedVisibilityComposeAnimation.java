...
public final class AnimatedVisibilityComposeAnimation implements ComposeAnimation {
    ...
    public Transition<Boolean> m4318getAnimationObject() {
    ...
    public AnimatedVisibilityComposeAnimation(Transition<Boolean> animationObject, String str) {
        ...
        this.states = SetsKt.setOf((Object[]) new AnimatedVisibilityState[]{AnimatedVisibilityState.m4325boximpl(AnimatedVisibilityState.INSTANCE.m4332getEnterjXw82LU()), AnimatedVisibilityState.m4325boximpl(AnimatedVisibilityState.INSTANCE.m4333getExitjXw82LU())});
    }

    public final Transition<Object> getChildTransition() {
        Object orNull = CollectionsKt.getOrNull(m4318getAnimationObject().getTransitions(), 0);
