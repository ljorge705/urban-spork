...
public final class PlatformHapticFeedbackType {
    ...
    private static final int LongPress = HapticFeedbackType.m2525constructorimpl(0);
    private static final int TextHandleMove = HapticFeedbackType.m2525constructorimpl(9);

    /* renamed from: getLongPress-5zf0vsI, reason: not valid java name */
    public final int m2533getLongPress5zf0vsI() {
        return LongPress;
    }

    /* renamed from: getTextHandleMove-5zf0vsI, reason: not valid java name */
    public final int m2534getTextHandleMove5zf0vsI() {
