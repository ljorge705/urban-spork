...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m4526getSizeYbymL2g$annotations() {
    }
    ...
    public final long m4534getSizeYbymL2g() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: translate--gyyYBs, reason: not valid java name */
    public final IntRect m4538translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m4508getXimpl(offset), this.top + IntOffset.m4509getYimpl(offset), this.right + IntOffset.m4508getXimpl(offset), this.bottom + IntOffset.m4509getYimpl(offset));
    }
