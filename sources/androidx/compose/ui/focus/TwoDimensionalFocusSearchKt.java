...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m1604twoDimensionalFocusSearchOMvw8(FocusTargetModifierNode twoDimensionalFocusSearch, int i, Function1<? super FocusTargetModifierNode, Boolean> onFound) {
        Intrinsics.checkNotNullParameter(twoDimensionalFocusSearch, "$this$twoDimensionalFocusSearch");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        int i2 = WhenMappings.$EnumSwitchMapping$0[twoDimensionalFocusSearch.getFocusStateImpl().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m1600findChildCorrespondingToFocusEnterOMvw8(twoDimensionalFocusSearch, i, onFound));
            }
            if (i2 == 4) {
        ...
        int i3 = WhenMappings.$EnumSwitchMapping$0[activeChild.getFocusStateImpl().ordinal()];
        if (i3 != 1) {
            if (i3 == 2 || i3 == 3) {
                return Boolean.valueOf(m1601generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeChild, i, onFound));
            }
            if (i3 == 4) {
                throw new IllegalStateException(NoActiveChild.toString());
            }
        ...
        Boolean boolM1604twoDimensionalFocusSearchOMvw8 = m1604twoDimensionalFocusSearchOMvw8(activeChild, i, onFound);
        if (!Intrinsics.areEqual((Object) boolM1604twoDimensionalFocusSearchOMvw8, (Object) false)) {
            return boolM1604twoDimensionalFocusSearchOMvw8;
        }
        FocusRequester focusRequesterInvoke = activeChild.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m1562boximpl(i));
        if (Intrinsics.areEqual(focusRequesterInvoke, FocusRequester.INSTANCE.getDefault())) {
            focusRequesterInvoke = null;
        }
        FocusRequester focusRequester = focusRequesterInvoke;
        if (focusRequester != null) {
            if (Intrinsics.areEqual(focusRequester, FocusRequester.INSTANCE.getCancel())) {
                return null;
            }
            return Boolean.valueOf(focusRequester.findFocusTarget$ui_release(onFound));
        }
        return Boolean.valueOf(m1601generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeNode(activeChild), i, onFound));
    }

    /* renamed from: findChildCorrespondingToFocusEnter--OM-vw8, reason: not valid java name */
    public static final boolean m1600findChildCorrespondingToFocusEnterOMvw8(FocusTargetModifierNode findChildCorrespondingToFocusEnter, int i, Function1<? super FocusTargetModifierNode, Boolean> onFound) {
        ...
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        FocusRequester focusRequesterInvoke = findChildCorrespondingToFocusEnter.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m1562boximpl(i));
        if (Intrinsics.areEqual(focusRequesterInvoke, FocusRequester.INSTANCE.getDefault())) {
            focusRequesterInvoke = null;
        }
        FocusRequester focusRequester = focusRequesterInvoke;
        ...
        if (FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1574getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m1581getRightdhqQ8s();
        }
        if (FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1581getRightdhqQ8s()) || FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1573getDowndhqQ8s())) {
            rectBottomRight = topLeft(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        } else {
            if (!FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1577getLeftdhqQ8s()) && !FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1582getUpdhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rectBottomRight = bottomRight(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        }
        FocusTargetModifierNode focusTargetModifierNodeM1599findBestCandidate4WY_MpI = m1599findBestCandidate4WY_MpI(mutableVector, rectBottomRight, i);
        if (focusTargetModifierNodeM1599findBestCandidate4WY_MpI != null) {
            return onFound.invoke(focusTargetModifierNodeM1599findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }

    /* renamed from: generateAndSearchChildren-4C6V_qg, reason: not valid java name */
    private static final boolean m1601generateAndSearchChildren4C6V_qg(final FocusTargetModifierNode focusTargetModifierNode, final FocusTargetModifierNode focusTargetModifierNode2, final int i, final Function1<? super FocusTargetModifierNode, Boolean> function1) {
        if (m1603searchChildren4C6V_qg(focusTargetModifierNode, focusTargetModifierNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m1561searchBeyondBoundsOMvw8(focusTargetModifierNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                ...
                Boolean boolValueOf = Boolean.valueOf(TwoDimensionalFocusSearchKt.m1603searchChildren4C6V_qg(focusTargetModifierNode, focusTargetModifierNode2, i, function1));
    ...
    private static final FocusTargetModifierNode m1599findBestCandidate4WY_MpI(MutableVector<FocusTargetModifierNode> mutableVector, Rect rect, int i) {
        Rect rectTranslate;
        if (FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1577getLeftdhqQ8s())) {
            ...
            rectTranslate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1582getUpdhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetModifierNode2)) {
                    ...
                    if (m1602isBetterCandidateI7lrPNg(rectFocusRect, rectTranslate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1577getLeftdhqQ8s())) {
            if (FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1581getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float top2;
        float height;
        if (FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1577getLeftdhqQ8s()) || FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1581getRightdhqQ8s())) {
            f = 2;
            top = rect2.getTop() + (rect2.getHeight() / f);
            top2 = rect.getTop();
            height = rect.getHeight();
        } else {
            if (!FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1582getUpdhqQ8s()) && !FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1573getDowndhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m1602isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m1598beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m1598beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    private static final boolean m1598beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (beamBeats_I7lrPNg$inSourceBeam(rect3, i, rect) || !beamBeats_I7lrPNg$inSourceBeam(rect2, i, rect)) {
            return false;
        }
        return !beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i, rect) || FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1577getLeftdhqQ8s()) || FocusDirection.m1565equalsimpl0(i, FocusDirection.INSTANCE.m1581getRightdhqQ8s()) || beamBeats_I7lrPNg$majorAxisDistance$15(rect2, i, rect) < beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i, rect);
    }
    ...
    public static final boolean m1603searchChildren4C6V_qg(FocusTargetModifierNode focusTargetModifierNode, FocusTargetModifierNode focusTargetModifierNode2, int i, Function1<? super FocusTargetModifierNode, Boolean> function1) {
        FocusTargetModifierNode focusTargetModifierNodeM1599findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetModifierNode[16], 0);
        ...
        while (mutableVector.isNotEmpty() && (focusTargetModifierNodeM1599findBestCandidate4WY_MpI = m1599findBestCandidate4WY_MpI(mutableVector, FocusTraversalKt.focusRect(focusTargetModifierNode2), i)) != null) {
            if (focusTargetModifierNodeM1599findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(focusTargetModifierNodeM1599findBestCandidate4WY_MpI).booleanValue();
            }
            FocusRequester focusRequesterInvoke = focusTargetModifierNodeM1599findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m1562boximpl(i));
            if (Intrinsics.areEqual(focusRequesterInvoke, FocusRequester.INSTANCE.getDefault())) {
                focusRequesterInvoke = null;
            }
            FocusRequester focusRequester = focusRequesterInvoke;
            ...
            if (m1601generateAndSearchChildren4C6V_qg(focusTargetModifierNodeM1599findBestCandidate4WY_MpI, focusTargetModifierNode2, i, function1)) {
                return true;
            }
            mutableVector.remove(focusTargetModifierNodeM1599findBestCandidate4WY_MpI);
        }
        return false;
    }
        ...
        while (mutableVector2.isNotEmpty()) {
            ...
            if ((node.getAggregateChildKindSet() & iM3598constructorimpl) != 0) {
                for (Modifier.Node child2 = node; child2 != null; child2 = child2.getChild()) {
                    if ((child2.getKindSet() & iM3598constructorimpl) != 0 && (child2 instanceof FocusTargetModifierNode)) {
                        ...
                        FocusRequester focusRequesterInvoke = focusTargetModifierNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m1562boximpl(FocusDirection.INSTANCE.m1574getEnterdhqQ8s()));
                        if (Intrinsics.areEqual(focusRequesterInvoke, FocusRequester.INSTANCE.getDefault())) {
                            focusRequesterInvoke = null;
                        }
                        FocusRequester focusRequester = focusRequesterInvoke;
                        if (focusRequester != null) {
                            if (!Intrinsics.areEqual(focusRequester, FocusRequester.INSTANCE.getCancel()) && (size = (focusRequesterNodes$ui_release = focusRequester.getFocusRequesterNodes$ui_release()).getSize()) > 0) {
                                FocusRequesterModifierNode[] content = focusRequesterNodes$ui_release.getContent();
                                int i = 0;
                                do {
                                    collectAccessibleChildren(content[i], mutableVector);
                                    i++;
                                } while (i < size);
                            }
                        }
