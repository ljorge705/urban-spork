...
public final class PointerEventType {
    ...
    private static final int Unknown = m3228constructorimpl(0);
    private static final int Press = m3228constructorimpl(1);
    private static final int Release = m3228constructorimpl(2);
    private static final int Move = m3228constructorimpl(3);
    private static final int Enter = m3228constructorimpl(4);
    private static final int Exit = m3228constructorimpl(5);
    private static final int Scroll = m3228constructorimpl(6);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerEventType m3227boximpl(int i) {
        return new PointerEventType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m3228constructorimpl(int i) {
        return i;
    }
    ...
    public static final class Companion {
        ...
        public final int m3240getUnknown7fucELk() {
            return PointerEventType.Unknown;
        }

        /* renamed from: getPress-7fucELk, reason: not valid java name */
        public final int m3237getPress7fucELk() {
            return PointerEventType.Press;
        }

        /* renamed from: getRelease-7fucELk, reason: not valid java name */
        public final int m3238getRelease7fucELk() {
            return PointerEventType.Release;
        }

        /* renamed from: getMove-7fucELk, reason: not valid java name */
        public final int m3236getMove7fucELk() {
            return PointerEventType.Move;
        }

        /* renamed from: getEnter-7fucELk, reason: not valid java name */
        public final int m3234getEnter7fucELk() {
            return PointerEventType.Enter;
        }

        /* renamed from: getExit-7fucELk, reason: not valid java name */
        public final int m3235getExit7fucELk() {
            return PointerEventType.Exit;
        }

        /* renamed from: getScroll-7fucELk, reason: not valid java name */
        public final int m3239getScroll7fucELk() {
    ...
    public static String m3232toStringimpl(int i) {
        return m3230equalsimpl0(i, Press) ? "Press" : m3230equalsimpl0(i, Release) ? "Release" : m3230equalsimpl0(i, Move) ? "Move" : m3230equalsimpl0(i, Enter) ? ReactEditTextInputConnectionWrapper.ENTER_KEY_VALUE : m3230equalsimpl0(i, Exit) ? "Exit" : m3230equalsimpl0(i, Scroll) ? "Scroll" : "Unknown";
    }
}
