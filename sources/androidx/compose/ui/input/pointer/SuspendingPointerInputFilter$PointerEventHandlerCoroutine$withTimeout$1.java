...
@DebugMetadata(c = "androidx.compose.ui.input.pointer.SuspendingPointerInputFilter$PointerEventHandlerCoroutine", f = "SuspendingPointerInputFilter.kt", i = {0}, l = {IptcDirectory.TAG_COPYRIGHT_NOTICE}, m = "withTimeout", n = {"job"}, s = {"L$0"})
