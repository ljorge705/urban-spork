...
public final class PointerType {
    ...
    private static final int Unknown = m3347constructorimpl(0);
    private static final int Touch = m3347constructorimpl(1);
    private static final int Mouse = m3347constructorimpl(2);
    private static final int Stylus = m3347constructorimpl(3);
    private static final int Eraser = m3347constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PointerType m3346boximpl(int i) {
