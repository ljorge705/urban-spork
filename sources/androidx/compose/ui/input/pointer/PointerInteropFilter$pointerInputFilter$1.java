...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates$ui_release != null) {
                        long jMo3403localToRootMKHz9U = layoutCoordinates$ui_release.mo3403localToRootMKHz9U(Offset.INSTANCE.m1655getZeroF1C5BW0());
                        final PointerInteropFilter pointerInteropFilter = this.this$0;
                        PointerInteropUtils_androidKt.m3336toCancelMotionEventScoped4ec7I(pointerEvent, jMo3403localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                            {
                                super(1);
                            }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long jMo3403localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo3403localToRootMKHz9U(Offset.INSTANCE.m1655getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m3337toMotionEventScoped4ec7I(pointerEvent, jMo3403localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
