...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long uptime;
        boolean down;
        long jMo3359screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m3260boximpl(pointerInputEventData.m3291getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                uptime = pointerInputEventData.getUptime();
                jMo3359screenToLocalMKHz9U = pointerInputEventData.m3292getPositionF1C5BW0();
                down = false;
            } else {
                long uptime2 = pointerInputData.getUptime();
                uptime = uptime2;
                down = pointerInputData.getDown();
                jMo3359screenToLocalMKHz9U = positionCalculator.mo3359screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            linkedHashMap.put(PointerId.m3260boximpl(pointerInputEventData.m3291getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3291getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3292getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), uptime, jMo3359screenToLocalMKHz9U, down, false, pointerInputEventData.m3295getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3294getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m3260boximpl(pointerInputEventData.m3291getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3293getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3295getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3260boximpl(pointerInputEventData.m3291getIdJ3iCeTQ()));
            }
        }
