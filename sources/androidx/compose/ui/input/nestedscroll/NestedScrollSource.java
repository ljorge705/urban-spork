...
public final class NestedScrollSource {
    ...
    private static final int Drag = m3170constructorimpl(1);
    private static final int Fling = m3170constructorimpl(2);
    private static final int Relocate = m3170constructorimpl(3);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ NestedScrollSource m3169boximpl(int i) {
        return new NestedScrollSource(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static int m3170constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3171equalsimpl(int i, Object obj) {
        return (obj instanceof NestedScrollSource) && i == ((NestedScrollSource) obj).getValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3172equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3173hashCodeimpl(int i) {
    ...
    public static String m3174toStringimpl(int i) {
        return m3172equalsimpl0(i, Drag) ? "Drag" : m3172equalsimpl0(i, Fling) ? "Fling" : m3172equalsimpl0(i, Relocate) ? "Relocate" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m3176getRelocateWNlRxjI$annotations() {
        }
        ...
        public final int m3177getDragWNlRxjI() {
            return NestedScrollSource.Drag;
        }

        /* renamed from: getFling-WNlRxjI, reason: not valid java name */
        public final int m3178getFlingWNlRxjI() {
            return NestedScrollSource.Fling;
        }

        /* renamed from: getRelocate-WNlRxjI, reason: not valid java name */
        public final int m3179getRelocateWNlRxjI() {
