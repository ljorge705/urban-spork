...
public final class ShadowKt {
    ...
    public static /* synthetic */ Modifier m1560shadowziNgDLE$default(Modifier modifier, float f, Shape shape, boolean z, int i, Object obj) {
        ...
        return m1559shadowziNgDLE(modifier, f, shape, z);
    }
    ...
    public static final /* synthetic */ Modifier m1559shadowziNgDLE(Modifier shadow, float f, Shape shape, boolean z) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m1557shadows4CzXII(shadow, f, shape, z, GraphicsLayerScopeKt.getDefaultShadowColor(), GraphicsLayerScopeKt.getDefaultShadowColor());
    }

    /* renamed from: shadow-s4CzXII$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1558shadows4CzXII$default(Modifier modifier, float f, Shape shape, boolean z, long j, long j2, int i, Object obj) {
        boolean z2;
        ...
        return m1557shadows4CzXII(modifier, f, rectangleShape, z2, (i & 8) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j, (i & 16) != 0 ? GraphicsLayerScopeKt.getDefaultShadowColor() : j2);
    }

    /* renamed from: shadow-s4CzXII, reason: not valid java name */
    public static final Modifier m1557shadows4CzXII(Modifier shadow, final float f, final Shape shape, final boolean z, final long j, final long j2) {
        Intrinsics.checkNotNullParameter(shadow, "$this$shadow");
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (Dp.m4389compareTo0680j_4(f, Dp.m4390constructorimpl(0)) > 0 || z) {
            return InspectableValueKt.inspectableWrapper(shadow, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.ui.draw.ShadowKt$shadow-s4CzXII$$inlined$debugInspectorInfo$1
                ...
                public final void invoke2(InspectorInfo inspectorInfo) {
                    ...
                    inspectorInfo.getProperties().set(ViewProps.ELEVATION, Dp.m4388boximpl(f));
                    inspectorInfo.getProperties().set("shape", shape);
                    inspectorInfo.getProperties().set("clip", Boolean.valueOf(z));
                    inspectorInfo.getProperties().set("ambientColor", Color.m1867boximpl(j));
                    inspectorInfo.getProperties().set("spotColor", Color.m1867boximpl(j2));
                }
                ...
                public final void invoke2(GraphicsLayerScope graphicsLayer) {
                    ...
                    graphicsLayer.setShadowElevation(graphicsLayer.mo577toPx0680j_4(f));
                    graphicsLayer.setShape(shape);
                    graphicsLayer.setClip(z);
                    graphicsLayer.mo2062setAmbientShadowColor8_81llA(j);
                    graphicsLayer.mo2064setSpotShadowColor8_81llA(j2);
                }
            }));
        }
        return shadow;
