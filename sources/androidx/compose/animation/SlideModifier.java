...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m352targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long jM4518getZeronOccac = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m4518getZeronOccac() : slideOffset2.invoke(IntSize.m4542boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long jM4518getZeronOccac2 = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m4518getZeronOccac() : slideOffset.invoke(IntSize.m4542boximpl(fullSize)).getPackedValue();
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measure, placeableMo3396measureBRTryo0.getWidth(), placeableMo3396measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m3447placeWithLayeraW9wM$default(layout, placeableMo3396measureBRTryo0, lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m4499boximpl(m353invokeBjo55l4(enterExitState));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m353invokeBjo55l4(EnterExitState it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return slideModifier.m352targetValueByStateoFUgxo0(it, j2);
                    }
