...
public final class StartOffset {
    ...
    public static final /* synthetic */ StartOffset m384boximpl(long j) {
        return new StartOffset(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static long m386constructorimpl(long j) {
        return j;
    }
    ...
    public boolean equals(Object obj) {
        return m388equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m392hashCodeimpl(this.value);
    }
    ...
    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m385constructorimpl(int i, int i2) {
        return m386constructorimpl(i * i2);
    }

    /* renamed from: constructor-impl$default, reason: not valid java name */
    public static /* synthetic */ long m387constructorimpl$default(int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i3 & 2) != 0) {
            i2 = StartOffsetType.INSTANCE.m402getDelayEo1U57Q();
        }
        return m385constructorimpl(i, i2);
    }

    /* renamed from: getOffsetMillis-impl, reason: not valid java name */
    public static final int m390getOffsetMillisimpl(long j) {
        return Math.abs((int) j);
    }

    /* renamed from: getOffsetType-Eo1U57Q, reason: not valid java name */
    public static final int m391getOffsetTypeEo1U57Q(long j) {
        boolean z = j > 0;
        if (z) {
            return StartOffsetType.INSTANCE.m403getFastForwardEo1U57Q();
        }
        if (z) {
            throw new NoWhenBranchMatchedException();
        }
        return StartOffsetType.INSTANCE.m402getDelayEo1U57Q();
    }
}
