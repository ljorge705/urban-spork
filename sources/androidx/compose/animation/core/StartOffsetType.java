...
public final class StartOffsetType {
    ...
    private static final int Delay = m396constructorimpl(-1);
    private static final int FastForward = m396constructorimpl(1);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ StartOffsetType m395boximpl(int i) {
        return new StartOffsetType(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m396constructorimpl(int i) {
        return i;
    }
