...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m334sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        ChangeSize value = this.expand.getValue();
        long packedValue = value != null ? value.getSize().invoke(IntSize.m4542boximpl(fullSize)).getPackedValue() : fullSize;
        ChangeSize value2 = this.shrink.getValue();
        long packedValue2 = value2 != null ? value2.getSize().invoke(IntSize.m4542boximpl(fullSize)).getPackedValue() : fullSize;
    ...
    public final long m335targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        if (this.currentAlignment == null) {
            return IntOffset.INSTANCE.m4518getZeronOccac();
        }
        if (this.alignment.getValue() != null && !Intrinsics.areEqual(this.currentAlignment, this.alignment.getValue())) {
            ...
            if (value != null) {
                long packedValue = value.getSize().invoke(IntSize.m4542boximpl(fullSize)).getPackedValue();
                Alignment value2 = this.alignment.getValue();
                Intrinsics.checkNotNull(value2);
                long jMo1535alignKFBX0sM = value2.mo1535alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment = this.currentAlignment;
                Intrinsics.checkNotNull(alignment);
                long jMo1535alignKFBX0sM2 = alignment.mo1535alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                return IntOffsetKt.IntOffset(IntOffset.m4508getXimpl(jMo1535alignKFBX0sM) - IntOffset.m4508getXimpl(jMo1535alignKFBX0sM2), IntOffset.m4509getYimpl(jMo1535alignKFBX0sM) - IntOffset.m4509getYimpl(jMo1535alignKFBX0sM2));
            }
            return IntOffset.INSTANCE.m4518getZeronOccac();
        }
        return IntOffset.INSTANCE.m4518getZeronOccac();
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        final long jM4518getZeronOccac;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable placeableMo3396measureBRTryo0 = measurable.mo3396measureBRTryo0(j);
        final long jIntSize = IntSizeKt.IntSize(placeableMo3396measureBRTryo0.getWidth(), placeableMo3396measureBRTryo0.getHeight());
        long packedValue = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m4542boximpl(m336invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m336invokeYEO4UFw(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return this.this$0.m334sizeByStateUzc_VyU(it, jIntSize);
            }
        ...
        final long packedValue2 = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m4499boximpl(m337invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m337invokeBjo55l4(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return this.this$0.m335targetOffsetByStateoFUgxo0(it, jIntSize);
            }
        }).getValue().getPackedValue();
        Alignment alignment = this.currentAlignment;
        if (alignment != null) {
            jM4518getZeronOccac = alignment.mo1535alignKFBX0sM(jIntSize, packedValue, LayoutDirection.Ltr);
        } else {
            jM4518getZeronOccac = IntOffset.INSTANCE.m4518getZeronOccac();
        }
        return MeasureScope.layout$default(measure, IntSize.m4550getWidthimpl(packedValue), IntSize.m4549getHeightimpl(packedValue), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, placeableMo3396measureBRTryo0, IntOffset.m4508getXimpl(jM4518getZeronOccac) + IntOffset.m4508getXimpl(packedValue2), IntOffset.m4509getYimpl(jM4518getZeronOccac) + IntOffset.m4509getYimpl(packedValue2), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
