...
final class SizeAnimationModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public static final /* data */ class AnimData {
        ...
        public static /* synthetic */ AnimData m346copyO0kMr_c$default(AnimData animData, Animatable animatable, long j, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return animData.m348copyO0kMr_c(animatable, j);
        }
        ...
        public final AnimData m348copyO0kMr_c(Animatable<IntSize, AnimationVector2D> anim, long startSize) {
        ...
        public boolean equals(Object other) {
            ...
            return Intrinsics.areEqual(this.anim, animData.anim) && IntSize.m4548equalsimpl0(this.startSize, animData.startSize);
        }
        ...
        public final long m349getStartSizeYbymL2g() {
            return this.startSize;
        }

        public int hashCode() {
            return (this.anim.hashCode() * 31) + IntSize.m4551hashCodeimpl(this.startSize);
        }

        /* renamed from: setStartSize-ozmzZPI, reason: not valid java name */
        public final void m350setStartSizeozmzZPI(long j) {
            this.startSize = j;
        }

        public String toString() {
            return "AnimData(anim=" + this.anim + ", startSize=" + ((Object) IntSize.m4553toStringimpl(this.startSize)) + ')';
        }
    ...
    public MeasureResult mo300measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        long jM345animateTomzRDjE0 = m345animateTomzRDjE0(IntSizeKt.IntSize(placeableMo3396measureBRTryo0.getWidth(), placeableMo3396measureBRTryo0.getHeight()));
        return MeasureScope.layout$default(measure, IntSize.m4550getWidthimpl(jM345animateTomzRDjE0), IntSize.m4549getHeightimpl(jM345animateTomzRDjE0), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SizeAnimationModifier$measure$1
            {
                super(1);
            }
    ...
    public final long m345animateTomzRDjE0(long targetSize) {
        AnimData animData = getAnimData();
        if (animData != null) {
            if (!IntSize.m4548equalsimpl0(targetSize, animData.getAnim().getTargetValue().getPackedValue())) {
                animData.m350setStartSizeozmzZPI(animData.getAnim().getValue().getPackedValue());
            ...
            animData = new AnimData(new Animatable(IntSize.m4542boximpl(targetSize), VectorConvertersKt.getVectorConverter(IntSize.INSTANCE), IntSize.m4542boximpl(IntSizeKt.IntSize(1, 1)), null, 8, null), targetSize, null);
        }
