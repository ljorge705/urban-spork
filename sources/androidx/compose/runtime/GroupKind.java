...
final class GroupKind {
    ...
    private static final int Group = m1498constructorimpl(0);
    private static final int Node = m1498constructorimpl(1);
    private static final int ReusableNode = m1498constructorimpl(2);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ GroupKind m1497boximpl(int i) {
        return new GroupKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1498constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1499equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m1505unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m1499equalsimpl(this.value, obj);
    }
    ...
    public static final boolean m1502isNodeimpl(int i) {
        return i != INSTANCE.m1506getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m1503isReusableimpl(int i) {
        return i != INSTANCE.m1507getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m1506getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs, reason: not valid java name */
        public final int m1507getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs, reason: not valid java name */
        public final int m1508getReusableNodeULZAiWs() {
