...
public final class PersistentOrderedSetBuilder<E> extends AbstractMutableSet<E> implements PersistentSet.Builder<E> {
    ...
    public PersistentSet<E> build() {
        ...
        if (persistentHashMapBuild == this.set.getHashMap$runtime_release()) {
            CommonFunctionsKt.m1530assert(this.firstElement == this.set.getFirstElement());
            CommonFunctionsKt.m1530assert(this.lastElement == this.set.getLastElement());
