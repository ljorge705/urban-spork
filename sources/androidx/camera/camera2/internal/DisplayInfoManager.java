...
public class DisplayInfoManager {
    ...
    private static final Size ABNORMAL_DISPLAY_SIZE_THRESHOLD = new Size(320, FaceDetectorAvcMLKit.FACE_DETECTION_FRAME_WIDTH);
    private static final Size FALLBACK_DISPLAY_SIZE = new Size(OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, DefaultFrameSampler.DESIRED_FRAME_WIDTH);
