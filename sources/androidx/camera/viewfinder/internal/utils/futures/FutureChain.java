...
public class FutureChain<V> implements ListenableFuture<V> {
    ...
    FutureChain() {
        this.mDelegate = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver<V>() { // from class: androidx.camera.viewfinder.internal.utils.futures.FutureChain.1
