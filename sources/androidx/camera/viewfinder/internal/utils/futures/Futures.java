...
import androidx.camera.viewfinder.internal.utils.futures.ImmediateFuture;
...
public final class Futures {
    private static final Function<?, ?> IDENTITY_FUNCTION = new Function<Object, Object>() { // from class: androidx.camera.viewfinder.internal.utils.futures.Futures.2
    ...
    public static <I, O> ListenableFuture<O> transform(ListenableFuture<I> listenableFuture, final Function<? super I, ? extends O> function, Executor executor) {
        ...
        return transformAsync(listenableFuture, new AsyncFunction<I, O>() { // from class: androidx.camera.viewfinder.internal.utils.futures.Futures.1
            @Override // androidx.camera.viewfinder.internal.utils.futures.AsyncFunction
    ...
    public static <V> void propagate(ListenableFuture<V> listenableFuture, CallbackToFutureAdapter.Completer<V> completer) {
        propagateTransform(listenableFuture, IDENTITY_FUNCTION, completer, CameraExecutors.directExecutor());
    }
    ...
    private static <I, O> void propagateTransform(boolean z, final ListenableFuture<I> listenableFuture, final Function<? super I, ? extends O> function, final CallbackToFutureAdapter.Completer<O> completer, Executor executor) {
        ...
        addCallback(listenableFuture, new FutureCallback<I>() { // from class: androidx.camera.viewfinder.internal.utils.futures.Futures.3
        ...
        if (z) {
            completer.addCancellationListener(new Runnable() { // from class: androidx.camera.viewfinder.internal.utils.futures.Futures.4
    ...
    public static <V> ListenableFuture<V> nonCancellationPropagating(final ListenableFuture<V> listenableFuture) {
        Preconditions.checkNotNull(listenableFuture);
        return listenableFuture.isDone() ? listenableFuture : CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.viewfinder.internal.utils.futures.Futures$$ExternalSyntheticLambda0
    ...
    static /* synthetic */ Object lambda$nonCancellationPropagating$0(ListenableFuture listenableFuture, CallbackToFutureAdapter.Completer completer) throws Exception {
        propagateTransform(false, listenableFuture, IDENTITY_FUNCTION, completer, CameraExecutors.directExecutor());
    ...
    public static <V> ListenableFuture<List<V>> successfulAsList(Collection<? extends ListenableFuture<? extends V>> collection) {
        return new ListFuture(new ArrayList(collection), false, CameraExecutors.directExecutor());
    }

    public static <V> ListenableFuture<List<V>> allAsList(Collection<? extends ListenableFuture<? extends V>> collection) {
        return new ListFuture(new ArrayList(collection), true, CameraExecutors.directExecutor());
    }
    ...
    private static final class CallbackListener<V> implements Runnable {
        ...
        public String toString() {
            return getClass().getSimpleName() + Constants.SEPARATOR_COMMA + this.mCallback;
        }
    }
