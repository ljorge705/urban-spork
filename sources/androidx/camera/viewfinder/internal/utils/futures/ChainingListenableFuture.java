...
class ChainingListenableFuture<I, O> extends FutureChain<O> implements Runnable {
    ...
    @Override // androidx.camera.viewfinder.internal.utils.futures.FutureChain, java.util.concurrent.Future
    ...
    public void run() {
        ...
        listenableFutureApply.addListener(new Runnable() { // from class: androidx.camera.viewfinder.internal.utils.futures.ChainingListenableFuture.1
            @Override // java.lang.Runnable
            public void run() {
                try {
                    try {
