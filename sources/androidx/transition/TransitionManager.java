...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo4710clone = transition.mo4710clone();
        transitionMo4710clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo4710clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo4710clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo4710clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo4710clone = transition.mo4710clone();
        sceneChangeSetup(viewGroup, transitionMo4710clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo4710clone);
    }
