...
public final class GlUtil {
    ...
    public static int createTexture(int i, int i2, boolean z) throws GlException {
        if (z) {
            ...
            return createTexture(i, i2, 34842, FujifilmMakernoteDirectory.TAG_AUTO_DYNAMIC_RANGE);
        }
        return createTexture(i, i2, 6408, FujifilmMakernoteDirectory.TAG_FILM_MODE);
    }
