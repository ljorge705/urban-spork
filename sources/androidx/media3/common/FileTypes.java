...
public final class FileTypes {
    ...
    */
    ...
    public static int inferFileTypeFromUri(Uri uri) {
        ...
        if (lastPathSegment.endsWith(LivenessConstants.VIDEO_RECORDING_FILE_FORMAT) || lastPathSegment.startsWith(EXTENSION_PREFIX_M4, lastPathSegment.length() - 4) || lastPathSegment.startsWith(LivenessConstants.VIDEO_RECORDING_FILE_FORMAT, lastPathSegment.length() - 5) || lastPathSegment.startsWith(EXTENSION_PREFIX_CMF, lastPathSegment.length() - 5)) {
            return 8;
        }
