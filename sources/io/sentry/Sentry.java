...
public final class Sentry {
    ...
    public static IHub getCurrentHub() {
        ...
        IHub iHubM5981clone = mainHub.m5981clone();
        threadLocal.set(iHubM5981clone);
        return iHubM5981clone;
    }

    public static IHub cloneMainHub() {
        return globalHubMode ? mainHub : mainHub.m5981clone();
    }
    ...
    private static void handleAppStartProfilingConfig(final SentryOptions sentryOptions, ISentryExecutorService iSentryExecutorService) {
        try {
            iSentryExecutorService.submit(new Runnable() { // from class: io.sentry.Sentry$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
    ...
    private static void notifyOptionsObservers(final SentryOptions sentryOptions) {
        try {
            sentryOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.Sentry$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
