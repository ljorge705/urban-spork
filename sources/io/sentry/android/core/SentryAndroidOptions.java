...
public final class SentryAndroidOptions extends SentryOptions {
    ...
    private SdkVersion createSdkVersion() {
        SdkVersion sdkVersionUpdateSdkVersion = SdkVersion.updateSdkVersion(getSdkVersion(), BuildConfig.SENTRY_ANDROID_SDK_NAME, "7.20.1");
        sdkVersionUpdateSdkVersion.addPackage("maven:io.sentry:sentry-android-core", "7.20.1");
