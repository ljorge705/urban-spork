...
public final class PhoneStateBreadcrumbsIntegration implements Integration, Closeable {
            ...
            try {
                sentryOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.PhoneStateBreadcrumbsIntegration$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m6023x144a89d8(iHub, sentryOptions);
                    }
                });
            } catch (Throwable th) {
    ...
    /* synthetic */ void m6023x144a89d8(IHub iHub, SentryOptions sentryOptions) {
    ...
    static final class PhoneStateChangeListener extends PhoneStateListener {
        ...
        public void onCallStateChanged(int i, String str) {
            if (i == 1) {
                ...
                breadcrumb.setData(Constants.KEY_ACTION, "CALL_STATE_RINGING");
