...
public final class TempSensorBreadcrumbsIntegration implements Integration, Closeable, SensorEventListener {
            ...
            try {
                sentryOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.TempSensorBreadcrumbsIntegration$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m6029x7962c083(sentryOptions);
                    }
                });
            } catch (Throwable th) {
    ...
    /* synthetic */ void m6029x7962c083(SentryOptions sentryOptions) {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        breadcrumb.setData(Constants.KEY_ACTION, "TYPE_AMBIENT_TEMPERATURE");
