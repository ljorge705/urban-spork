...
public final class Scope implements IScope {
    ...
    public Session withSession(IWithSession iWithSession) {
        Session sessionM5994clone;
        synchronized (this.sessionLock) {
            iWithSession.accept(this.session);
            sessionM5994clone = this.session != null ? this.session.m5994clone() : null;
        }
        return sessionM5994clone;
    }
    ...
    public SessionPair startSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.options.getRelease() != null) {
                ...
                sessionPair = new SessionPair(this.session.m5994clone(), session != null ? session.m5994clone() : null);
            } else {
    ...
    public Session endSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.session != null) {
                this.session.end();
                Session sessionM5994clone = this.session.m5994clone();
                this.session = null;
                session = sessionM5994clone;
            }
        }
