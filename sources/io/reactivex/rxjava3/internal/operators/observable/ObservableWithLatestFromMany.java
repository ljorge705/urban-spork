...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class WithLatestFromObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        WithLatestFromObserver(Observer<? super R> actual, Function<? super Object[], R> combiner, int n2) {
        ...
        void subscribe(ObservableSource<?>[] others, int n2) {
            ...
            for (int i = 0; i < n2 && !DisposableHelper.isDisposed(atomicReference.get()) && !this.done; i++) {
