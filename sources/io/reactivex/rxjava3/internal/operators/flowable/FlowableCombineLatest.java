...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        CombineLatestCoordinator(Subscriber<? super R> actual, Function<? super Object[], ? extends R> combiner, int n2, int bufferSize, boolean delayErrors) {
        ...
        void subscribe(Publisher<? extends T>[] sources, int n2) {
            CombineLatestInnerSubscriber<T>[] combineLatestInnerSubscriberArr = this.subscribers;
            for (int i = 0; i < n2 && !this.done && !this.cancelled; i++) {
