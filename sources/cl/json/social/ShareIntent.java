...
public abstract class ShareIntent {
    ...
    public void open(ReadableMap readableMap) throws ActivityNotFoundException {
        ...
        if (hasValidKey(SentryReplayEvent.JsonKeys.URLS, readableMap)) {
            ...
            if (!TextUtils.isEmpty(string)) {
                getIntent().putExtra("android.intent.extra.TEXT", string + StringUtils.SPACE + readableMap.getArray(SentryReplayEvent.JsonKeys.URLS).getString(0));
                return;
            } else {
        ...
        if (hasValidKey("url", readableMap)) {
            ...
            if (!TextUtils.isEmpty(string)) {
                getIntent().putExtra("android.intent.extra.TEXT", string + StringUtils.SPACE + readableMap.getString("url"));
                return;
            } else {
