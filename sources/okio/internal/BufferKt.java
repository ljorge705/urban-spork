    ...
    */
            ...
            if (cCharAt < 128) {
                ...
                if (cCharAt < 2048) {
                    ...
                    if (cCharAt > 56319 || 56320 > cCharAt3 || 57343 < cCharAt3) {
                        ...
                        segmentWritableSegment$okio4.data[segmentWritableSegment$okio4.limit] = (byte) ((i6 >> 18) | FaceDetectorAvcMLKit.FACE_DETECTION_FRAME_WIDTH);
    ...
    public static final Buffer commonWriteUtf8CodePoint(Buffer commonWriteUtf8CodePoint, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((i >> 18) | FaceDetectorAvcMLKit.FACE_DETECTION_FRAME_WIDTH);
