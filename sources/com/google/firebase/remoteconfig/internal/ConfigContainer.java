...
public class ConfigContainer {
    ...
    static ConfigContainer copyOf(JSONObject jSONObject) throws JSONException {
        ...
        return new ConfigContainer(jSONObject.getJSONObject(CONFIGS_KEY), new Date(jSONObject.getLong(FETCH_TIME_KEY)), jSONObject.getJSONArray(ABT_EXPERIMENTS_KEY), jSONObjectOptJSONObject, jSONObject.optLong(TEMPLATE_VERSION_NUMBER_KEY));
    }
