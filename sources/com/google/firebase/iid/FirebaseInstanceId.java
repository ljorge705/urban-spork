...
public class FirebaseInstanceId {
    ...
    private final FirebaseApp f61app;
    ...
    private String getSubtype() {
        return FirebaseApp.DEFAULT_APP_NAME.equals(this.f61app.getName()) ? "" : this.f61app.getPersistenceKey();
    }
    ...
    String blockingGetMasterToken() throws IOException {
        return getToken(Metadata.getDefaultSenderId(this.f61app), ProxyConfig.MATCH_ALL_SCHEMES);
    }

    @Deprecated
    public void deleteInstanceId() throws IOException {
        checkRequiredFirebaseOptions(this.f61app);
    ...
    public long getCreationTime() {
        return store.getCreationTime(this.f61app.getPersistenceKey());
    }
    ...
    String getIdWithoutTriggeringSync() {
        try {
            store.setCreationTime(this.f61app.getPersistenceKey());
    ...
    public Task<InstanceIdResult> getInstanceId() {
        checkRequiredFirebaseOptions(this.f61app);
        return getInstanceId(Metadata.getDefaultSenderId(this.f61app), ProxyConfig.MATCH_ALL_SCHEMES);
    }
    ...
    Store.Token getTokenWithoutTriggeringSync() {
        return getTokenWithoutTriggeringSync(Metadata.getDefaultSenderId(this.f61app), ProxyConfig.MATCH_ALL_SCHEMES);
    }
