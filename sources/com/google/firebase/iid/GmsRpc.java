...
public class GmsRpc {
    ...
    private final FirebaseApp f62app;
    ...
    private String getHashedFirebaseAppName() {
        try {
            return base64UrlSafe(MessageDigest.getInstance("SHA-1").digest(this.f62app.getName().getBytes()));
    ...
    private Bundle setDefaultAttributesToBundle(String str, String str2, String str3, Bundle bundle) {
        ...
        bundle.putString("gmp_app_id", this.f62app.getOptions().getApplicationId());
