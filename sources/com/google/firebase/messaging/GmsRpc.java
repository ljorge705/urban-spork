...
class GmsRpc {
    ...
    private final FirebaseApp f63app;
    ...
    Task<String> getToken() {
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f63app), "*", new Bundle()));
    }

    Task<?> deleteToken() {
        Bundle bundle = new Bundle();
        bundle.putString(EXTRA_DELETE, "1");
        return extractResponseWhenComplete(startRpc(Metadata.getDefaultSenderId(this.f63app), "*", bundle));
    }
    ...
    private String getHashedFirebaseAppName() {
        try {
            return base64UrlSafe(MessageDigest.getInstance("SHA-1").digest(this.f63app.getName().getBytes()));
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        bundle.putString(PARAM_GMP_APP_ID, this.f63app.getOptions().getApplicationId());
