...
public enum zzjz implements zzcx {
    NO_ERROR(0),
    ...
    CAMERA1_SOURCE_CANT_START_ERROR(Mp4SoundDirectory.TAG_NUMBER_OF_CHANNELS),
    CAMERA1_SOURCE_NO_SUITABLE_SIZE_ERROR(Mp4SoundDirectory.TAG_AUDIO_SAMPLE_SIZE),
