...
public class ImmutableGraph<N> extends ForwardingGraph<N> {
    ...
    private static <N> GraphConnections<N, GraphConstants.Presence> connectionsOf(Graph<N> graph, N n2) {
        ...
        if (graph.isDirected()) {
            return DirectedGraphConnections.ofImmutable(n2, graph.incidentEdges(n2), functionConstant);
        }
        return UndirectedGraphConnections.ofImmutable(Maps.asMap(graph.adjacentNodes(n2), functionConstant));
    }
