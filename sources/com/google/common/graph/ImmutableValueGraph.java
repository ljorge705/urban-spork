    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(final ValueGraph<N, V> valueGraph, final N n2) {
        Function function = new Function() { // from class: com.google.common.graph.ImmutableValueGraph$$ExternalSyntheticLambda0
            ...
            public final Object apply(Object obj) {
                return Objects.requireNonNull(valueGraph.edgeValueOrDefault(n2, obj, null));
            }
        };
        if (valueGraph.isDirected()) {
            return DirectedGraphConnections.ofImmutable(n2, valueGraph.incidentEdges(n2), function);
        }
