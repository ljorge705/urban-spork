...
public final class Tables {
    ...
    static abstract class AbstractCell<R, C, V> implements Table.Cell<R, C, V> {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(strValueOf).length() + 4 + String.valueOf(strValueOf2).length() + String.valueOf(strValueOf3).length()).append("(").append(strValueOf).append(Constants.SEPARATOR_COMMA).append(strValueOf2).append(")=").append(strValueOf3).toString();
        }
    }
