...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E> {
    ...
    static <E> ImmutableSortedSet<E> construct(Comparator<? super E> comparator, int i, E... eArr) {
        ...
        for (int i3 = 1; i3 < i; i3++) {
            cctxrwizduxmjefyvyrx cctxrwizduxmjefyvyrxVar = (Object) eArr[i3];
            if (comparator.compare(cctxrwizduxmjefyvyrxVar, (Object) eArr[i2 - 1]) != 0) {
                eArr[i2] = cctxrwizduxmjefyvyrxVar;
                i2++;
            }
        }
