...
public class PanasonicMakernoteDescriptor extends TagDescriptor<PanasonicMakernoteDirectory> {
    ...
    private String getTransformDescription(int i) {
        ...
        try {
            ...
            return (uInt16 == -1 && uInt162 == 1) ? "Slim Low" : (uInt16 == -3 && uInt162 == 2) ? "Slim High" : (uInt16 == 0 && uInt162 == 0) ? "Off" : (uInt16 == 1 && uInt162 == 1) ? "Stretch Low" : (uInt16 == 3 && uInt162 == 2) ? "Stretch High" : "Unknown (" + uInt16 + StringUtils.SPACE + uInt162 + ")";
    ...
    public String getRollAngleDescription() {
        if (((PanasonicMakernoteDirectory) this._directory).getInteger(144) == null) {
            return null;
        }
    ...
    public String getPitchAngleDescription() {
        if (((PanasonicMakernoteDirectory) this._directory).getInteger(145) == null) {
            return null;
        }
        return new DecimalFormat("0.#").format((-r0.shortValue()) / 10.0d);
    }
    ...
    public String getContrastModeDescription() {
        ...
        int iIntValue = integer.intValue();
        return iIntValue != 0 ? iIntValue != 1 ? iIntValue != 2 ? iIntValue != 6 ? iIntValue != 7 ? iIntValue != 256 ? iIntValue != 272 ? iIntValue != 288 ? "Unknown (" + integer + ")" : "High" : "Normal" : "Low" : "Medium High" : "Medium Low" : "High" : "Low" : "Normal";
    }
    ...
    private String buildFacesDescription(Face[] faceArr) {
        ...
        while (i < faceArr.length) {
            int i2 = i + 1;
            sb.append("Face ").append(i2).append(": ").append(faceArr[i].toString()).append("\n");
            i = i2;
        }
        if (sb.length() > 0) {
    ...
    public String getAfAreaModeDescription() {
        ...
        if (i == 0) {
            int i2 = intArray[1];
            return i2 != 1 ? i2 != 16 ? "Unknown (" + intArray[0] + StringUtils.SPACE + intArray[1] + ")" : "Spot Mode Off" : "Spot Mode On";
        }
        if (i == 1) {
            int i3 = intArray[1];
            return i3 != 0 ? i3 != 1 ? "Unknown (" + intArray[0] + StringUtils.SPACE + intArray[1] + ")" : "5-area" : "Spot Focusing";
        }
        if (i == 16) {
            int i4 = intArray[1];
            return i4 != 0 ? i4 != 16 ? "Unknown (" + intArray[0] + StringUtils.SPACE + intArray[1] + ")" : "1-area (high speed)" : "1-area";
        }
        if (i != 32) {
            return i != 64 ? "Unknown (" + intArray[0] + StringUtils.SPACE + intArray[1] + ")" : "Face Detect";
        }
        int i5 = intArray[1];
        return i5 != 0 ? i5 != 1 ? i5 != 2 ? i5 != 3 ? "Unknown (" + intArray[0] + StringUtils.SPACE + intArray[1] + ")" : "3-area (right)" : "3-area (center)" : "3-area (left)" : "Auto or Face Detect";
    }
