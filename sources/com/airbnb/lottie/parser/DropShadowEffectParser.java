...
public class DropShadowEffectParser {
    ...
    private static final JsonReader.Options INNER_EFFECT_NAMES = JsonReader.Options.of(Constants.NOTIF_MSG, CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_VALUE);
