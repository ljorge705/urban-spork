...
public class LayerParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.of(Constants.NOTIF_MSG, "ind", "refId", "ty", "parent", "sw", "sh", Constants.INAPP_NOTIF_SHOW_CLOSE, "ks", "tt", "masksProperties", "shapes", "t", "ef", "sr", DynamicLink.SocialMetaTagParameters.KEY_SOCIAL_TITLE, Constants.INAPP_WINDOW, "h", "ip", "op", "tm", "cl", "hd");
