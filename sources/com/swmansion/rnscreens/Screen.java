...
public final class Screen extends FabricEnabledViewGroup {
    ...
    */
    ...
    private final Pair<Double, Double> calculateHeaderHeight() {
        ...
        Integer numValueOf2 = Integer.valueOf(getContext().getResources().getIdentifier("status_bar_height", "dimen", Constants.KEY_ANDROID));
