...
public final class CaptureSDKTheme$$serializer implements GeneratedSerializer<CaptureSDKTheme> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, CaptureSDKTheme.$childSerializers[1], BuiltinSerializersKt.getNullable(WebSdkThemeConfig$$serializer.INSTANCE)};
    }
    ...
    public CaptureSDKTheme deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = CaptureSDKTheme.$childSerializers;
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            webSdkThemeConfig = (WebSdkThemeConfig) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, WebSdkThemeConfig$$serializer.INSTANCE, null);
            i = 7;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    webSdkThemeConfig2 = (WebSdkThemeConfig) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, WebSdkThemeConfig$$serializer.INSTANCE, webSdkThemeConfig2);
                    i2 |= 4;
                }
            }
            i = i2;
    ...
    public void serialize(Encoder encoder, CaptureSDKTheme value) {
        ...
        CaptureSDKTheme.write$Self$onfido_capture_sdk_core_release(value, compositeEncoderBeginStructure, descriptor2);
