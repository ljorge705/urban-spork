...
public final class CaptureSDKJsConfig$$serializer implements GeneratedSerializer<CaptureSDKJsConfig> {
    ...
    public CaptureSDKJsConfig deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            captureSDKBootstrapConfig = (CaptureSDKBootstrapConfig) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 0, CaptureSDKBootstrapConfig$$serializer.INSTANCE, null);
            captureSDKContext = (CaptureSDKContext) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, CaptureSDKContext$$serializer.INSTANCE, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    captureSDKBootstrapConfig = (CaptureSDKBootstrapConfig) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 0, CaptureSDKBootstrapConfig$$serializer.INSTANCE, captureSDKBootstrapConfig);
                    i2 |= 1;
                } else {
                    if (iDecodeElementIndex != 1) {
                        throw new UnknownFieldException(iDecodeElementIndex);
                    }
                    captureSDKContext2 = (CaptureSDKContext) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, CaptureSDKContext$$serializer.INSTANCE, captureSDKContext2);
                    i2 |= 2;
                }
            }
    ...
    public void serialize(Encoder encoder, CaptureSDKJsConfig value) {
        ...
        CaptureSDKJsConfig.write$Self$onfido_capture_sdk_core_release(value, compositeEncoderBeginStructure, descriptor2);
