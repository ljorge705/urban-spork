...
public final class NationalIdentityCaptureStepBuilder extends DocumentCaptureWithCountryCodeScreenStepBuilder<NationalIdentityCaptureStepBuilder> implements DocumentFormatSelection<NationalIdentityCaptureStepBuilder> {
    ...
    public NationalIdentityCaptureStepBuilder withDocumentFormat(DocumentFormat documentFormat) {
    ...
    private final void validateFoldedDocumentTypeCountryConfiguration() {
        boolean z = (CountryCode.IT == this.countryCode || CountryCode.ZA == this.countryCode) ? false : true;
        if (DocumentFormat.FOLDED == this.documentFormat && z) {
    ...
    /* renamed from: com.onfido.android.sdk.capture.ui.options.stepbuilder.document.NationalIdentityCaptureStepBuilder$throwIllegalStateException$1, reason: invalid class name */
