...
public final class FaceCaptureFragment extends FlowFragment {
    ...
    private static final class Launcher extends ActivityResultContract<Unit, Flow.Result> {
        ...
        public Intent createIntent(Context context, Unit input) {
            ...
            return CaptureActivity.INSTANCE.createFaceIntent(context, null, new OnfidoConfig.Builder(context).build());
        }
    }

    public FaceCaptureFragment() {
        super(R.layout.onfido_fragment_document_capture);
        ActivityResultLauncher<Unit> activityResultLauncherRegisterForActivityResult = registerForActivityResult(Launcher.INSTANCE, new ActivityResultCallback() { // from class: com.onfido.android.sdk.capture.core.features.face.FaceCaptureFragment$$ExternalSyntheticLambda0
            @Override // androidx.activity.result.ActivityResultCallback
            public final void onActivityResult(Object obj) {
                FaceCaptureFragment.onfidoLauncher$lambda$0(this.f$0, (Flow.Result) obj);
            }
        });
    ...
    public static final void onfidoLauncher$lambda$0(FaceCaptureFragment this$0, Flow.Result result) {
