...
public final class ToFaceAlignmentFeedbackMapper {
    ...
    public final FaceAlignmentFeedback map(FaceAlignment faceAlignment) {
        ...
        if (Intrinsics.areEqual(faceAlignment, FaceAlignment.FaceCenterIsNotAligned.FaceIsTooLeft.INSTANCE) || Intrinsics.areEqual(faceAlignment, FaceAlignment.FaceCenterIsNotAligned.FaceIsTooRight.INSTANCE) || Intrinsics.areEqual(faceAlignment, FaceAlignment.FaceCenterIsNotAligned.FaceIsTooUp.INSTANCE) || Intrinsics.areEqual(faceAlignment, FaceAlignment.FaceCenterIsNotAligned.FaceIsTooDown.INSTANCE)) {
            return FaceAlignmentFeedback.FaceNotCentered.INSTANCE;
        }
