...
final class HeadTurnProgressView$rightProgressAnimator$2 extends Lambda implements Function0<ValueAnimator> {
    final /* synthetic */ HeadTurnProgressView this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    HeadTurnProgressView$rightProgressAnimator$2(HeadTurnProgressView headTurnProgressView) {
        super(0);
    ...
    public static final void invoke$lambda$1$lambda$0(HeadTurnProgressView this$0, ValueAnimator it) {
        ...
        this$0.setupRightProgressForDrawing(this$0.currentRightProgress);
    }
    ...
    public final ValueAnimator invoke() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.onfido.android.sdk.capture.component.active.video.capture.presentation.capture.view.headturn.HeadTurnProgressView$rightProgressAnimator$2$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                HeadTurnProgressView$rightProgressAnimator$2.invoke$lambda$1$lambda$0(headTurnProgressView, valueAnimator);
            }
        });
