...
public final class OnfidoActivityCaptureBinding implements ViewBinding {
    ...
    public static OnfidoActivityCaptureBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.onfido_activity_capture, viewGroup, false);
        if (z) {
