...
public final class OnfidoFragmentNfcDocumentNotSupportedBinding implements ViewBinding {
            ...
            if (onfidoButton2 != null) {
                ...
                if (imageView != null && (viewFindChildViewById = ViewBindings.findChildViewById(view, (i = R.id.onfidoInclude3))) != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            return new OnfidoFragmentNfcDocumentNotSupportedBinding((LinearLayout) view, onfidoButton, onfidoButton2, imageView, onfidoWatermarkLayoutBindingBind, textView, textView2);
                        }
                    }
                }
            }
    ...
    public static OnfidoFragmentNfcDocumentNotSupportedBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.onfido_fragment_nfc_document_not_supported, viewGroup, false);
        if (z) {
