...
public final class SupportedDocument$$serializer implements GeneratedSerializer<SupportedDocument> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.onfido.api.client.data.SupportedDocument", supportedDocument$$serializer, 3);
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, StringSerializer.INSTANCE, SupportedDocument.$childSerializers[2]};
    }
    ...
    public SupportedDocument deserialize(Decoder decoder) {
        ...
        return new SupportedDocument(i, str, str2, list, null);
    }
    ...
    public void serialize(Encoder encoder, SupportedDocument value) {
        ...
        SupportedDocument.write$Self$onfido_api_client(value, compositeEncoderBeginStructure, descriptor2);
