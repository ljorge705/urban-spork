...
public class Utils {
    ...
    public static String getLocalisedStringFromResources(Locale locale, String str) {
        ...
        return LocaleUtils.getLocaleStringResource(locale, reactApplicationContext.getResources().getIdentifier(str, CTVariableUtils.STRING, reactApplicationContext.getPackageName()), reactApplicationContext);
    }
