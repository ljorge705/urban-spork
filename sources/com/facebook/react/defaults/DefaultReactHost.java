...
public final class DefaultReactHost {
    ...
    public static final ReactHost getDefaultReactHost(Context context, List<? extends ReactPackage> packageList, String jsMainModulePath, String jsBundleAssetPath, boolean isHermesEnabled) {
        ...
        if (reactHost == null) {
            JSBundleLoader jSBundleLoaderCreateAssetLoader = JSBundleLoader.createAssetLoader(context, CodePushConstants.ASSETS_BUNDLE_PREFIX + jsBundleAssetPath, true);
            ...
            DefaultReactHostDelegate defaultReactHostDelegate = new DefaultReactHostDelegate(jsMainModulePath, jSBundleLoaderCreateAssetLoader, packageList, hermesInstance, null, null, null, new DefaultTurboModuleManagerDelegate.Builder(), 112, null);
