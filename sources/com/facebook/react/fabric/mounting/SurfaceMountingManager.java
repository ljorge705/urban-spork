    ...
    private class RemoveDeleteTreeUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long j) {
            ...
            while (!SurfaceMountingManager.this.mReactTagsToRemove.empty()) {
                try {
                    int iIntValue = ((Integer) SurfaceMountingManager.this.mReactTagsToRemove.pop()).intValue();
                    i++;
                    if (SurfaceMountingManager.this.mErroneouslyReaddedReactTags.contains(Integer.valueOf(iIntValue))) {
                        ...
                        if (nullableViewState != null) {
                            ...
                            SurfaceMountingManager.this.mTagToViewState.remove(Integer.valueOf(iIntValue));
