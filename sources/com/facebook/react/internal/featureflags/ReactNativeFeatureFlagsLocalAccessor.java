...
public final class ReactNativeFeatureFlagsLocalAccessor implements ReactNativeFeatureFlagsAccessor {
    ...
    public boolean androidEnablePendingFabricTransactions() {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(this.currentProvider.androidEnablePendingFabricTransactions());
    ...
    public boolean enableSpannableBuildingUnification() {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(this.currentProvider.enableSpannableBuildingUnification());
    ...
    public boolean enableCustomDrawOrderFabric() {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(this.currentProvider.enableCustomDrawOrderFabric());
    ...
    public boolean enableFixForClippedSubviewsCrash() {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(this.currentProvider.enableFixForClippedSubviewsCrash());
    ...
    public boolean inspectorEnableCxxInspectorPackagerConnection() {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(this.currentProvider.inspectorEnableCxxInspectorPackagerConnection());
    ...
    public boolean inspectorEnableModernCDPRegistry() {
        ...
        if (boolValueOf == null) {
            boolValueOf = Boolean.valueOf(this.currentProvider.inspectorEnableModernCDPRegistry());
