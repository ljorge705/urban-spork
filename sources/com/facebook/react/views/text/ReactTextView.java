...
public class ReactTextView extends AppCompatTextView implements ReactCompoundView {
    ...
    private static WritableMap inlineViewJson(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        if (i == 8) {
            writableMapCreateMap.putString(ViewHierarchyNode.JsonKeys.VISIBILITY, "gone");
            writableMapCreateMap.putInt("index", i2);
        } else if (i == 0) {
            writableMapCreateMap.putString(ViewHierarchyNode.JsonKeys.VISIBILITY, ViewProps.VISIBLE);
            writableMapCreateMap.putInt("index", i2);
            ...
            writableMapCreateMap.putString(ViewHierarchyNode.JsonKeys.VISIBILITY, "unknown");
            writableMapCreateMap.putInt("index", i2);
        }
