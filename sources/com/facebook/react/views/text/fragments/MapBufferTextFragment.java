...
public final class MapBufferTextFragment implements TextFragment {
    ...
    public TextAttributeProps getTextAttributeProps() {
        TextAttributeProps textAttributePropsFromMapBuffer = TextAttributeProps.fromMapBuffer(this.fragment.getMapBuffer(5));
        Intrinsics.checkNotNullExpressionValue(textAttributePropsFromMapBuffer, "fromMapBuffer(...)");
        return textAttributePropsFromMapBuffer;
    }
