...
public final class BridgeTextFragment implements TextFragment {
    ...
    public TextAttributeProps getTextAttributeProps() {
        TextAttributeProps textAttributePropsFromReadableMap = TextAttributeProps.fromReadableMap(new ReactStylesDiffMap(this.fragment.getMap("textAttributes")));
        Intrinsics.checkNotNullExpressionValue(textAttributePropsFromReadableMap, "fromReadableMap(...)");
        return textAttributePropsFromReadableMap;
    }

    @Override // com.facebook.react.views.text.fragments.TextFragment
    public String getString() {
        return this.fragment.getString(CTVariableUtils.STRING);
    }
