...
public class ReactViewBackgroundDrawable extends Drawable {
    ...
    private void updatePath() {
        ...
        if (this.mNeedUpdatePathForBorderRadius) {
            ...
            this.mBackgroundColorRenderPath.addRoundRect(this.mInnerClipTempRectForBorderRadius.left - 0.8f, this.mInnerClipTempRectForBorderRadius.top - 0.8f, this.mInnerClipTempRectForBorderRadius.right + 0.8f, this.mInnerClipTempRectForBorderRadius.bottom + 0.8f, new float[]{fMax, fMax2, fMax3, fMax4, fMax5, fMax6, fMax7, fMax8}, Path.Direction.CW);
