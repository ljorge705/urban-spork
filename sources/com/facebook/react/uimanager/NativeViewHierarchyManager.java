        ...
        if (viewGroup != null) {
            ...
            for (int i = 0; viewGroupManager.getChildAt((ViewGroupManager) viewGroup, i) != null; i += 16) {
                ...
                while (true) {
                    ...
                    sb.append(viewGroupManager.getChildAt((ViewGroupManager) viewGroup, i3).getId() + Constants.SEPARATOR_COMMA);
                    i2++;
                }
                sb.append("\n");
            }
        ...
        if (iArr != null) {
            ...
            for (int i4 = 0; i4 < iArr.length; i4 += 16) {
                ...
                while (true) {
                    ...
                    sb.append(iArr[i6] + Constants.SEPARATOR_COMMA);
                    i5++;
                }
                sb.append("\n");
            }
        ...
        if (viewAtIndexArr != null) {
            ...
            for (int i7 = 0; i7 < viewAtIndexArr.length; i7 += 16) {
                ...
                while (true) {
                    ...
                    sb.append("[" + viewAtIndexArr[i9].mIndex + Constants.SEPARATOR_COMMA + viewAtIndexArr[i9].mTag + "],");
                    i8++;
                }
                sb.append("\n");
            }
        ...
        if (iArr2 != null) {
            ...
            for (int i10 = 0; i10 < iArr2.length; i10 += 16) {
                ...
                while (true) {
                    ...
                    sb.append(iArr2[i12] + Constants.SEPARATOR_COMMA);
                    i11++;
                }
                sb.append("\n");
            }
