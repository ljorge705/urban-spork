...
public class ReactAccessibilityDelegate extends ExploreByTouchHelper {
    ...
    public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (readableMap3 != null && readableMap3.hasKey(MetricSummary.JsonKeys.MIN) && readableMap3.hasKey("now") && readableMap3.hasKey("max")) {
    ...
    public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
        ...
        if (readableMap != null && readableMap.hasKey(MetricSummary.JsonKeys.MIN) && readableMap.hasKey("now") && readableMap.hasKey("max")) {
