...
public final class PriorityThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(final Runnable runnable) {
        ...
        return new Thread(new Runnable() { // from class: com.facebook.imagepipeline.core.PriorityThreadFactory$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                PriorityThreadFactory.newThread$lambda$0(this.f$0, runnable);
            }
        }, this.addThreadNumber ? this.prefix + '-' + this.threadNumber.getAndIncrement() : this.prefix);
    }
