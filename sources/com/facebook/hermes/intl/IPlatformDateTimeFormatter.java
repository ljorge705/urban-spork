...
public interface IPlatformDateTimeFormatter {
    ...
    public enum WeekDay {
        ...
        public String toString() {
            ...
            if (i == 1) {
                return com.singular.sdk.internal.Constants.LONG;
            }
            if (i == 2) {
                return "short";
            }
    ...
    public enum Second {
        ...
        public String getSkeleonSymbol() {
            ...
            if (i == 2) {
                return com.clevertap.android.sdk.Constants.KEY_ENCRYPTION_INAPP_SS;
            }
            if (i == 3) {
                return "";
            }
        ...
        public String getSkeleonSymbol() {
            switch (AnonymousClass1.$SwitchMap$com$facebook$hermes$intl$IPlatformDateTimeFormatter$TimeZoneName[ordinal()]) {
                ...
                case 5:
                    return "O";
                case 6:
                    return CTProductConfigConstants.PRODUCT_CONFIG_JSON_KEY_FOR_VALUE;
                case 7:
                    return "";
                default:
                    throw new IllegalArgumentException();
    ...
    public enum DateStyle {
        ...
        public String toString() {
            ...
            if (i == 1) {
                return IdentityInteractor.FULL_SDK_VERSION_SUFFIX;
            }
            if (i == 2) {
                return com.singular.sdk.internal.Constants.LONG;
            }
