...
class MinuteIntervalSnappableTimePickerDialog extends TimePickerDialog {
    ...
    public boolean pickerIsInTextInputMode() {
        View viewFindViewById = findViewById(this.mContext.getResources().getIdentifier("input_mode", "id", Constants.KEY_ANDROID));
    ...
    public void onAttachedToWindow() {
        ...
        this.mTimePicker = (TimePicker) findViewById(this.mContext.getResources().getIdentifier("timePicker", "id", Constants.KEY_ANDROID));
        if (timePickerHasCustomMinuteInterval()) {
            setupPickerDialog();
        }
    }
    ...
    private void setSpinnerDisplayedValues() {
        NumberPicker numberPicker = (NumberPicker) findViewById(this.mContext.getResources().getIdentifier("minute", "id", Constants.KEY_ANDROID));
