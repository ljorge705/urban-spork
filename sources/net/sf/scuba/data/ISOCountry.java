...
public class ISOCountry extends Country implements Serializable {
    ...
    static {
        ...
        ISOCountry iSOCountry31 = new ISOCountry(LDSFile.EF_DG4_TAG, "BR", "BRA", "Brazil", "Brazilian");
        BR = iSOCountry31;
        ...
        BZ = iSOCountry37;
        ISOCountry iSOCountry38 = new ISOCountry(OlympusRawInfoMakernoteDirectory.TagWbRbLevelsEveningSunlight, "CA", "CAN", "Canada", "Canadian");
        CA = iSOCountry38;
        ...
        CF = iSOCountry41;
        ISOCountry iSOCountry42 = new ISOCountry(IptcDirectory.TAG_ARM_IDENTIFIER, "CG", "COG", "Congo", "Congolese");
        CG = iSOCountry42;
        ISOCountry iSOCountry43 = new ISOCountry(1878, "CH", "CHE", "Switzerland", "Swiss");
        CH = iSOCountry43;
        ISOCountry iSOCountry44 = new ISOCountry(SQLitePersistence.MAX_ARGS, "CI", "CIV", "Cote d'Ivoire", "Ivorian");
        CI = iSOCountry44;
        ...
        CM = iSOCountry47;
        ISOCountry iSOCountry48 = new ISOCountry(ExifDirectoryBase.TAG_TRANSFER_RANGE, "CN", "CHN", "China", "Chinese");
        CN = iSOCountry48;
        ...
        CZ = iSOCountry55;
        ISOCountry iSOCountry56 = new ISOCountry(IptcDirectory.TAG_CONTACT, "DE", "DEU", "Germany", "German");
        DE = iSOCountry56;
        ...
        DZ = iSOCountry61;
        ISOCountry iSOCountry62 = new ISOCountry(SanyoMakernoteDirectory.TAG_FLICKER_REDUCE, "EC", "ECU", "Ecuador", "Ecuadorian");
        EC = iSOCountry62;
        ...
        EH = iSOCountry65;
        ISOCountry iSOCountry66 = new ISOCountry(IptcDirectory.TAG_REFERENCE_NUMBER, "ER", "ERI", "Eritrea", "Eritrean");
        ER = iSOCountry66;
        ...
        ET = iSOCountry68;
        ISOCountry iSOCountry69 = new ISOCountry(IptcDirectory.TAG_PROGRAM_VERSION, "FI", "FIN", "Finland", "Finnish");
        FI = iSOCountry69;
        ...
        FO = iSOCountry73;
        ISOCountry iSOCountry74 = new ISOCountry(IptcDirectory.TAG_BY_LINE, "FR", "FRA", "France", "French");
        FR = iSOCountry74;
        ...
        GB = iSOCountry76;
        ISOCountry iSOCountry77 = new ISOCountry(OlympusFocusInfoMakernoteDirectory.TagAfPoint, "GD", "GRD", "Grenada", "Grenadian");
        GD = iSOCountry77;
        ...
        GM = iSOCountry84;
        ISOCountry iSOCountry85 = new ISOCountry(LeicaMakernoteDirectory.TAG_WB_BLUE_LEVEL, "GN", "GIN", "Guinea", "Guinean");
        GN = iSOCountry85;
        ISOCountry iSOCountry86 = new ISOCountry(LeicaMakernoteDirectory.TAG_MEASURED_LV, "GP", "GLP", "Guadeloupe");
        GP = iSOCountry86;
        ISOCountry iSOCountry87 = new ISOCountry(IptcDirectory.TAG_EXPIRATION_TIME, "GQ", "GNQ", "Equatorial Guinea", "Equatorial Guinean, Equatoguinean");
        GQ = iSOCountry87;
        ...
        GW = iSOCountry92;
        ISOCountry iSOCountry93 = new ISOCountry(OlympusFocusInfoMakernoteDirectory.TagAfInfo, "GY", "GUY", "Guyana", "Guyanese");
        GY = iSOCountry93;
        ...
        HM = iSOCountry95;
        ISOCountry iSOCountry96 = new ISOCountry(LeicaMakernoteDirectory.TAG_IMAGE_ID_NUMBER, "HN", "HND", "Honduras", "Honduran");
        HN = iSOCountry96;
        ISOCountry iSOCountry97 = new ISOCountry(401, "HR", "HRV", "Croatia", "Croatian");
        HR = iSOCountry97;
        ISOCountry iSOCountry98 = new ISOCountry(LeicaMakernoteDirectory.TAG_CONTROLLER_BOARD_VERSION, "HT", "HTI", "Haiti", "Haitian");
        HT = iSOCountry98;
        ...
        KE = iSOCountry114;
        ISOCountry iSOCountry115 = new ISOCountry(PhotoshopDirectory.TAG_TRANSPARENCY_INDEX, "KG", "KGZ", "Kyrgyzstan", "Kyrgyz");
        KG = iSOCountry115;
        ISOCountry iSOCountry116 = new ISOCountry(278, "KH", "KHM", "Cambodia", "Cambodian");
        KH = iSOCountry116;
        ISOCountry iSOCountry117 = new ISOCountry(IptcDirectory.TAG_AUDIO_TYPE, "KI", "KIR", "Kiribati", "I-Kiribati");
        KI = iSOCountry117;
        ...
        KR = iSOCountry121;
        ISOCountry iSOCountry122 = new ISOCountry(PhotoshopDirectory.TAG_SEED_NUMBER, "KW", "KWT", "Kuwait", "Kuwaiti");
        KW = iSOCountry122;
        ...
        LA = iSOCountry125;
        ISOCountry iSOCountry126 = new ISOCountry(PhotoshopDirectory.TAG_EXIF_DATA_1, "LB", "LBN", "Lebanon", "Lebanese");
        LB = iSOCountry126;
        ISOCountry iSOCountry127 = new ISOCountry(1634, "LC", "LCA", "Saint Lucia", "Saint Lucian");
        LC = iSOCountry127;
        ISOCountry iSOCountry128 = new ISOCountry(PhotoshopDirectory.TAG_COUNT_INFORMATION, "LI", "LIE", "Liechtenstein");
        LI = iSOCountry128;
        ISOCountry iSOCountry129 = new ISOCountry(ExifDirectoryBase.TAG_TILE_OFFSETS, "LK", "LKA", "Sri Lanka", "Sri Lankan");
        LK = iSOCountry129;
        ISOCountry iSOCountry130 = new ISOCountry(PhotoshopDirectory.TAG_LAYER_GROUPS_ENABLED_ID, "LR", "LBR", "Liberia", "Liberian");
        LR = iSOCountry130;
        ISOCountry iSOCountry131 = new ISOCountry(PhotoshopDirectory.TAG_PRINT_SCALE, "LS", "LSO", "Lesotho", "Basotho");
        LS = iSOCountry131;
        ISOCountry iSOCountry132 = new ISOCountry(PhotoshopDirectory.TAG_PATH_SELECTION_STATE, "LT", "LTU", "Lithuania", "Lithuanian");
        LT = iSOCountry132;
        ISOCountry iSOCountry133 = new ISOCountry(1090, "LU", "LUX", "Luxembourg", "Luxembourg, Luxembourgish");
        LU = iSOCountry133;
        ISOCountry iSOCountry134 = new ISOCountry(PhotoshopDirectory.TAG_PIXEL_ASPECT_RATIO, "LV", "LVA", "Latvia", "Latvian");
        LV = iSOCountry134;
        ISOCountry iSOCountry135 = new ISOCountry(PhotoshopDirectory.TAG_SHEET_DISCLOSURE, "LY", "LBY", "Libyan Arab Jamahiriya", "Libyan");
        LY = iSOCountry135;
        ...
        MY = iSOCountry157;
        ISOCountry iSOCountry158 = new ISOCountry(QuickTimeMetadataDirectory.TAG_DIRECTOR, "MZ", "MOZ", "Mozambique", "Mozambican");
        MZ = iSOCountry158;
        ISOCountry iSOCountry159 = new ISOCountry(QuickTimeMetadataDirectory.TAG_LOCATION_NOTE, "NA", "NAM", "Namibia", "Namibian");
        NA = iSOCountry159;
        ...
        NO = iSOCountry166;
        ISOCountry iSOCountry167 = new ISOCountry(OlympusCameraSettingsMakernoteDirectory.TagPictureModeSharpness, "NP", "NPL", "Nepal", "Nepali");
        NP = iSOCountry167;
        ...
        NZ = iSOCountry170;
        ISOCountry iSOCountry171 = new ISOCountry(QuickTimeMetadataDirectory.TAG_COLLECTION_USER, "OM", "OMN", "Oman", "Omani");
        OM = iSOCountry171;
        ISOCountry iSOCountry172 = new ISOCountry(1425, "PA", "PAN", "Panama", "Panamanian");
        PA = iSOCountry172;
        ISOCountry iSOCountry173 = new ISOCountry(OlympusCameraSettingsMakernoteDirectory.TagImageStabilization, "PE", "PER", "Peru", "Peruvian");
        PE = iSOCountry173;
        ...
        SB = iSOCountry193;
        ISOCountry iSOCountry194 = new ISOCountry(1680, BouncyCastleProvider.PROVIDER_NAME, "SYC", "Seychelles", "Seychellois");
        SC = iSOCountry194;
        ...
        SR = iSOCountry206;
        SS = new ISOCountry(1832, InAppStore.SERVER_SIDE_MODE, "SSD", "South Sudan");
        ...
        TZ = iSOCountry226;
        ISOCountry iSOCountry227 = new ISOCountry(OlympusCameraSettingsMakernoteDirectory.TagStackedImage, "UA", "UKR", "Ukraine", "Ukrainian");
        UA = iSOCountry227;
