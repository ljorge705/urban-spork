...
public class UnicodeCountry extends Country implements Serializable {
    ...
    static {
        ...
        BZ = unicodeCountry37;
        UnicodeCountry unicodeCountry38 = new UnicodeCountry(OlympusRawInfoMakernoteDirectory.TagWbRbLevelsEveningSunlight, "CA", "CAN", "Canada", "Canadian");
        CA = unicodeCountry38;
        ...
        CF = unicodeCountry41;
        UnicodeCountry unicodeCountry42 = new UnicodeCountry(IptcDirectory.TAG_ARM_IDENTIFIER, "CG", "COG", "Congo - Brazzaville", "Congolese");
        CG = unicodeCountry42;
        UnicodeCountry unicodeCountry43 = new UnicodeCountry(1878, "CH", "CHE", "Switzerland", "Swiss");
        CH = unicodeCountry43;
        UnicodeCountry unicodeCountry44 = new UnicodeCountry(SQLitePersistence.MAX_ARGS, "CI", "CIV", "Côte d’Ivoire", "Ivorian");
        CI = unicodeCountry44;
        ...
        CM = unicodeCountry47;
        UnicodeCountry unicodeCountry48 = new UnicodeCountry(ExifDirectoryBase.TAG_TRANSFER_RANGE, "CN", "CHN", "China", "Chinese");
        CN = unicodeCountry48;
        ...
        CZ = unicodeCountry55;
        UnicodeCountry unicodeCountry56 = new UnicodeCountry(IptcDirectory.TAG_CONTACT, "DE", "DEU", "Germany", "German");
        DE = unicodeCountry56;
        ...
        DZ = unicodeCountry61;
        UnicodeCountry unicodeCountry62 = new UnicodeCountry(SanyoMakernoteDirectory.TAG_FLICKER_REDUCE, "EC", "ECU", "Ecuador", "Ecuadorian");
        EC = unicodeCountry62;
        ...
        EH = unicodeCountry65;
        UnicodeCountry unicodeCountry66 = new UnicodeCountry(IptcDirectory.TAG_REFERENCE_NUMBER, "ER", "ERI", "Eritrea", "Eritrean");
        ER = unicodeCountry66;
        ...
        ET = unicodeCountry68;
        UnicodeCountry unicodeCountry69 = new UnicodeCountry(IptcDirectory.TAG_PROGRAM_VERSION, "FI", "FIN", "Finland", "Finnish");
        FI = unicodeCountry69;
        ...
        FO = unicodeCountry73;
        UnicodeCountry unicodeCountry74 = new UnicodeCountry(IptcDirectory.TAG_BY_LINE, "FR", "FRA", "France", "French");
        FR = unicodeCountry74;
        ...
        GB = unicodeCountry76;
        UnicodeCountry unicodeCountry77 = new UnicodeCountry(OlympusFocusInfoMakernoteDirectory.TagAfPoint, "GD", "GRD", "Grenada", "Grenadian");
        GD = unicodeCountry77;
        ...
        GM = unicodeCountry84;
        UnicodeCountry unicodeCountry85 = new UnicodeCountry(LeicaMakernoteDirectory.TAG_WB_BLUE_LEVEL, "GN", "GIN", "Guinea", "Guinean");
        GN = unicodeCountry85;
        UnicodeCountry unicodeCountry86 = new UnicodeCountry(LeicaMakernoteDirectory.TAG_MEASURED_LV, "GP", "GLP", "Guadeloupe", "");
        GP = unicodeCountry86;
        UnicodeCountry unicodeCountry87 = new UnicodeCountry(IptcDirectory.TAG_EXPIRATION_TIME, "GQ", "GNQ", "Equatorial Guinea", "Equatorial Guinean, Equatoguinean");
        GQ = unicodeCountry87;
        ...
        GW = unicodeCountry92;
        UnicodeCountry unicodeCountry93 = new UnicodeCountry(OlympusFocusInfoMakernoteDirectory.TagAfInfo, "GY", "GUY", "Guyana", "Guyanese");
        GY = unicodeCountry93;
        ...
        HM = unicodeCountry95;
        UnicodeCountry unicodeCountry96 = new UnicodeCountry(LeicaMakernoteDirectory.TAG_IMAGE_ID_NUMBER, "HN", "HND", "Honduras", "Honduran");
        HN = unicodeCountry96;
        UnicodeCountry unicodeCountry97 = new UnicodeCountry(401, "HR", "HRV", "Croatia", "Croatian");
        HR = unicodeCountry97;
        UnicodeCountry unicodeCountry98 = new UnicodeCountry(LeicaMakernoteDirectory.TAG_CONTROLLER_BOARD_VERSION, "HT", "HTI", "Haiti", "Haitian");
        HT = unicodeCountry98;
        ...
        UnicodeCountry unicodeCountry115 = new UnicodeCountry(PhotoshopDirectory.TAG_TRANSPARENCY_INDEX, "KG", "KGZ", "Kyrgyzstan", "Kyrgyz");
        ...
        UnicodeCountry unicodeCountry117 = new UnicodeCountry(IptcDirectory.TAG_AUDIO_TYPE, "KI", "KIR", "Kiribati", "I-Kiribati");
        ...
        UnicodeCountry unicodeCountry122 = new UnicodeCountry(PhotoshopDirectory.TAG_SEED_NUMBER, "KW", "KWT", "Kuwait", "Kuwaiti");
        ...
        UnicodeCountry unicodeCountry126 = new UnicodeCountry(PhotoshopDirectory.TAG_EXIF_DATA_1, "LB", "LBN", "Lebanon", "Lebanese");
        ...
        UnicodeCountry unicodeCountry128 = new UnicodeCountry(PhotoshopDirectory.TAG_COUNT_INFORMATION, "LI", "LIE", "Liechtenstein", "");
        LI = unicodeCountry128;
        UnicodeCountry unicodeCountry129 = new UnicodeCountry(ExifDirectoryBase.TAG_TILE_OFFSETS, "LK", "LKA", "Sri Lanka", "Sri Lankan");
        LK = unicodeCountry129;
        UnicodeCountry unicodeCountry130 = new UnicodeCountry(PhotoshopDirectory.TAG_LAYER_GROUPS_ENABLED_ID, "LR", "LBR", "Liberia", "Liberian");
        LR = unicodeCountry130;
        UnicodeCountry unicodeCountry131 = new UnicodeCountry(PhotoshopDirectory.TAG_PRINT_SCALE, "LS", "LSO", "Lesotho", "Basotho");
        LS = unicodeCountry131;
        UnicodeCountry unicodeCountry132 = new UnicodeCountry(PhotoshopDirectory.TAG_PATH_SELECTION_STATE, "LT", "LTU", "Lithuania", "Lithuanian");
        ...
        UnicodeCountry unicodeCountry134 = new UnicodeCountry(PhotoshopDirectory.TAG_PIXEL_ASPECT_RATIO, "LV", "LVA", "Latvia", "Latvian");
        LV = unicodeCountry134;
        UnicodeCountry unicodeCountry135 = new UnicodeCountry(PhotoshopDirectory.TAG_SHEET_DISCLOSURE, "LY", "LBY", "Libya", "Libyan");
        ...
        UnicodeCountry unicodeCountry158 = new UnicodeCountry(QuickTimeMetadataDirectory.TAG_DIRECTOR, "MZ", "MOZ", "Mozambique", "Mozambican");
        MZ = unicodeCountry158;
        UnicodeCountry unicodeCountry159 = new UnicodeCountry(QuickTimeMetadataDirectory.TAG_LOCATION_NOTE, "NA", "NAM", "Namibia", "Namibian");
        ...
        UnicodeCountry unicodeCountry167 = new UnicodeCountry(OlympusCameraSettingsMakernoteDirectory.TagPictureModeSharpness, "NP", "NPL", "Nepal", "Nepali");
        ...
        UnicodeCountry unicodeCountry171 = new UnicodeCountry(QuickTimeMetadataDirectory.TAG_COLLECTION_USER, "OM", "OMN", "Oman", "Omani");
        ...
        UnicodeCountry unicodeCountry173 = new UnicodeCountry(OlympusCameraSettingsMakernoteDirectory.TagImageStabilization, "PE", "PER", "Peru", "Peruvian");
        ...
        UnicodeCountry unicodeCountry194 = new UnicodeCountry(1680, BouncyCastleProvider.PROVIDER_NAME, "SYC", "Seychelles", "Seychellois");
        ...
        UnicodeCountry unicodeCountry227 = new UnicodeCountry(OlympusCameraSettingsMakernoteDirectory.TagStackedImage, "UA", "UKR", "Ukraine", "Ukrainian");
