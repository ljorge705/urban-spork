...
public final class VietnameseCalendar extends EastAsianCalendar<Unit, VietnameseCalendar> implements LocalizedPatternSupport {
    ...
    private static class Merger extends AbstractMergerEA<VietnameseCalendar> {
        ...
        */
        public net.time4j.calendar.VietnameseCalendar createFrom(net.time4j.engine.ChronoEntity<?> r3, net.time4j.engine.AttributeQuery r4, boolean r5, boolean r6) {
            /*
                r2 = this;
                net.time4j.engine.ChronoElement<java.lang.Integer> r4 = net.time4j.calendar.CommonElements.RELATED_GREGORIAN_YEAR
                int r4 = r3.getInt(r4)
                r5 = 0
                r6 = -2147483648(0xffffffff80000000, float:-0.0)
                if (r4 != r6) goto L2a
                net.time4j.format.TextElement<net.time4j.calendar.CyclicYear> r4 = net.time4j.calendar.VietnameseCalendar.YEAR_OF_CYCLE
                boolean r4 = r3.contains(r4)
                if (r4 == 0) goto L28
                net.time4j.format.TextElement<net.time4j.calendar.CyclicYear> r4 = net.time4j.calendar.VietnameseCalendar.YEAR_OF_CYCLE
                java.lang.Object r4 = r3.get(r4)
                net.time4j.calendar.CyclicYear r4 = (net.time4j.calendar.CyclicYear) r4
                net.time4j.engine.ChronoElement<java.lang.Integer> r0 = net.time4j.calendar.VietnameseCalendar.CYCLE
                int r0 = r3.getInt(r0)
                if (r0 == r6) goto L28
                net.time4j.calendar.EastAsianYear r4 = r4.inCycle(r0)
                goto L2e
            L28:
                r4 = r5
                goto L2e
            L2a:
                net.time4j.calendar.EastAsianYear r4 = net.time4j.calendar.EastAsianYear.forGregorian(r4)
            L2e:
                if (r4 != 0) goto L38
                ...
                return r5
            L38:
                net.time4j.format.TextElement<net.time4j.calendar.EastAsianMonth> r0 = net.time4j.calendar.VietnameseCalendar.MONTH_OF_YEAR
                boolean r0 = r3.contains(r0)
                if (r0 == 0) goto L55
                net.time4j.format.TextElement<net.time4j.calendar.EastAsianMonth> r0 = net.time4j.calendar.VietnameseCalendar.MONTH_OF_YEAR
                java.lang.Object r0 = r3.get(r0)
                net.time4j.calendar.EastAsianMonth r0 = (net.time4j.calendar.EastAsianMonth) r0
                net.time4j.calendar.StdCalendarElement<java.lang.Integer, net.time4j.calendar.VietnameseCalendar> r1 = net.time4j.calendar.VietnameseCalendar.DAY_OF_MONTH
                int r3 = r3.getInt(r1)
                if (r3 == r6) goto L73
                net.time4j.calendar.VietnameseCalendar r3 = net.time4j.calendar.VietnameseCalendar.of(r4, r0, r3)
                return r3
            L55:
                net.time4j.calendar.StdCalendarElement<java.lang.Integer, net.time4j.calendar.VietnameseCalendar> r0 = net.time4j.calendar.VietnameseCalendar.DAY_OF_YEAR
                int r3 = r3.getInt(r0)
                if (r3 == r6) goto L73
                r6 = 1
                if (r3 < r6) goto L73
                net.time4j.calendar.EastAsianMonth r5 = net.time4j.calendar.EastAsianMonth.valueOf(r6)
                net.time4j.calendar.VietnameseCalendar r4 = net.time4j.calendar.VietnameseCalendar.of(r4, r5, r6)
                int r3 = r3 - r6
                long r5 = (long) r3
                net.time4j.calendar.VietnameseCalendar$Unit r3 = net.time4j.calendar.VietnameseCalendar.Unit.DAYS
                net.time4j.engine.TimePoint r3 = r4.plus(r5, r3)
                net.time4j.calendar.VietnameseCalendar r3 = (net.time4j.calendar.VietnameseCalendar) r3
                return r3
            L73:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: net.time4j.calendar.VietnameseCalendar.Merger.createFrom(net.time4j.engine.ChronoEntity, net.time4j.engine.AttributeQuery, boolean, boolean):net.time4j.calendar.VietnameseCalendar");
        }
    }
