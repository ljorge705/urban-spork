...
class SP80038G {
    ...
    protected static BigInteger calculateY_FF1(BlockCipher blockCipher, byte[] bArr, int i, int i2, int i3, byte[] bArr2, short[] sArr, RadixConverter radixConverter) throws IllegalStateException, DataLengthException {
        ...
        if (i2 > 16) {
            ...
            for (int i7 = 1; i7 < i6; i7++) {
                int i8 = i7 * 16;
                System.arraycopy(bArrPrf, 0, bArr4, i8, 12);
                Pack.intToBigEndian(iBigEndianToInt ^ i7, bArr4, i8 + 12);
    ...
    protected static BigInteger calculateY_FF3(BlockCipher blockCipher, byte[] bArr, int i, int i2, short[] sArr, RadixConverter radixConverter) throws IllegalStateException, DataLengthException {
    ...
    static short[] decFF1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        ...
        while (i6 >= 0) {
            ...
            short[] sArr6 = sArr3;
            i5 = i - i5;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr5).subtract(calculateY_FF1(blockCipher, bArr, iCalculateB_FF1, i4, i6, bArrCalculateP_FF1, sArr3, radixConverter)).mod(bigIntegerArrCalculateModUV[i6 & 1]), i5, sArr5);
            i6--;
            sArr3 = sArr5;
            sArr4 = sArr6;
            iCalculateB_FF1 = i7;
    ...
    private static short[] decFF3_1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        int i4 = i3;
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(BigInteger.valueOf(radixConverter.getRadix()), i2, i4);
        ...
        while (i5 >= 0) {
            int i6 = i - i4;
            int i7 = i5 & 1;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr4).subtract(calculateY_FF3(blockCipher, bArr, 4 - (i7 * 4), i5, sArr3, radixConverter)).mod(bigIntegerArrCalculateModUV[1 - i7]), i6, sArr4);
            i5--;
            i4 = i6;
            short[] sArr5 = sArr4;
            sArr4 = sArr3;
    ...
    private static short[] encFF1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        ...
        while (i5 < 10) {
            ...
            short[] sArr6 = sArr3;
            i6 = i - i6;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr6).add(calculateY_FF1(blockCipher, bArr, iCalculateB_FF1, i4, i5, bArrCalculateP_FF1, sArr5, radixConverter)).mod(bigIntegerArrCalculateModUV[i7 & 1]), i6, sArr6);
            i5 = i7 + 1;
            sArr3 = sArr5;
            sArr4 = sArr6;
        }
    ...
    private static short[] encFF3_1(BlockCipher blockCipher, RadixConverter radixConverter, byte[] bArr, int i, int i2, int i3, short[] sArr, short[] sArr2) throws IllegalStateException, DataLengthException {
        int i4 = i2;
        BigInteger[] bigIntegerArrCalculateModUV = calculateModUV(BigInteger.valueOf(radixConverter.getRadix()), i4, i3);
        Arrays.reverseInPlace(sArr);
        Arrays.reverseInPlace(sArr2);
        short[] sArr3 = sArr;
        short[] sArr4 = sArr2;
        ...
        while (i5 < 8) {
            int i6 = i - i4;
            int i7 = i5 & 1;
            radixConverter.toEncoding(radixConverter.fromEncoding(sArr3).add(calculateY_FF3(blockCipher, bArr, 4 - (i7 * 4), i5, sArr4, radixConverter)).mod(bigIntegerArrCalculateModUV[1 - i7]), i6, sArr3);
            i5++;
            i4 = i6;
            short[] sArr5 = sArr4;
            sArr4 = sArr3;
