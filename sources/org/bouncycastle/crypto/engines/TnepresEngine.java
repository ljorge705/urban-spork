...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    protected void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        int iBigEndianToInt = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i);
        int iBigEndianToInt2 = this.wKey[130] ^ Pack.bigEndianToInt(bArr, i + 4);
        int[] iArr = {Pack.bigEndianToInt(bArr, i + 12) ^ this.wKey[128], this.wKey[129] ^ Pack.bigEndianToInt(bArr, i + 8), iBigEndianToInt2, iBigEndianToInt};
    ...
    protected void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int[] iArr = {Pack.bigEndianToInt(bArr, i + 12), Pack.bigEndianToInt(bArr, i + 8), iBigEndianToInt2, iBigEndianToInt};
