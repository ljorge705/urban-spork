...
public class PhotonBeetleEngine implements AEADCipher {
    ...
    public int doFinal(byte[] bArr, int i) throws InvalidCipherTextException, IllegalStateException {
        ...
        if (length != 0) {
            ...
            bArr4[i10] = (byte) ((bSelect << this.LAST_THREE_BITS_OFFSET) ^ bArr4[i10]);
        }
        if (i2 != 0) {
            ...
            bArr6[i18] = (byte) (bArr6[i18] ^ (bSelect2 << this.LAST_THREE_BITS_OFFSET));
        }
        int i19 = i + i2;
        if (this.input_empty) {
        ...
        if (this.forEncryption) {
            System.arraycopy(this.T, 0, bArr, i19, 16);
            i2 += 16;
        } else {
