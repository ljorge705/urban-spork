...
class DHKEM {
    ...
    private boolean ValidateSk(BigInteger bigInteger) {
        BigInteger n2 = this.domainParams.getN();
        return bigInteger.compareTo(BigInteger.valueOf(1L)) >= 0 && bigInteger.compareTo(n2) < 0 && WNafUtil.getNafWeight(bigInteger) >= (n2.bitLength() >>> 2);
    }
