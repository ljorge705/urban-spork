...
public class SM2Signer implements Signer, ECConstants {
    ...
    private boolean verifySignature(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerCalculateE = calculateE(n2, digestDoFinal());
        ...
        return bigIntegerCalculateE.add(eCPointNormalize.getAffineXCoord().toBigInteger()).mod(n2).equals(bigInteger);
    }
    ...
    public byte[] generateSignature() throws CryptoException {
        ...
        BigInteger n2 = this.ecParams.getN();
        BigInteger bigIntegerCalculateE = calculateE(n2, bArrDigestDoFinal);
        ...
        while (true) {
            ...
            if (!bigIntegerMod.equals(ZERO) && !bigIntegerMod.add(bigIntegerNextK).equals(n2)) {
                BigInteger bigIntegerMod2 = BigIntegers.modOddInverse(n2, d.add(ONE)).multiply(bigIntegerNextK.subtract(bigIntegerMod.multiply(d)).mod(n2)).mod(n2);
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (z) {
            ...
            if (d.compareTo(ONE) < 0 || d.compareTo(bigIntegerSubtract) >= 0) {
