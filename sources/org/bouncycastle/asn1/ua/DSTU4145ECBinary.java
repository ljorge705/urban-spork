...
public class DSTU4145ECBinary extends ASN1Object {
    ...
    private DSTU4145ECBinary(ASN1Sequence aSN1Sequence) {
        ...
        this.f317a = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(i + 1));
        this.b = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(i + 2));
        this.f318n = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(i + 3));
    ...
    public DSTU4145ECBinary(ECDomainParameters eCDomainParameters) {
        ...
        this.f317a = new ASN1Integer(curve.getA().toBigInteger());
        this.b = new DEROctetString(curve.getB().getEncoded());
        this.f318n = new ASN1Integer(eCDomainParameters.getN());
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f317a);
        aSN1EncodableVector.add(this.b);
        aSN1EncodableVector.add(this.f318n);
