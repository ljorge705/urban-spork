...
class FalconNIST {
    ...
    FalconNIST(int i, int i2, SecureRandom secureRandom) {
        ...
        if (i == 10) {
            this.CRYPTO_SECRETKEYBYTES = OlympusCameraSettingsMakernoteDirectory.TagManometerReading;
            this.CRYPTO_BYTES = OlympusCameraSettingsMakernoteDirectory.TagColorCreatorEffect;
            return;
        }
        if (i == 9 || i == 8) {
            i3 = i5 * 12;
    ...
    byte[] crypto_sign(boolean z, byte[] bArr, byte[] bArr2, int i, int i2, byte[] bArr3, int i3) {
        ...
        int iTrim_i8_decode = falconCodec.trim_i8_decode(bArr4, 0, this.LOGN, falconCodec.max_fg_bits[this.LOGN], bArr3, i3, this.CRYPTO_SECRETKEYBYTES);
        if (iTrim_i8_decode == 0) {
            throw new IllegalStateException("f decode failed");
        }
        FalconCodec falconCodec2 = this.codec;
        int iTrim_i8_decode2 = falconCodec2.trim_i8_decode(bArr5, 0, this.LOGN, falconCodec2.max_fg_bits[this.LOGN], bArr3, i3 + iTrim_i8_decode, this.CRYPTO_SECRETKEYBYTES - iTrim_i8_decode);
        ...
        int iTrim_i8_decode3 = falconCodec3.trim_i8_decode(bArr6, 0, this.LOGN, falconCodec3.max_FG_bits[this.LOGN], bArr3, i3 + i7, this.CRYPTO_SECRETKEYBYTES - i7);
        ...
        if (z) {
            ...
            bArr10[0] = (byte) (i9 + 32);
            i5 = 1;
            int iComp_encode2 = this.codec.comp_encode(bArr10, 1, i8 - 1, sArr, 0, i9);
            if (iComp_encode2 == 0) {
            ...
            i4 = 0;
            i5 = 1;
            iComp_encode = this.codec.comp_encode(bArr10, 0, i8, sArr, 0, this.LOGN);
            if (iComp_encode == 0) {
                throw new IllegalStateException("signature failed to generate");
            }
        }
        ...
        System.arraycopy(bArr10, i4, bArr, this.NONCELEN + i5, iComp_encode);
        return Arrays.copyOfRange(bArr, i4, this.NONCELEN + i5 + iComp_encode);
    }
    ...
    byte[][] crypto_sign_keypair(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        FalconCodec falconCodec = this.codec;
        int i5 = i2 + 1;
        int iTrim_i8_encode = falconCodec.trim_i8_encode(bArr2, i5, this.CRYPTO_SECRETKEYBYTES - 1, bArr3, 0, i4, falconCodec.max_fg_bits[this.LOGN]);
        ...
        FalconCodec falconCodec2 = this.codec;
        int i7 = i2 + i6;
        int iTrim_i8_encode2 = falconCodec2.trim_i8_encode(bArr2, i7, this.CRYPTO_SECRETKEYBYTES - i6, bArr4, 0, this.LOGN, falconCodec2.max_fg_bits[this.LOGN]);
        if (iTrim_i8_encode2 == 0) {
            throw new IllegalStateException("g encode failed");
        }
        int i8 = i6 + iTrim_i8_encode2;
        byte[] bArrCopyOfRange2 = Arrays.copyOfRange(bArr2, i7, i8);
        FalconCodec falconCodec3 = this.codec;
        int i9 = i2 + i8;
        int iTrim_i8_encode3 = falconCodec3.trim_i8_encode(bArr2, i9, this.CRYPTO_SECRETKEYBYTES - i8, bArr5, 0, this.LOGN, falconCodec3.max_FG_bits[this.LOGN]);
        if (iTrim_i8_encode3 == 0) {
            throw new IllegalStateException("F encode failed");
        }
        int i10 = i8 + iTrim_i8_encode3;
        byte[] bArrCopyOfRange3 = Arrays.copyOfRange(bArr2, i9, i10);
    ...
    */
    int crypto_sign_open(boolean r20, byte[] r21, byte[] r22, byte[] r23, byte[] r24, int r25) {
        /*
