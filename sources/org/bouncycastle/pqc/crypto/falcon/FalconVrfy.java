...
class FalconVrfy {
    final int Q = CasioType2MakernoteDirectory.TAG_SELF_TIMER;
    final int Q0I = 12287;
    final int R = 4091;
    final int R2 = 10952;
    ...
    boolean complete_private(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, byte[] bArr4, int i4, int i5, short[] sArr, int i6) {
        ...
        for (int i13 = 0; i13 < i7; i13++) {
            ...
            int i15 = i14 - ((~(-((i14 - 6144) >>> 31))) & CasioType2MakernoteDirectory.TAG_SELF_TIMER);
            z &= i15 >= -127 && i15 <= 127;
            bArr[i + i13] = (byte) i15;
        }
        return z;
    ...
    int count_nttzero(short[] sArr, int i, int i2, short[] sArr2, int i3) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            short s = sArr[i + i5];
            sArr2[i3 + i5] = (short) (s + ((-(s >>> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER));
        }
        mq_NTT(sArr2, i3, i2);
        int i6 = 0;
    ...
    int mq_add(int i, int i2) {
        int i3 = (i + i2) - 12289;
        return i3 + ((-(i3 >>> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER);
    }

    int mq_conv_small(int i) {
        return i + ((-(i >>> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER);
    }
    ...
    int mq_montymul(int i, int i2) {
        int i3 = i * i2;
        int i4 = ((i3 + (((i3 * 12287) & 65535) * CasioType2MakernoteDirectory.TAG_SELF_TIMER)) >>> 16) - 12289;
        return i4 + ((-(i4 >>> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER);
    }
    ...
    int mq_rshift1(int i) {
        return (i + ((-(i & 1)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER)) >>> 1;
    }
    ...
    int verify_raw(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, int i4, short[] sArr4, int i5) {
        ...
        for (int i7 = 0; i7 < i6; i7++) {
            short s = sArr2[i2 + i7];
            sArr4[i5 + i7] = (short) (s + ((-(s >>> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER));
        }
        mq_NTT(sArr4, i5, i4);
        ...
        for (int i8 = 0; i8 < i6; i8++) {
            ...
            sArr4[i9] = (short) (i10 - ((-((6144 - i10) >>> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER));
        }
    ...
    int verify_recover(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, short[] sArr4, int i4, int i5, short[] sArr5, int i6) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            short s = sArr4[i4 + i8];
            sArr5[i6 + i8] = (short) (s + ((-(s >> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER));
            short s2 = sArr3[i3 + i8];
            sArr[i + i8] = (short) mq_sub(sArr2[i2 + i8], 65535 & (s2 + ((-(s2 >>> 31)) & CasioType2MakernoteDirectory.TAG_SELF_TIMER)));
        }
        mq_NTT(sArr5, i6, i5);
        mq_NTT(sArr5, i, i5);
        int i9 = 0;
