...
class FalconFFT {
    ...
    void iFFT(FalconFPR[] falconFPRArr, int i, int i2) {
        ...
        while (true) {
            ...
            while (i3 < i6) {
                ...
                FPREngine fPREngine = this.fpr;
                FalconFPR falconFPRFpr_neg = fPREngine.fpr_neg(fPREngine.fpr_gm_tab[i12 + i4]);
                int i13 = i3;
    ...
    void poly_merge_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            int i10 = i3 + i8;
            int i11 = (i8 + i6) << 1;
            ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(falconFPRArr3[i10], falconFPRArr3[i10 + i7], this.fpr.fpr_gm_tab[i11], this.fpr.fpr_gm_tab[i11 + 1]);
            FalconFPR falconFPR3 = complexNumberWrapperFPC_MUL.re;
            FalconFPR falconFPR4 = complexNumberWrapperFPC_MUL.im;
    ...
    void poly_split_fft(FalconFPR[] falconFPRArr, int i, FalconFPR[] falconFPRArr2, int i2, FalconFPR[] falconFPRArr3, int i3, int i4) {
        ...
        for (int i8 = 0; i8 < i7; i8++) {
            ...
            FPREngine fPREngine = this.fpr;
            ComplexNumberWrapper complexNumberWrapperFPC_MUL = FPC_MUL(falconFPR7, falconFPR8, falconFPR9, fPREngine.fpr_neg(fPREngine.fpr_gm_tab[i12 + 1]));
            FalconFPR falconFPR10 = complexNumberWrapperFPC_MUL.re;
            FalconFPR falconFPR11 = complexNumberWrapperFPC_MUL.im;
            int i13 = i2 + i8;
