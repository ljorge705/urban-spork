...
public class FrodoParameters implements KEMParameters {
    ...
    static {
        ...
        cdf_table1344 = sArr3;
        frodokem640aes = new FrodoParameters("frodokem640aes", OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, 15, 2, sArr, new SHAKEDigest(128), new FrodoMatrixGenerator.Aes128MatrixGenerator(OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, 32768));
        frodokem640shake = new FrodoParameters("frodokem640shake", OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, 15, 2, sArr, new SHAKEDigest(128), new FrodoMatrixGenerator.Shake128MatrixGenerator(OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE, 32768));
