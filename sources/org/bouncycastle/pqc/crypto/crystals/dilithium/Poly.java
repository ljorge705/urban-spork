...
class Poly {
    ...
    public Poly(DilithiumEngine dilithiumEngine) {
        ...
        this.polyUniformNBlocks = (symmetricGetSymmetric.stream128BlockBytes + 767) / symmetricGetSymmetric.stream128BlockBytes;
    }
    ...
    public byte[] polyt0Pack(byte[] bArr, int i) {
        int[] iArr = new int[8];
        int i2 = 0;
        for (int i3 = 8; i2 < this.dilithiumN / i3; i3 = 8) {
            int i4 = i2 * 8;
            iArr[0] = 4096 - getCoeffIndex(i4);
            ...
            bArr[i7] = b;
            int i8 = iArr[1];
            bArr[i7] = (byte) (((byte) (i8 << 5)) | b);
            bArr[i5 + 2] = (byte) (i8 >> 3);
            int i9 = i5 + 3;
            byte b2 = (byte) (i8 >> 11);
            bArr[i9] = b2;
            int i10 = iArr[2];
            bArr[i9] = (byte) (b2 | ((byte) (i10 << 2)));
            int i11 = i5 + 4;
            byte b3 = (byte) (i10 >> 6);
            bArr[i11] = b3;
            int i12 = iArr[3];
            bArr[i11] = (byte) (b3 | ((byte) (i12 << 7)));
            bArr[i5 + 5] = (byte) (i12 >> 1);
            int i13 = i5 + 6;
            byte b4 = (byte) (i12 >> 9);
            bArr[i13] = b4;
            int i14 = iArr[4];
            bArr[i13] = (byte) (b4 | ((byte) (i14 << 4)));
            bArr[i5 + 7] = (byte) (i14 >> 4);
            int i15 = i5 + 8;
            byte b5 = (byte) (i14 >> 12);
            bArr[i15] = b5;
            int i16 = iArr[5];
            bArr[i15] = (byte) (b5 | ((byte) (i16 << 1)));
            int i17 = i5 + 9;
            byte b6 = (byte) (i16 >> 7);
            bArr[i17] = b6;
            int i18 = iArr[6];
            bArr[i17] = (byte) (b6 | ((byte) (i18 << 6)));
            bArr[i5 + 10] = (byte) (i18 >> 2);
            int i19 = i5 + 11;
            byte b7 = (byte) (i18 >> 10);
            bArr[i19] = b7;
            bArr[i19] = (byte) (b7 | ((byte) (coeffIndex << 3)));
    ...
    public void uniformBlocks(byte[] bArr, short s) {
        ...
        int iRejectUniform = rejectUniform(this, 0, this.dilithiumN, bArr2, i);
        while (iRejectUniform < this.dilithiumN) {
            ...
            iRejectUniform += rejectUniform(this, iRejectUniform, this.dilithiumN - iRejectUniform, bArr2, i);
        }
    }
    ...
    public void uniformEta(byte[] bArr, short s) {
        ...
        int iRejectEta = rejectEta(this, 0, this.dilithiumN, bArr2, i2, dilithiumEta);
