...
class Horst {
    ...
    static int horst_verify(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i16 = 0; i16 < 32; i16++) {
            hashFunctions.hash_2n_n_mask(bArr5, i16 * 32, bArr2, i + (i16 * 64), bArr3, OlympusMakernoteDirectory.TAG_PREVIEW_IMAGE);
        }
        ...
        for (int i19 = 0; i19 < 4; i19++) {
            hashFunctions.hash_2n_n_mask(bArr5, i19 * 32, bArr5, i19 * 64, bArr3, LeicaMakernoteDirectory.TAG_IMAGE_ID_NUMBER);
        }
