...
public class SNTRUPrimeParameters implements KEMParameters {
    ...
    public static final SNTRUPrimeParameters sntrup857 = new SNTRUPrimeParameters("sntrup857", 857, 5167, ExifDirectoryBase.TAG_TILE_WIDTH, 1322, 1152, 1322, 1999, 32);
    public static final SNTRUPrimeParameters sntrup953 = new SNTRUPrimeParameters("sntrup953", 953, 6343, 396, 1505, OlympusCameraSettingsMakernoteDirectory.TagPictureModeBWFilter, 1505, 2254, 32);
    public static final SNTRUPrimeParameters sntrup1013 = new SNTRUPrimeParameters("sntrup1013", 1013, 7177, CaptureActivity.RESULT_EXIT_USER_FLOW, 1623, 1423, 1623, 2417, 32);
