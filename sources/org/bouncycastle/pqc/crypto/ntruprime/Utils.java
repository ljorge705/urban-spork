...
class Utils {
    ...
    protected static void expand(int[] iArr, byte[] bArr) throws DataLengthException, IllegalArgumentException {
    ...
    protected static void generatePolynomialInRQFromSeed(short[] sArr, byte[] bArr, int i, int i2) throws DataLengthException, IllegalArgumentException {
        int[] iArr = new int[i];
        expand(iArr, bArr);
