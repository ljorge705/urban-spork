...
class ReedMuller {
    ...
    static void encodeSub(Codeword codeword, int i) {
        int iBit0Mask = ((((Bit0Mask(i >> 7) ^ (Bit0Mask(i) & (-1431655766))) ^ (Bit0Mask(i >> 1) & (-858993460))) ^ (Bit0Mask(i >> 2) & (-252645136))) ^ (Bit0Mask(i >> 3) & (-16711936))) ^ (Bit0Mask(i >> 4) & SupportMenu.CATEGORY_MASK);
    ...
    private static void hadamardTransform(int[] iArr, int[] iArr2) {
        ...
        int i = 0;
        while (true) {
            int[] iArr3 = iArrClone2;
            iArrClone2 = iArrClone;
            iArrClone = iArr3;
            if (i >= 7) {
                System.arraycopy(iArrClone, 0, iArr, 0, iArr.length);
                System.arraycopy(iArrClone2, 0, iArr2, 0, iArr2.length);
                return;
            }
            for (int i2 = 0; i2 < 64; i2++) {
                int i3 = i2 * 2;
                int i4 = i3 + 1;
                iArrClone[i2] = iArrClone2[i3] + iArrClone2[i4];
                iArrClone[i2 + 64] = iArrClone2[i3] - iArrClone2[i4];
            }
            i++;
        }
    }
