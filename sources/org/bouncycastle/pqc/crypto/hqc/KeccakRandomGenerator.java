...
class KeccakRandomGenerator {
    ...
    private void keccakIncAbsorb(byte[] bArr, int i) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (j4 < j3 - j2) {
                    int i6 = ((int) (j2 + j4)) >> 3;
                    jArr[i6] = jArr[i6] ^ (toUnsignedLong(bArr[i5 + i4] & 255) << ((int) (((this.state[25] + j4) & 7) * 8)));
                    i5++;
                }
            }
            i3 = (int) (j - (j3 - j2));
        ...
        while (true) {
            ...
            jArr2[i8] = jArr2[i8] ^ (toUnsignedLong(bArr[i7 + i4] & 255) << ((int) (((this.state[25] + j5) & 7) * 8)));
            i7++;
        }
    }
    ...
    private static void keccakPermutation(long[] jArr) {
        ...
        while (i < 24) {
            ...
            long j102 = ((~j71) & j73) ^ j81;
            long j103 = ((~j73) & j78) ^ j71;
            long j104 = j67 ^ ((~j76) & j65);
            j22 = j76 ^ ((~j65) & j72);
            j21 = j104;
            long j105 = j65 ^ ((~j72) & j75);
            long j106 = ((~j75) & j67) ^ j72;
            long j107 = ((~j67) & j76) ^ j75;
            j7 = j91;
            j3 = j87;
            j13 = j96;
            j14 = j97;
