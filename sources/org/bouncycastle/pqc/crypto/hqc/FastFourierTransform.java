    ...
    static void computeFFTRec(int[] iArr, int[] iArr2, int i, int i2, int i3, int[] iArr3, int i4, int i5) {
        ...
        if (i3 == 1) {
            for (int i9 = 0; i9 < i2; i9++) {
                iArr11[i9] = GFCalculator.mult(iArr3[i9], iArr2[1]);
            }
            iArr[0] = iArr2[0];
            for (int i10 = 0; i10 < i2; i10++) {
                for (int i11 = 0; i11 < iMult; i11++) {
                    iArr[iMult + i11] = iArr[i11] ^ iArr11[i10];
                }
                iMult <<= 1;
            }
            return;
        ...
        if (iArr3[i12] != 1) {
            int i13 = 1;
            for (int i14 = 1 << i3; i13 < i14; i14 = i14) {
                iMult = GFCalculator.mult(iMult, iArr3[i12]);
                iArr2[i13] = GFCalculator.mult(iMult, iArr2[i13]);
                i13++;
            }
        }
        computeRadix(iArr4, iArr5, iArr2, i3, i4);
        for (int i15 = 0; i15 < i12; i15++) {
            int iMult2 = GFCalculator.mult(iArr3[i15], GFCalculator.inverse(iArr3[i12]));
            iArr6[i15] = iMult2;
            iArr7[i15] = GFCalculator.mult(iMult2, iMult2) ^ iArr6[i15];
        }
        computeSubsetSum(iArr8, iArr6, i12);
        int i16 = i3 - 1;
        computeFFTRec(iArr9, iArr4, (i + 1) / 2, i12, i16, iArr7, i4, i5);
        int i17 = 1 << (i12 & 15);
        if (i <= 3) {
            iArr[0] = iArr9[0];
            iArr[i17] = iArr9[0] ^ iArr5[0];
            for (int i18 = 1; i18 < i17; i18++) {
                int iMult3 = iArr9[i18] ^ GFCalculator.mult(iArr8[i18], iArr5[0]);
                iArr[i18] = iMult3;
                iArr[i17 + i18] = iMult3 ^ iArr5[0];
            }
            return;
        }
        computeFFTRec(iArr10, iArr5, i / 2, i12, i16, iArr7, i4, i5);
        System.arraycopy(iArr10, 0, iArr, i17, i17);
        iArr[0] = iArr9[0];
        iArr[i17] = iArr[i17] ^ iArr9[0];
        for (int i19 = 1; i19 < i17; i19++) {
            int iMult4 = iArr9[i19] ^ GFCalculator.mult(iArr8[i19], iArr10[i19]);
            iArr[i19] = iMult4;
            int i20 = i17 + i19;
            iArr[i20] = iMult4 ^ iArr[i20];
        }
    }
