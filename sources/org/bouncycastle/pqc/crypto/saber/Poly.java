    ...
    private void karatsuba_simple(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (true) {
            ...
            for (int i8 = 16; i7 < i8; i8 = 16) {
                ...
                int i13 = i3;
                int[] iArr8 = iArr7;
                iArr4[i11] = (int) (iArr4[i11] + ((i9 + i10) * (i3 + i4)));
                int i14 = iArr2[i7 + 32];
                int i15 = iArr2[i7 + 48];
                int i16 = i11 + 64;
                iArr3[i16] = iArr3[i16] + OVERFLOWING_MUL(i14, i5);
                int i17 = i11 + 96;
                iArr3[i17] = iArr3[i17] + OVERFLOWING_MUL(i15, i6);
                iArr6[i11] = iArr6[i11] + OVERFLOWING_MUL(i5 + i6, i14 + i15);
                int i18 = i9 + i14;
                int i19 = i13 + i5;
                iArr8[i11] = iArr8[i11] + OVERFLOWING_MUL(i18, i19);
                int i20 = i10 + i15;
                int i21 = i4 + i6;
                iArr8[i12] = iArr8[i12] + OVERFLOWING_MUL(i20, i21);
                iArr5[i11] = iArr5[i11] + OVERFLOWING_MUL(i18 + i20, i19 + i21);
                i7++;
                i3 = i13;
                i2 = i2;
                iArr7 = iArr8;
        ...
        for (int i28 = 0; i28 < 63; i28++) {
            iArr9[i28] = (iArr9[i28] - iArr3[i28]) - iArr3[i28 + 64];
        }
        for (int i29 = 0; i29 < 63; i29++) {
            int i30 = i29 + 32;
            iArr3[i30] = iArr3[i30] + iArr9[i29];
        }
    }
