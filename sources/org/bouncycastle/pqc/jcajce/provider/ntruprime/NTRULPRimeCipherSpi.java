...
class NTRULPRimeCipherSpi extends CipherSpi {
    ...
    @Override // javax.crypto.CipherSpi
    protected Key engineUnwrap(byte[] bArr, String str, int i) throws DataLengthException, NoSuchAlgorithmException, InvalidKeyException {
        if (i != 3) {
    ...
    @Override // javax.crypto.CipherSpi
    protected byte[] engineWrap(Key key) throws DataLengthException, IllegalBlockSizeException, InvalidKeyException {
