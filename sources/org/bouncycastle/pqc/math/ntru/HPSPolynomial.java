...
public class HPSPolynomial extends Polynomial {
    ...
    public void sqFromBytes(byte[] bArr) {
        ...
        while (i < this.params.packDegree() / 8) {
            ...
            int i9 = i3 + 5;
            this.coeffs[i2 + 3] = (short) (i8 | ((((short) (bArr[i9] & 255)) & 15) << 7));
            int i10 = (bArr[i9] & 255) >>> 4;
            int i11 = i3 + 6;
            this.coeffs[i2 + 4] = (short) (((((short) (bArr[i11] & 255)) & 127) << 4) | i10);
            int i12 = i3 + 8;
            this.coeffs[i2 + 5] = (short) (((bArr[i11] & 255) >>> 7) | ((((short) (bArr[i3 + 7] & 255)) & 255) << 1) | ((((short) (bArr[i12] & 255)) & 3) << 9));
            int i13 = i3 + 9;
            this.coeffs[i2 + 6] = (short) (((bArr[i12] & 255) >>> 2) | ((((short) (bArr[i13] & 255)) & 31) << 6));
            this.coeffs[i2 + 7] = (short) (((bArr[i13] & 255) >>> 5) | ((((short) (bArr[i3 + 10] & 255)) & 255) << 3));
            i++;
        }
        ...
        if (iPackDegree == 2) {
            ...
            int i15 = i * 11;
            int i16 = i15 + 1;
            this.coeffs[i14] = (short) ((bArr[i15] & 255) | ((((short) (bArr[i16] & 255)) & 7) << 8));
            this.coeffs[i14 + 1] = (short) (((((short) (bArr[i15 + 2] & 255)) & 63) << 5) | ((bArr[i16] & 255) >>> 3));
        } else if (iPackDegree == 4) {
            int i17 = i * 8;
            int i18 = i * 11;
            int i19 = i18 + 1;
            this.coeffs[i17] = (short) ((bArr[i18] & 255) | ((((short) (bArr[i19] & 255)) & 7) << 8));
            int i20 = i18 + 2;
            this.coeffs[i17 + 1] = (short) (((bArr[i19] & 255) >>> 3) | ((((short) (bArr[i20] & 255)) & 63) << 5));
            int i21 = i18 + 4;
            this.coeffs[i17 + 2] = (short) (((((short) (bArr[i18 + 3] & 255)) & 255) << 2) | ((bArr[i20] & 255) >>> 6) | ((((short) (bArr[i21] & 255)) & 1) << 10));
            this.coeffs[i17 + 3] = (short) (((((short) (bArr[i18 + 5] & 255)) & 15) << 7) | ((bArr[i21] & 255) >>> 1));
        }
