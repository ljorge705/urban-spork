    ...
    void s3Inv(Polynomial polynomial, Polynomial polynomial2, Polynomial polynomial3, Polynomial polynomial4, Polynomial polynomial5) {
        ...
        for (short s3 = 1; i4 < (i * 2) - s3; s3 = 1) {
            ...
            for (int i7 = s; i7 < length; i7++) {
                ...
                short s4 = sArr3[i7];
                short[] sArr4 = polynomial3.coeffs;
                short s5 = (short) (sBothNegativeMask & (s4 ^ sArr4[i7]));
                sArr3[i7] = (short) (s4 ^ s5);
                sArr4[i7] = (short) (s5 ^ sArr4[i7]);
                short[] sArr5 = polynomial4.coeffs;
                short s6 = sArr5[i7];
                short[] sArr6 = polynomial5.coeffs;
                short s7 = (short) ((sArr6[i7] ^ s6) & sBothNegativeMask);
                sArr5[i7] = (short) (s6 ^ s7);
                sArr6[i7] = (short) (sArr6[i7] ^ s7);
            }
            for (int i8 = 0; i8 < length; i8++) {
                polynomial3.coeffs[i8] = mod3((byte) (r8[i8] + (polynomial2.coeffs[i8] * sMod3)));
            }
            for (int i9 = 0; i9 < length; i9++) {
                polynomial5.coeffs[i9] = mod3((byte) (r8[i9] + (polynomial4.coeffs[i9] * sMod3)));
            }
            int i10 = 0;
            while (i10 < i) {
                short[] sArr7 = polynomial3.coeffs;
