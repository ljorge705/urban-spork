...
public class HRSS1373Polynomial extends HRSSPolynomial {
    ...
    public void sqFromBytes(byte[] bArr) {
        ...
        while (i < this.params.packDegree() / 4) {
            ...
            int i3 = i * 7;
            int i4 = i3 + 1;
            this.coeffs[i2] = (short) ((bArr[i3] & 255) | ((((short) (bArr[i4] & 255)) & 63) << 8));
            int i5 = i3 + 3;
            this.coeffs[i2 + 1] = (short) (((bArr[i4] & 255) >>> 6) | (((short) (bArr[i3 + 2] & 255)) << 2) | (((short) (bArr[i5] & 15)) << 10));
            int i6 = ((bArr[i5] & 255) >>> 4) | ((((short) (bArr[i3 + 4] & 255)) & 255) << 4);
            int i7 = i3 + 5;
            this.coeffs[i2 + 2] = (short) (i6 | (((short) (bArr[i7] & 3)) << 12));
            this.coeffs[i2 + 3] = (short) (((bArr[i7] & 255) >>> 2) | (((short) (bArr[i3 + 6] & 255)) << 6));
            i++;
        }
    ...
    public byte[] sqToBytes(int i) {
        ...
        if (this.params.packDegree() % 4 == 2) {
            ...
            short sModQ = (short) modQ(this.coeffs[this.params.packDegree() - 1] & 65535, this.params.q());
            sArr[1] = sModQ;
            int i5 = i2 * 7;
            short s5 = sArr[0];
            bArr[i5] = (byte) (s5 & 255);
