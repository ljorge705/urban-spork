...
public class EtsiTs103097ExtensionModule {
    ...
    static {
        ...
        OERDefinition.Builder builderTypeName2 = OERDefinition.seq(Ieee1609Dot2BaseTypes.HashedId8.label("issuerId"), OERDefinition.optional(OERDefinition.integer(0L, 255L).label("lastKnownCtlSequence"))).typeName("EtsiTs102941CtlRequest");
