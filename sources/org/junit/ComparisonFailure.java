    ...
    private static class ComparisonCompactor {
        ...
        private class DiffExtractor {
            ...
            public String compactSuffix() {
                return this.sharedSuffix.length() <= ComparisonCompactor.this.contextLength ? this.sharedSuffix : this.sharedSuffix.substring(0, ComparisonCompactor.this.contextLength) + ComparisonCompactor.ELLIPSIS;
            }
