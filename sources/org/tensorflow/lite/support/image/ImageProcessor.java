...
public class ImageProcessor extends SequentialProcessor<TensorImage> {
    ...
    public RectF inverseTransform(RectF rect, int inputImageHeight, int inputImageWidth) {
        PointF pointFInverseTransform = inverseTransform(new PointF(rect.left, rect.top), inputImageHeight, inputImageWidth);
        PointF pointFInverseTransform2 = inverseTransform(new PointF(rect.right, rect.bottom), inputImageHeight, inputImageWidth);
