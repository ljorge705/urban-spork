...
public class TensorOperatorWrapper implements ImageOperator {
    ...
    public TensorImage apply(TensorImage image) {
        ...
        TensorBuffer tensorBufferApply = this.tensorOp.apply(image.getTensorBuffer());
        ColorSpaceType colorSpaceType = image.getColorSpaceType();
        TensorImage tensorImage = new TensorImage(tensorBufferApply.getDataType());
        tensorImage.load(tensorBufferApply, colorSpaceType);
        return tensorImage;
    }
}
