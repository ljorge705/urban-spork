...
public class TransformToGrayscaleOp implements ImageOperator {
    ...
    public TensorImage apply(TensorImage image) {
        ...
        TensorBuffer tensorBufferCreateFixedSize = TensorBuffer.createFixedSize(iArr2, image.getDataType());
        tensorBufferCreateFixedSize.loadArray(iArr, iArr2);
        image.load(tensorBufferCreateFixedSize, ColorSpaceType.GRAYSCALE);
        return image;
    }
}
