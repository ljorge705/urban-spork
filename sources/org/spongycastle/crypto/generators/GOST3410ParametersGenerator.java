        ...
        while (i11 < i8) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (bigInteger10.modPow(bigIntegerArr4[i16].multiply(bigIntegerAdd.add(BigInteger.valueOf(j))), bigIntegerArr4[i10]).compareTo(bigInteger9) == 0 && bigInteger10.modPow(bigIntegerAdd.add(BigInteger.valueOf(j)), bigIntegerArr4[i10]).compareTo(bigInteger9) != 0) {
                        break;
                    }
                    i17 += 2;
                    i8 = i4;
