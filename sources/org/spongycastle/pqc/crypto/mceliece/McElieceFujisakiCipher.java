...
public class McElieceFujisakiCipher implements MessageEncryptor {
    ...
    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        ...
        this.f409n = mcElieceCCA2PublicKeyParameters.getN();
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f409n = mcElieceCCA2PrivateKeyParameters.getN();
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f409n, this.t, bArr2)).getEncoded();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException, ArrayIndexOutOfBoundsException {
        ...
        int i = (this.f409n + 7) >> 3;
        int length = bArr.length - i;
        byte[][] bArrSplit = ByteUtils.split(bArr, i);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f409n, bArr2));
        ...
        if (Conversions.encode(this.f409n, this.t, bArr5).equals(gF2Vector)) {
            return bArr4;
        }
