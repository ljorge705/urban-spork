...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        ...
        this.f411n = mcElieceCCA2PublicKeyParameters.getN();
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f411n = mcElieceCCA2PrivateKeyParameters.getN();
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        int i = this.k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f411n, this.t).bitLength() - 1) >> 3;
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.k, bArr9), Conversions.encode(this.f411n, this.t, bArr8)).getEncoded();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException, ArrayIndexOutOfBoundsException {
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f411n, bArr));
        ...
        byte[] bArrConcatenate = ByteUtils.concatenate(ByteUtils.concatenate(bArr2, Conversions.decode(this.f411n, this.t, gF2Vector)), encoded);
