...
public class McElieceCCA2KeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.f405n = this.mcElieceCCA2Params.getParameters().getN();
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        return new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new McElieceCCA2PublicKeyParameters(this.f405n, this.t, gF2Matrix, this.mcElieceCCA2Params.getParameters().getDigest()), (AsymmetricKeyParameter) new McElieceCCA2PrivateKeyParameters(this.f405n, gF2Matrix.getNumRows(), gF2mField, polynomialGF2mSmallM, permutation, this.mcElieceCCA2Params.getParameters().getDigest()));
    }
}
