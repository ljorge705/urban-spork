...
public class CMSAuthenticatedDataGenerator extends CMSAuthenticatedGenerator {
    ...
    public CMSAuthenticatedData generate(CMSTypedData cMSTypedData, MacCalculator macCalculator, final DigestCalculator digestCalculator) throws IOException, CMSException {
