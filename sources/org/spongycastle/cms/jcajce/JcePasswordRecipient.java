...
public abstract class JcePasswordRecipient implements PasswordRecipient {
    ...
    protected Key extractSecretKey(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2, byte[] bArr, byte[] bArr2) throws InvalidKeyException, CMSException, InvalidAlgorithmParameterException {
