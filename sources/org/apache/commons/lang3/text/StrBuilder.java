...
public class StrBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    public StrBuilder append(boolean z) {
        if (z) {
            ...
            char[] cArr = this.buffer;
            int i = this.size;
            cArr[i] = Constants.INAPP_POSITION_TOP;
            cArr[i + 1] = Constants.INAPP_POSITION_RIGHT;
            ...
            cArr2[i2] = 'f';
            cArr2[i2 + 1] = 'a';
            cArr2[i2 + 2] = Constants.INAPP_POSITION_LEFT;
            cArr2[i2 + 3] = 's';
            this.size = i2 + 5;
            cArr2[i2 + 4] = 'e';
        }
    ...
    public StrBuilder insert(int i, boolean z) {
        ...
        if (z) {
            ...
            char[] cArr2 = this.buffer;
            cArr2[i] = Constants.INAPP_POSITION_TOP;
            cArr2[i + 1] = Constants.INAPP_POSITION_RIGHT;
            ...
            cArr4[i] = 'f';
            cArr4[i + 1] = 'a';
            cArr4[i + 2] = Constants.INAPP_POSITION_LEFT;
            cArr4[i + 3] = 's';
            cArr4[i + 4] = 'e';
            this.size += 5;
        }
