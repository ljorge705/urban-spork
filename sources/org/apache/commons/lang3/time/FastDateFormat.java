...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    public String toString() {
        return "FastDateFormat[" + this.printer.getPattern() + Constants.SEPARATOR_COMMA + this.printer.getLocale() + Constants.SEPARATOR_COMMA + this.printer.getTimeZone().getID() + "]";
    }
