...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    private final void insertAtInternal(int i, int n2) {
        ...
        E[] eArr = this.array;
        ArraysKt.copyInto(eArr, eArr, i + n2, i, this.offset + this.length);
        this.length += n2;
    }
    ...
    private final void addAllInternal(int i, Collection<? extends E> elements, int n2) {
        ...
        ListBuilder<E> listBuilder = this.backing;
        if (listBuilder != null) {
            listBuilder.addAllInternal(i, elements, n2);
            this.array = this.backing.array;
            this.length += n2;
        } else {
