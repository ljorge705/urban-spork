...
public class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final boolean toBooleanStrict(String str) {
        ...
        if (Intrinsics.areEqual(str, com.facebook.hermes.intl.Constants.CASEFIRST_FALSE)) {
            return false;
        }
    ...
    public static final Boolean toBooleanStrictOrNull(String str) {
        ...
        return Intrinsics.areEqual(str, com.facebook.hermes.intl.Constants.CASEFIRST_FALSE) ? false : null;
    }
