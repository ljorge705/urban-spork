...
public final class UStringsKt {
    ...
    public static final String m7409toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m7411toStringolVBNx4(short s, int i) {
    ...
    public static final String m7410toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m7408toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m6191constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m6107boximpl(UByte.m6113constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m6191constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m6371boximpl(UShort.m6377constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM6191constructorimpl = UInt.m6191constructorimpl(i);
        int iM$1 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                if (iM$1 == 119304647) {
                    iM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1, iM6191constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM$1 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM6191constructorimpl2 = UInt.m6191constructorimpl(i3 * iM6191constructorimpl);
            int iM6191constructorimpl3 = UInt.m6191constructorimpl(UInt.m6191constructorimpl(iDigitOf) + iM6191constructorimpl2);
            if (Integer.compare(iM6191constructorimpl3 ^ Integer.MIN_VALUE, iM6191constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM6191constructorimpl3;
        }
        return UInt.m6185boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM6270constructorimpl = ULong.m6270constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM6270constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM6270constructorimpl2 = ULong.m6270constructorimpl(j * jM6270constructorimpl);
            long jM6270constructorimpl3 = ULong.m6270constructorimpl(ULong.m6270constructorimpl(UInt.m6191constructorimpl(r13) & 4294967295L) + jM6270constructorimpl2);
            if (Long.compare(jM6270constructorimpl3 ^ Long.MIN_VALUE, jM6270constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM6270constructorimpl3;
        }
