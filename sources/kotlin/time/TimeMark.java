...
public interface TimeMark {
    ...
    TimeMark mo7413minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo7415plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7560plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7559minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo7415plusLRDsOJo(Duration.m7475unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m7455isNegativeimpl(timeMark.mo7412elapsedNowUwyO8pc());
        }
