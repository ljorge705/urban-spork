...
public final class LongSaturatedMathKt {
    ...
    public static final long m7551saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM7468toLongimpl = Duration.m7468toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m7550checkInfiniteSumDefinedPjuGub4(j, j2, jM7468toLongimpl);
        }
        if ((1 | (jM7468toLongimpl - 1)) == Long.MAX_VALUE) {
            return m7552saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM7468toLongimpl;
        return ((j ^ j3) & (jM7468toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m7550checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m7454isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m7552saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM7425divUwyO8pc = Duration.m7425divUwyO8pc(j2, 2);
        long jM7468toLongimpl = Duration.m7468toLongimpl(jM7425divUwyO8pc, durationUnit);
        return (1 | (jM7468toLongimpl - 1)) == Long.MAX_VALUE ? jM7468toLongimpl : m7551saturatingAddNuflL3o(m7551saturatingAddNuflL3o(j, durationUnit, jM7425divUwyO8pc), durationUnit, Duration.m7457minusLRDsOJo(j2, jM7425divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m7524getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m7523getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m7475unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m7458plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m7475unaryMinusUwyO8pc(infinityOfSign(j3));
        }
