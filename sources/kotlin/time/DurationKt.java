...
public final class DurationKt {
    ...
    private static final long m7549timesmvk6XK0(int i, long j) {
        return Duration.m7460timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m7548timeskIfJnKk(double d, long j) {
        return Duration.m7459timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM7525getZEROUwyO8pc = Duration.INSTANCE.m7525getZEROUwyO8pc();
        ...
        if (str2.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str2.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        z4 = z8;
                        long jM7458plusLRDsOJo = Duration.m7458plusLRDsOJo(jM7525getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM7525getZEROUwyO8pc = Duration.m7458plusLRDsOJo(jM7458plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        z4 = z8;
                        jM7525getZEROUwyO8pc = Duration.m7458plusLRDsOJo(jM7525getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    z8 = z4;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM7525getZEROUwyO8pc = Duration.INSTANCE.m7523getINFINITEUwyO8pc();
            } else {
                boolean z9 = !z6;
                if (z6 && str2.charAt(length2) == '(' && StringsKt.last(str2) == ')') {
                    length2++;
                    length--;
                    if (length2 == length) {
                        throw new IllegalArgumentException("No components");
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM7458plusLRDsOJo2 = Duration.m7458plusLRDsOJo(jM7525getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM7525getZEROUwyO8pc = Duration.m7458plusLRDsOJo(jM7458plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM7525getZEROUwyO8pc = Duration.m7458plusLRDsOJo(jM7525getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m7475unaryMinusUwyO8pc(jM7525getZEROUwyO8pc) : jM7525getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m7422constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m7422constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m7422constructorimpl((j << 1) + i);
    }
