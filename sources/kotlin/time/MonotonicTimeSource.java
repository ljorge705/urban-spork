...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m7562boximpl(m7556markNowz9LOYto());
    }
    ...
    public long m7556markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m7565constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m7555elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m7554differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m7553adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m7565constructorimpl(LongSaturatedMathKt.m7551saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
