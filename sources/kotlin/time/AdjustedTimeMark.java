...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo7413minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m7559minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo7412elapsedNowUwyO8pc() {
        return Duration.m7457minusLRDsOJo(this.mark.mo7412elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo7415plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m7458plusLRDsOJo(this.adjustment, duration), null);
    }
}
